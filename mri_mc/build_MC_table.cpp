...
static const int SmfOx[12] = {0, 3, 2, 1, 5, 4, 7, 6, 8, 11, 9, 10};
static const int SmfOy[12] = {2, 1, 0, 3, 6, 7, 4, 5, 10, 9, 8, 11};
static const int SmfOz[12] = {8, 9, 10, 11, 4, 5, 6, 7, 0, 1, 2, 3};
#if 0
