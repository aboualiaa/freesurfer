...
public:
  Coffin(const std::string OutDir, std::vector<std::string> InDirList,
         ...
         const std::string BedpostDir, const int NumTract, const float FminPath,
         ...
         const std::string XyzPriorFile1, const std::string angPriorFile,
         const std::string CurvPriorFile, const std::string NeighPriorFile,
         const std::string NeighIdFile, const int NeighPriorSet,
         const std::string LocalPriorFile, const std::string LocalIdFile,
         const int LocalPriorSet, const std::vector<std::string> AsegList,
         const std::string AffineXfmFile, const std::string NonlinXfmFile,
         const int NumBurnIn, const int NumSample, const int KeepSampleNth,
         const int UpdatePropNth, const std::string PropStdFile,
         const bool Debug = false);
  ~Coffin();
  void SetOutputDir(const std::string OutDir);
  void
       SetPathway(const std::string InitFile, const std::string RoiFile1,
                  const std::string RoiFile2, const std::string RoiMeshFile1,
                  const std::string RoiMeshFile2, const std::string RoiRefFile1,
                  const std::string RoiRefFile2, const std::string XyzPriorFile0,
