...
private:
  ...
  std::vector<std::vector<int>> mStreamlines, mControlPoints,
      mControlPointsTest, mExcludedStreamlines, mHistoLocal, mHistoNear,
      mHistoLocalAll, mHistoNearAll, mHistoTangent, mHistoCurvature,
      mHistoTangentAll, mHistoCurvatureAll;
  std::vector<std::vector<float>> mControlStd, mControlStdTest, mPriorLocal,
      mPriorNear, mPriorLocalAll, mPriorNearAll, mAsegDistMean, mAsegDistStd,
      mAsegDistMeanAll, mAsegDistStdAll, mPriorTangent, mPriorCurvature,
      mPriorTangentAll, mPriorCurvatureAll, mTangentXByArc, mTangentYByArc,
      mCurvatureByArc, mTangentXByArcAll, mTangentYByArcAll, mCurvatureByArcAll;
