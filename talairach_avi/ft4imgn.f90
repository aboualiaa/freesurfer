!$Header: /space/repo/1/dev/dev/talairach_avi/ft4imgn.f,v 1.1 2007/05/04 22:33:59 nicks Exp $
!$Log: ft4imgn.f,v $
!Revision 1.1  2007/05/04 22:33:59  nicks
!new talairach alignment utility, using Avi Snyders registration tools
!
! Revision 1.2  2007/04/29  05:15:21  avi
! gcc v3 compliant (use set_rnan() instead of r_quiet_nan())
!
! Revision 1.1  2006/02/13  06:24:18  avi
! Initial revision
!
subroutine ft4imgn(t4, imgt, nxt, nyt, nzt, centert, mmppixt, imgo, nxo, nyo, nzo, centero, mmppixo)
    !     variant of ft4imgo for nearest neighbor resampling
    real*4 t4(4, 4)
...
subroutine imgvaln(imgt, nx, ny, nz, center, mmppix, x, v, lslice)
    !     variant of imgvalx
    !     avi snyder
    !     returns in v the nearest neighbor value of imgt at locus x.
    !     lslice returns the slice from which the data is taken.
