! $Header: /space/repo/1/dev/dev/talairach_avi/param6opr.f,v 1.1 2007/05/04 22:34:03 nicks Exp $
! $Log: param6opr.f,v $
! Revision 1.1  2007/05/04 22:34:03  nicks
! new talairach alignment utility, using Avi Snyders registration tools
!
! Revision 1.2  2007/04/17  05:34:45  avi
! gcc compliant
!
! Revision 1.1  1996/04/19  17:12:14  ty7777
! Initial revision
!
!     param6opr.f
!     Avi Snyder 22-Oct-93
...
subroutine param6mul(param1, param2, param3)
    !     computes equivalent of param1 followed by param2
    !     and leaves in param3
...
subroutine param6inv(param0, param1)
    !     computes rotation-translation inverse of param0
    !     and leaves in param1
