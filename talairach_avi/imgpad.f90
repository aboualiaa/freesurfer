...
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
! $Header: /space/repo/1/dev/dev/talairach_avi/imgpad.f,v 1.1 2007/05/04 22:33:59 nicks Exp $
! $Log: imgpad.f,v $
! Revision 1.1  2007/05/04 22:33:59  nicks
! new talairach alignment utility, using Avi Snyders registration tools
!
! Revision 1.4  2007/04/11  05:15:53  avi
! f90 compliant
!
! Revision 1.3  2000/12/13  18:46:45  avi
! copyright
!
! Revision 1.2  1996/04/25  22:02:02  ty7777
! Fix bug for case of margin equals zero.
!
! Revision 1.1  1996/04/19  17:10:57  ty7777
! Initial revision
!
subroutine npad_test
    real*4 mmppix/2.086214/
    !     margin computed as 2.*sd = 2.*0.1874/(mmppix*fhalf)
    fhalf = 0.02
...
subroutine imgpad(imag, nx, ny, nz, imagp, nxp, nyp, nzp)
    ...
    do 1 kp = 1, nzp
        k = kp - mz
        !     if(k.ge.-mz/2.and.k.lt.nz+mz/2)k=min0(nz,max0(1,kp-mz))
        t = 0.
        if(k.lt.1)then
