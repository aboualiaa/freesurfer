...
/* gauss3d.f */
/*************/
void gauss3d_(float *imag, int *nx, int *ny, int *nz, float *cmppix,
              float *fhalf);

/***************/
/* img2lmask.c */
/***************/
void img2lmask(int *pnx, int *pny, int *pnz, float *imag, int *mask,
               float *mmppix, float *pfhalf, float *pcrit);
