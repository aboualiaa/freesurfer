...
! Copyright 1996, 1997, 1998, 1999, 2000,  Washington University, Mallinckrodt Institute of Radiology.
! All Rights Reserved.
...
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
! $Header: /space/repo/1/dev/dev/talairach_avi/matopr.f,v 1.1 2007/05/04 22:33:59 nicks Exp $
! $Log: matopr.f,v $
! Revision 1.1  2007/05/04 22:33:59  nicks
! new talairach alignment utility, using Avi Snyders registration tools
!
! Revision 1.3  2007/03/30  06:36:16  avi
! f90
! trap N exceeding scratch array dimensions
!
! Revision 1.2  2000/12/13  18:29:48  avi
! copyright
!
! Revision 1.1  1996/04/19  17:11:36  ty7777
! Initial revision
!
...
SUBROUTINE MATINV(A, N, D)
    !     ALGORITHM FOLLOWS Bevington, Phillip R.,
...
SUBROUTINE GENINV(A, G, B, N, DET)
    !     Calculates B = inv(A) where A is any square matrix
    !     G is a scratch array
