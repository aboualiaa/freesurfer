...
int main(int argc, const char *argv[]) {
  ...
  // load input
  std::vector<int> annot1 =
      readAnnotationIntoVector(parser.retrieve<std::string>("annot1"));
  std::vector<int> annot2 =
      readAnnotationIntoVector(parser.retrieve<std::string>("annot2"));
