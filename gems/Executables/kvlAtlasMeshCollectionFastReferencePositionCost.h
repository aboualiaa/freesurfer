...
class AtlasMeshCollectionFastReferencePositionCost
...
public:
  ...
  //
  bool GetValue(const ParametersType &parameters, double &dataCost,
                double &alphasCost, double &positionCost) const;
...
private:
  ...
  struct VertexNeighboringTetrahedronInfo {
    ...
    // Constructor
    VertexNeighboringTetrahedronInfo()
        : m_TetrahedronId(0), m_X1(0), m_Y1(0), m_Z1(0), m_X2(0), m_Y2(0),
          m_Z2(0), m_X3(0), m_Y3(0), m_Z3(0) {}
  };
