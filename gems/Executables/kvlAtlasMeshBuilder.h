...
public:
  ...
  void SetAffectedPoints(
      const std::vector<AtlasMesh::PointIdentifier> &affectedPoints) {
...
protected:
  ...
  void RegisterPointOccupancies() {
    ...
    for (std::vector<AtlasMesh::PointIdentifier>::const_iterator it =
             m_AffectedPoints.begin();
...
public:
  ...
  //
  void GetCurrentDataAndAlphasCost(double &currentDataCost,
                                   double &currentAlphasCost) const;
...
protected:
  ...
  //
  void GetDataCostAndAlphasCost(const AtlasMeshCollection *meshCollection,
                                double &dataCost, double &alphasCost) const;
  ...
  AtlasMeshCollection::Pointer TryToCollapseFast(
      const AtlasMeshCollection *miniCollection,
...
private:
  ...
  public:
    ...
    //
    AtlasMesh::CellIdentifier GetEdgeId() const { return m_EdgeId; }
