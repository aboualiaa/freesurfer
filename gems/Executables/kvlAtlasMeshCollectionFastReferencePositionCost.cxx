...
//
//
void AtlasMeshCollectionFastReferencePositionCost ::SetInitialMeshCollection(
...
//
//
void AtlasMeshCollectionFastReferencePositionCost ::
  ...
  while (cellIt != m_Cells->End()) {
    ...
    const AtlasMesh::PointType::ValueType x0 =
        m_ReferencePosition->ElementAt(point0Id).GetElement(0);
    const AtlasMesh::PointType::ValueType y0 =
        m_ReferencePosition->ElementAt(point0Id).GetElement(1);
    const AtlasMesh::PointType::ValueType z0 =
        m_ReferencePosition->ElementAt(point0Id).GetElement(2);
    const AtlasMesh::PointType::ValueType x1 =
        m_ReferencePosition->ElementAt(point1Id).GetElement(0);
    const AtlasMesh::PointType::ValueType y1 =
        m_ReferencePosition->ElementAt(point1Id).GetElement(1);
    const AtlasMesh::PointType::ValueType z1 =
        m_ReferencePosition->ElementAt(point1Id).GetElement(2);
    const AtlasMesh::PointType::ValueType x2 =
        m_ReferencePosition->ElementAt(point2Id).GetElement(0);
    const AtlasMesh::PointType::ValueType y2 =
        m_ReferencePosition->ElementAt(point2Id).GetElement(1);
    const AtlasMesh::PointType::ValueType z2 =
        m_ReferencePosition->ElementAt(point2Id).GetElement(2);
    const AtlasMesh::PointType::ValueType x3 =
        m_ReferencePosition->ElementAt(point3Id).GetElement(0);
    const AtlasMesh::PointType::ValueType y3 =
        m_ReferencePosition->ElementAt(point3Id).GetElement(1);
    const AtlasMesh::PointType::ValueType z3 =
        m_ReferencePosition->ElementAt(point3Id).GetElement(2);
...
AtlasMeshCollectionFastReferencePositionCost ::GetValue(
...
bool AtlasMeshCollectionFastReferencePositionCost ::GetValue(
  ...
  for (std::vector<VertexNeighboringTetrahedronInfo>::const_iterator
           tetrahedronInfoIt = m_VertexNeighborhood.begin();
       tetrahedronInfoIt != m_VertexNeighborhood.end(); ++tetrahedronInfoIt) {
  ...
  for (unsigned int i = 0; i < m_InitialPositions.size(); i++) {
    AtlasMesh::PointsContainer::Pointer position =
        AtlasMesh::PointsContainer::New();
    AtlasMesh::PointsContainer::ConstPointer initialPosition =
        m_InitialPositions[i].GetPointer();
    for (AtlasMesh::PointsContainer::ConstIterator initialIt =
  ...
  AtlasMesh::PointDataContainer::Pointer pointParameters =
      AtlasMesh::PointDataContainer::New();
  for (AtlasMesh::PointDataContainer::ConstIterator initialIt =
           m_InitialPointParameters->Begin();
  ...
  m_DataAndAlphasCostCalculator->SetMeshCollection(
      m_CostCalculationMeshCollection);
