...
int main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option(
      argc, argv, "$Id: mri_paint.c,v 1.5 2011/03/02 00:04:23 nicks Exp $",
      "$Name:  $");
  ...
  m = MatrixInverse(lta->xforms[0].m_L, nullptr);
...
static void print_usage() {
  fprintf(stderr,
          "usage: %s [options] <input volume> <input surface> <registration "
          "file> <output .float file>\n",
          Progname);
}
