...
// aside from small modifications, this code is by Dani Lischinski
...
inline CDT_real Vector2d::norm() const { return sqrt(x * x + y * y); }
...
public:
...
#endif
  void ApplyTaggedMesh(void (*f)(int isconstrained, void *tag1,
                                 void *tag2)) const;
  ...
  int TaggedEdgeUnmatched(void *key1, void *key2,
...
inline Boolean Edge::isConstrained() { return QEdge()->isConstrained(); }

inline void Edge::Constrain() { QEdge()->Constrain(); }
