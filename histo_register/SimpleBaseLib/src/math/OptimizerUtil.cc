...
void testOptimizer(const String &outputPrefix, Objective &objective,
                   double xStart, double yStart, double min, double max) {
  ...
  optimizer.plotObjectiveMap(result, 0, 1, 50, 50, 4,
                             addDataPath(outputPrefix + ".png"));
}
