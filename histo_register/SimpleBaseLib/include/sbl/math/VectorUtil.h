...
/*! \file VectorUtil.h
    \brief The VectorUtil module provides various functions for creating,
   manipulating, and analyzing vectors (represented by Vector class instances).
*/
...
String toString(const VectorF &v, int minIndex = 0, int maxIndex = 100,
                const String &format = "%4.2f");
