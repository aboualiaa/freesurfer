...
/// The ConfigOptimizerObjective class provides an interface for objective
/// functions used by the runConfigOptimizer function.
...
void runConfigOptimizer(ConfigOptimizerObjective &objective, Config &conf,
                        double factor, const String &paramFileName,
