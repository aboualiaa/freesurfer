...
/*! \file TimeUtil.h
    ...
    These timestamps are represented using the unix standard of seconds since
   the epoch. In future versions the int timestamp types will be replaced with
   64-bit ints and/or doubles.
*/
...
/// The Date class represents a date value, allowing simple and efficient
/// operations on dates.
class Date {
public:
  // basic constructors
  ...
  inline int endTimestamp() const {
    return m_startTimestamp + 24 * 60 * 60 - 1;
  }
