...
/// wait for the given number of seconds (busy loop checking for interface
/// events)
...
/// The TimerSet class holds a named set of timers (useful for timing different
/// parts of a complex algorithm).
class TimerSet {
public:
