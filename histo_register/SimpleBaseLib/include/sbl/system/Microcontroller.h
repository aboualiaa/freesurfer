...
/*! \file Microcontroller.h
    \brief The Microcontroller module gives an interface for sending/receiving
   messages from a microcontroller.  The messages are transmitted with a simple
   binary protocol that includes basic error checking.
*/
...
void writeSerialMessage(SerialPort &serialPort, const String &messageName,
                        int valueCount = 0, int value0 = 0, int value1 = 0,
                        int value2 = 0);
