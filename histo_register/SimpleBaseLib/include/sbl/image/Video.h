...
/// The InputVideo class provides an interface to an input video file (or image
/// sequence).
class InputVideo {
public:
  /// open a video file
...
public:
  ...
  OutputVideo();
  OutputVideo(const String &fileName, int outputWidth, int outputHeight,
              double fps = 30);
  void open(const String &fileName, int outputWidth, int outputHeight,
            double fps = 30);
