...
int floodFillXYZ(const ImageGrayUSeq &seq, int minRegionColor,
                 int maxRegionColor, int fillValue, int x, int y, int z,
                 float *xCentRet = NULL, float *yCentRet = NULL,
                 float *zCentRet = NULL, int *xMinRet = NULL,
                 int *xMaxRet = NULL, int *yMinRet = NULL, int *yMaxRet = NULL,
