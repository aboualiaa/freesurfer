...
/// The ConfigViewer displays a set of config entries, but does not allow
/// editing.
...
public:
  ...
  /// assumes order is unchanged; adds missing entries, assuming those are at
  /// end
...
public:
  // basic constructor
  ConfigViewerDialog(wxWindow *parent, wxWindowID id, Config &conf,
                     const String &title);
