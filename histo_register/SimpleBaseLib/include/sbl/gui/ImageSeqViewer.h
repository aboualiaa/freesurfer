...
/// The ImageSeqViewer provides a user interface for viewing a sequence of
/// images. The viewer doesn't actually contain the data being displayed; that
/// is stored and controlled externally.
...
public:
  ...
  inline void setDrawCallback(void (*drawCallback)(int imageIndex)) {
