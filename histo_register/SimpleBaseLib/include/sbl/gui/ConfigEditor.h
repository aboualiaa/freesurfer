...
/// The ConfigEntryEditor widget provides an interface for editing a single
/// Config entry.
...
/// The ConfigEditorDialog class creates a pop-up window for editing a Config
/// object.
class ConfigEditorDialog : public wxDialog {
public:
  // basic constructor
  ConfigEditorDialog(wxWindow *parent, wxWindowID id, Config &config,
                     const String &title);
