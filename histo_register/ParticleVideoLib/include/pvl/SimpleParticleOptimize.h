...
/*! \file SimpleParticleOptimize.h
    \brief The SimpleParticleOptimize module provides functions for optimizing
   the locations of a set of particles.
*/
...
/// returns a matrix in which each row is a (particleIndex1, particleIndex2)
/// indicating a link between a pair of particle; if activePrev set, requires
/// that particle be active in previous frame
