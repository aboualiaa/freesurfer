...
/// The SparseSystem class represents a system of linear equations with sparse
/// coefficients.
class SparseSystem {
public:
  ...
  /// for SOR method, first variable should be on diagonal and have non-zero
  /// coef
  // fix(clean): unify fixed-length cases
  void addEquation(int i1, int i2, int i3, int i4, int i5, float a1, float a2,
                   float a3, float a4, float a5, float b);
  void addEquation(int i1, int i2, int i3, int i4, int i5, int i6, float a1,
                   float a2, float a3, float a4, float a5, float a6, float b);
  void addEquation(int i1, int i2, int i3, int i4, int i5, int i6, int i7,
                   int i8, int i9, float a1, float a2, float a3, float a4,
                   float a5, float a6, float a7, float a8, float a9, float b);

  // variable length equations
  inline int moreTermsAllowed(int eqnIndex) {
    return MAX_TERM_COUNT - m_varEqn[eqnIndex].termCount;
  }
