...
/*! \file VarMotionMultiRes.h
    \brief The VarMotionMultiRes module provides a variation of the varMotion
   algorithm in which the flow field is represented at a lower resolution than
   the image data (allowing faster optical flow estimation).
*/
