...
/*! \file VarMotion.h
    \brief The VarMotion module gives an implementation of a variational optical
   flow algorithm similar to the Brox et al. algorithm.
*/
...
void varIteration(MotionField &mf, const Array<ImageGrayF> &srcChan,
                  const Array<ImageGrayF> &destChan, const ImageGrayU &mask,
