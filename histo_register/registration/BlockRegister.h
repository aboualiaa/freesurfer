...
/*! \file BlockRegister.cc
        \brief The BlockRegister module registers a blockface volume with an MR
   volume. First the algorithm performs a linear registration and re-samples the
   MR to match the blockface according to this registration.  Then the alogirhtm
