...
/*! \file VarCorres3DUtil.cc
    \brief The VarCorres3DUtil module contains utility functions used by the
   VarCorres3D algorithm.
*/
...
int buildIndexMaps(int startIndex, const ImageGrayU &mask, ImageGrayI &uIndex,
                   ImageGrayI &vIndex, ImageGrayI &wIndex);

/// returns config object with parameters for variational correspondence
/// algorithm
