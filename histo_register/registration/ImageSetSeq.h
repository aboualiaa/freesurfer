...
/// The ImageSetSeq class represents a asequence of image sets (e.g. a 3D volume
/// of multi-channel images)
class ImageSetSeq {
public:
  ...
  const Array<ImageGrayF> &operator[](int index) const {
  ...
  /// compute the value of channel k at the given coordinates using linear
  /// interpolation
