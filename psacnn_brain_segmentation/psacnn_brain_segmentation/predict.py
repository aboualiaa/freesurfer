...
def predict_segmentation(
    ...
    aseg_labels = np.loadtxt("model_files/aseg_labels_skullstripped.txt")

    num_channels = 1
    channel_names = [contrast]
    feature_shape = (96, 96, 96, num_channels)
    # feature_shape = (128, 128, 128, num_channels)
    ...
    curr_unet.predict_segmentation(
        test_files,
        test_channel_names,
        out_membership_file,
        out_hard_file,
   ...
   '
    ...
    def _run_interface(self, runtime):
        ...
        predict_segmentation(
            ...
            output_soft=self.inputs.output_soft,
            patch_dim=self.inputs.patch_dim,
        )
    ...
    def _list_outputs(self):
        ...
        outputs["prob_image"] = os.path.join(base_dir, "psacnn_soft.nii.gz")
        return outputs
...
if __name__ == "__main__":
    ...
    conform = Node(
        MRIConvert(conform=True, out_type="niigz", out_file="conformed.nii.gz"),
        name="conform",
    )
    n4 = Node(
