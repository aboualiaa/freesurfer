...
def preprocess(
    input_file, output_dir, conform=True, bias_correct=True, skullstrip=True
):
...
if __name__ == "__main__":
    ...
    selectfiles = Node(
        SelectFiles(templates, base_directory=t2dir), name="selectfiles"
    )

    datasink = Node(
        DataSink(base_directory=t2dir, container=output_dir), name="datasink"
    )
    ...
    preprocess_flow.connect(
        [
            ...
            (
                ...
                datasink,
                [
                    ("stripped_image", "preprocess.brain"),
