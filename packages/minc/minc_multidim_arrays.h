...
@VERSION    : $Header:
/private-cvsroot/minc/volume_io/Include/volume_io/multidim.h,v 1.5.2.2
...
#define SET_GIVEN_DIM(array, asterisks, subscripts, value)                     \
  ...
  case DOUBLE:                                                                 \
    ...
    break;                                                                     \
  default:                                                                     \
    fprintf(stderr, "%s:%d No default", __FILE__, __LINE__);                   \
    exit(1);                                                                   \
  }

#define GET_MULTIDIM_TYPE_1D(array, type, v0) (((type *)((array).data))[v0])
...
#define SET_MULTIDIM_1D(array, x, value) SET_GIVEN_DIM(array, *, [x], value)
...
#define SET_MULTIDIM(array, x, y, z, t, v, value)                              \
  ...
  case 1:                                                                      \
    SET_MULTIDIM_1D(array, x, value);                                          \
    break;                                                                     \
  case 2:                                                                      \
    SET_MULTIDIM_2D(array, x, y, value);                                       \
    break;                                                                     \
  case 3:                                                                      \
    SET_MULTIDIM_3D(array, x, y, z, value);                                    \
    break;                                                                     \
  case 4:                                                                      \
    SET_MULTIDIM_4D(array, x, y, z, t, value);                                 \
    break;                                                                     \
  case 5:                                                                      \
    SET_MULTIDIM_5D(array, x, y, z, t, v, value);                              \
    break;                                                                     \
  default:                                                                     \
    fprintf(stderr, "%s:%d No default", __FILE__, __LINE__);                   \
    exit(1);                                                                   \
...
#define GET_MULTIDIM(value, vtype, array, x, y, z, t, v)                       \
  switch ((array).n_dimensions) {                                              \
  case 1:                                                                      \
    GET_MULTIDIM_1D(value, vtype, array, x);                                   \
    break;                                                                     \
  case 2:                                                                      \
    GET_MULTIDIM_2D(value, vtype, array, x, y);                                \
    break;                                                                     \
  case 3:                                                                      \
    GET_MULTIDIM_3D(value, vtype, array, x, y, z);                             \
    break;                                                                     \
  case 4:                                                                      \
    GET_MULTIDIM_4D(value, vtype, array, x, y, z, t);                          \
    break;                                                                     \
  case 5:                                                                      \
    GET_MULTIDIM_5D(value, vtype, array, x, y, z, t, v);                       \
    break;                                                                     \
  default:                                                                     \
    fprintf(stderr, "%s:%d No default", __FILE__, __LINE__);                   \
    exit(1);                                                                   \
...
#define GET_MULTIDIM_PTR_1D(ptr, array, x) GET_GIVEN_DIM_PTR(ptr, array, *, [x])
...
#define GET_MULTIDIM_PTR(ptr, array, x, y, z, t, v)                            \
  switch ((array).n_dimensions) {                                              \
  case 1:                                                                      \
    GET_MULTIDIM_PTR_1D(ptr, array, x);                                        \
    break;                                                                     \
  case 2:                                                                      \
    GET_MULTIDIM_PTR_2D(ptr, array, x, y);                                     \
    break;                                                                     \
  case 3:                                                                      \
    GET_MULTIDIM_PTR_3D(ptr, array, x, y, z);                                  \
    break;                                                                     \
  case 4:                                                                      \
    GET_MULTIDIM_PTR_4D(ptr, array, x, y, z, t);                               \
    break;                                                                     \
  case 5:                                                                      \
    GET_MULTIDIM_PTR_5D(ptr, array, x, y, z, t, v);                            \
    break;                                                                     \
  default:                                                                     \
    fprintf(stderr, "%s:%d no default", __FILE__, __LINE__);                   \
    exit(1);                                                                   \
