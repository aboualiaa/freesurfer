...
@COPYRIGHT  :
              ...
              express or implied warranty.
@VERSION    : $Header:
/private-cvsroot/minc/volume_io/Include/volume_io/geom_structs.h,v 1.20.2.3
2006/11/30 09:15:13 rotor Exp $
---------------------------------------------------------------------------- */
...
@COPYRIGHT  :
              ...
              express or implied warranty.
@VERSION    : $Header:
/private-cvsroot/minc/volume_io/Include/volume_io/transforms.h,v 1.12.2.2
2005/03/31 17:39:49 bert Exp $
---------------------------------------------------------------------------- */

typedef void (*User_transform_function)(void *user_data, double x, double y,
                                        double z, double *x_trans,
...
void get_volume_real_range(Volume volume, double *min_value, double *max_value);
...
void set_volume_voxel_value(Volume volume, int v0, int v1, int v2, int v3,
                            int v4, double voxel);
...
double get_volume_voxel_value(Volume volume, int v0, int v1, int v2, int v3,
                              int v4);

General_transform *get_voxel_to_world_transform(Volume volume);

VIO_Status output_volume(const char *filename, nc_type file_nc_data_type,
                         bool file_signed_flag, double file_voxel_min,
                         double file_voxel_max, Volume volume,
                         const char *history, minc_output_options *options);
