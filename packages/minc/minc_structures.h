...
@RCSID      : $Header: /private-cvsroot/minc/libsrc/minc_structures.h,v 6.1
1999/10/19 14:45:10 neelin Exp $ MINC (MNI)
---------------------------------------------------------------------------- */
...
struct mi_icv_struct {
  ...
  int do_dimconvert; /* Indicates that dimensional conversion function
                        should be given */
  int (*dimconvert_func)(int operation, mi_icv_type *icvp, long start[],
