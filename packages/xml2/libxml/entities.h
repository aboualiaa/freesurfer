...
XMLPUBFUN xmlEntityPtr XMLCALL xmlNewEntity(xmlDocPtr doc, const xmlChar *name,
...
XMLPUBFUN void XMLCALL xmlDumpEntitiesTable(xmlBufferPtr buf,
                                            xmlEntitiesTablePtr table);
XMLPUBFUN void XMLCALL xmlDumpEntityDecl(xmlBufferPtr buf, xmlEntityPtr ent);
