...
XMLPUBFUN int XMLCALL xmlXPathContextSetCache(xmlXPathContextPtr ctxt,
                                              int active, int value,
                                              int options);
/**
...
XMLPUBFUN int XMLCALL xmlXPathCompiledEvalToBoolean(xmlXPathCompExprPtr comp,
