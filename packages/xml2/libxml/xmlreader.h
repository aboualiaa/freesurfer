...
XMLPUBFUN int XMLCALL xmlTextReaderSetup(xmlTextReaderPtr reader,
...
XMLPUBFUN int XMLCALL xmlTextReaderIsNamespaceDecl(xmlTextReaderPtr reader);
...
XMLPUBFUN int XMLCALL xmlTextReaderMoveToAttribute(xmlTextReaderPtr reader,
                                                   const xmlChar *name);
XMLPUBFUN int XMLCALL xmlTextReaderMoveToAttributeNs(
    xmlTextReaderPtr reader, const xmlChar *localName,
    const xmlChar *namespaceURI);
...
XMLPUBFUN int XMLCALL xmlTextReaderPreservePattern(xmlTextReaderPtr reader,
...
XMLPUBFUN int XMLCALL xmlTextReaderSchemaValidate(xmlTextReaderPtr reader,
                                                  const char *xsd);
XMLPUBFUN int XMLCALL xmlTextReaderSchemaValidateCtxt(
    xmlTextReaderPtr reader, xmlSchemaValidCtxtPtr ctxt, int options);
XMLPUBFUN int XMLCALL xmlTextReaderSetSchema(xmlTextReaderPtr reader,
                                             xmlSchemaPtr schema);
#endif
XMLPUBFUN const xmlChar *XMLCALL
xmlTextReaderConstXmlVersion(xmlTextReaderPtr reader);
XMLPUBFUN int XMLCALL xmlTextReaderStandalone(xmlTextReaderPtr reader);

/*
 * Index lookup
 */
XMLPUBFUN long XMLCALL xmlTextReaderByteConsumed(xmlTextReaderPtr reader);
...
XMLPUBFUN xmlTextReaderPtr XMLCALL xmlReaderForMemory(const char *buffer,
                                                      ...
                                                      const char *encoding,
                                                      int options);
XMLPUBFUN xmlTextReaderPtr XMLCALL xmlReaderForFd(int fd, const char *URL,
                                                  const char *encoding,
                                                  int options);
...
XMLPUBFUN int XMLCALL xmlReaderNewMemory(xmlTextReaderPtr reader,
                                         ...
                                         const char *URL, const char *encoding,
                                         int options);
XMLPUBFUN int XMLCALL xmlReaderNewFd(xmlTextReaderPtr reader, int fd,
                                     const char *URL, const char *encoding,
                                     int options);
 ...
 */
typedef void(XMLCALL *xmlTextReaderErrorFunc)(void *arg, const char *msg,
                                              xmlParserSeverities severity,
                                              xmlTextReaderLocatorPtr locator);
XMLPUBFUN int XMLCALL
xmlTextReaderLocatorLineNumber(xmlTextReaderLocatorPtr locator);
/*int             xmlTextReaderLocatorLinePosition(xmlTextReaderLocatorPtr
 * locator);*/
XMLPUBFUN xmlChar *XMLCALL
...
XMLPUBFUN void XMLCALL xmlTextReaderSetErrorHandler(xmlTextReaderPtr reader,
                                                    ...
                                                    void *arg);
XMLPUBFUN void XMLCALL xmlTextReaderSetStructuredErrorHandler(
