...
XMLPUBFUN xmlParserCtxtPtr XMLCALL xmlCreateMemoryParserCtxt(const char *buffer,
                                                             int size);
XMLPUBFUN xmlParserCtxtPtr XMLCALL xmlCreateEntityParserCtxt(
...
XMLPUBFUN void XMLCALL __xmlErrEncoding(xmlParserCtxtPtr ctxt,
                                        xmlParserErrors xmlerr, const char *msg,
                                        const xmlChar *str1,
                                        const xmlChar *str2);
#endif
 ...
 */
typedef void (*xmlEntityReferenceFunc)(xmlEntityPtr ent, xmlNodePtr firstNode,
                                       xmlNodePtr lastNode);
 ...
 * Entities
 */
XMLPUBFUN xmlChar *XMLCALL xmlDecodeEntities(xmlParserCtxtPtr ctxt, int len,
 ...
 * internal only
 */
XMLPUBFUN void XMLCALL xmlErrMemory(xmlParserCtxtPtr ctxt, const char *extra);
#endif
