...
extern int pthread_once(pthread_once_t *__once_control,
                        void (*__init_routine)(void)) __attribute((weak));
 ...
 */
static xmlGlobalStatePtr xmlNewGlobalState(void) {
  xmlGlobalState *gs;
...
xmlGlobalStatePtr xmlGetGlobalState(void) {
  ...
  if (globalval == NULL) {
    ...
    if (tsd == NULL)
      return (NULL);
    p = (xmlGlobalStateCleanupHelperParams *)malloc(
...
#ifdef HAVE_PTHREAD_H
  if (libxml_is_threaded == -1) {
    if ((pthread_once != NULL) && (pthread_getspecific != NULL) &&
        (pthread_setspecific != NULL) && (pthread_key_create != NULL) &&
        (pthread_key_delete != NULL) && (pthread_mutex_init != NULL) &&
        (pthread_mutex_destroy != NULL) && (pthread_mutex_lock != NULL) &&
        (pthread_mutex_unlock != NULL) && (pthread_cond_init != NULL) &&
        (pthread_cond_destroy != NULL) && (pthread_cond_wait != NULL) &&
        (pthread_equal != NULL) && (pthread_self != NULL) &&
