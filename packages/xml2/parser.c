 ...
 * parser option.
 */
static int xmlParserEntityCheck(xmlParserCtxtPtr ctxt, unsigned long size,
                                xmlEntityPtr ent) {
...
static const char *xmlW3CPIs[] = {"xml-stylesheet", NULL};
...
static void xmlAddEntityReference(xmlEntityPtr ent, xmlNodePtr firstNode,
                                  xmlNodePtr lastNode);
#endif /* LIBXML_LEGACY_ENABLED */

static xmlParserErrors
xmlParseBalancedChunkMemoryInternal(xmlParserCtxtPtr oldctxt,
                                    const xmlChar *string, void *user_data,
                                    xmlNodePtr *lst);
 ...
 */
static void xmlErrAttributeDup(xmlParserCtxtPtr ctxt, const xmlChar *prefix,
  ...
  if (prefix == NULL)
    ...
    __xmlRaiseError(NULL, NULL, NULL, ctxt, NULL, XML_FROM_PARSER,
                    XML_ERR_ATTRIBUTE_REDEFINED, XML_ERR_FATAL, NULL, 0,
                    (const char *)prefix, (const char *)localname, NULL, 0, 0,
...
static void xmlFatalErr(xmlParserCtxtPtr ctxt, xmlParserErrors error,
  ...
  __xmlRaiseError(NULL, NULL, NULL, ctxt, NULL, XML_FROM_PARSER, error,
                  XML_ERR_FATAL, NULL, 0, info, NULL, NULL, 0, 0, errmsg, info);
  if (ctxt != NULL) {
    ctxt->wellFormed = 0;
    if (ctxt->recovery == 0)
      ctxt->disableSAX = 1;
...
static void xmlWarningMsg(xmlParserCtxtPtr ctxt, xmlParserErrors error,
  ...
  if (ctxt != NULL) {
    __xmlRaiseError(schannel, (ctxt->sax) ? ctxt->sax->warning : NULL,
                    ...
                    XML_ERR_WARNING, NULL, 0, (const char *)str1,
                    (const char *)str2, NULL, 0, 0, msg, (const char *)str1,
                    (const char *)str2);
  } else {
    __xmlRaiseError(schannel, NULL, NULL, ctxt, NULL, XML_FROM_PARSER, error,
                    XML_ERR_WARNING, NULL, 0, (const char *)str1,
                    (const char *)str2, NULL, 0, 0, msg, (const char *)str1,
                    (const char *)str2);
  }
...
static void xmlValidityError(xmlParserCtxtPtr ctxt, xmlParserErrors error,
  ...
  if (ctxt != NULL) {
    __xmlRaiseError(schannel, ctxt->vctxt.error, ctxt->vctxt.userData, ctxt,
                    NULL, XML_FROM_DTD, error, XML_ERR_ERROR, NULL, 0,
                    (const char *)str1, (const char *)str2, NULL, 0, 0, msg,
                    (const char *)str1, (const char *)str2);
    ctxt->valid = 0;
  } else {
    __xmlRaiseError(schannel, NULL, NULL, ctxt, NULL, XML_FROM_DTD, error,
...
static void xmlFatalErrMsgStrIntStr(xmlParserCtxtPtr ctxt,
  ...
  if (ctxt != NULL)
    ctxt->errNo = error;
  __xmlRaiseError(NULL, NULL, NULL, ctxt, NULL, XML_FROM_PARSER, error,
                  XML_ERR_FATAL, NULL, 0, (const char *)str1,
                  (const char *)str2, NULL, val, 0, msg, str1, val, str2);
  if (ctxt != NULL) {
    ctxt->wellFormed = 0;
    if (ctxt->recovery == 0)
      ctxt->disableSAX = 1;
...
static void xmlFatalErrMsgStr(xmlParserCtxtPtr ctxt, xmlParserErrors error,
  ...
  if (ctxt != NULL)
    ctxt->errNo = error;
  __xmlRaiseError(NULL, NULL, NULL, ctxt, NULL, XML_FROM_PARSER, error,
                  XML_ERR_FATAL, NULL, 0, (const char *)val, NULL, NULL, 0, 0,
                  msg, val);
  if (ctxt != NULL) {
    ctxt->wellFormed = 0;
    if (ctxt->recovery == 0)
...
static void xmlErrMsgStr(xmlParserCtxtPtr ctxt, xmlParserErrors error,
  ...
  if (ctxt != NULL)
    ctxt->errNo = error;
  __xmlRaiseError(NULL, NULL, NULL, ctxt, NULL, XML_FROM_PARSER, error,
                  XML_ERR_ERROR, NULL, 0, (const char *)val, NULL, NULL, 0, 0,
                  msg, val);
}
...
static void xmlNsErr(xmlParserCtxtPtr ctxt, xmlParserErrors error,
  ...
  __xmlRaiseError(NULL, NULL, NULL, ctxt, NULL, XML_FROM_NAMESPACE, error,
                  ...
                  (const char *)info2, (const char *)info3, 0, 0, msg, info1,
                  info2, info3);
  if (ctxt != NULL)
    ctxt->nsWellFormed = 0;
}
 ...
 */
static void xmlAddSpecialAttr(xmlParserCtxtPtr ctxt, const xmlChar *fullname,
                              const xmlChar *fullattr, int type) {
  if (ctxt->attsSpecial == NULL) {
 ...
 */
static void
xmlCleanSpecialAttrCallback(void *payload, void *data, const xmlChar *fullname,
 ...
 */
static int nsPush(xmlParserCtxtPtr ctxt, const xmlChar *prefix,
                  const xmlChar *URL) {
  ...
  if ((ctxt->nsMax == 0) || (ctxt->nsTab == NULL)) {
    ctxt->nsMax = 10;
    ctxt->nsNr = 0;
    ctxt->nsTab = (const xmlChar **)xmlMalloc(ctxt->nsMax * sizeof(xmlChar *));
    if (ctxt->nsTab == NULL) {
      xmlErrMemory(ctxt, NULL);
      ctxt->nsMax = 0;
      return (-1);
...
static int xmlCtxtGrowAttrs(xmlParserCtxtPtr ctxt, int nr) {
  ...
  if (ctxt->atts == NULL) {
    ...
    ctxt->atts = atts;
    attallocs =
        (int *)xmlRealloc((void *)ctxt->attallocs, (maxatts / 5) * sizeof(int));
    if (attallocs == NULL)
      goto mem_error;
    ctxt->attallocs = attallocs;
    ctxt->maxatts = maxatts;
...
int inputPush(xmlParserCtxtPtr ctxt, xmlParserInputPtr value) {
  ...
  if (ctxt->inputNr >= ctxt->inputMax) {
    ctxt->inputMax *= 2;
    ctxt->inputTab = (xmlParserInputPtr *)xmlRealloc(
        ctxt->inputTab, ctxt->inputMax * sizeof(ctxt->inputTab[0]));
...
int nodePush(xmlParserCtxtPtr ctxt, xmlNodePtr value) {
  ...
  if (ctxt->nodeNr >= ctxt->nodeMax) {
    ...
    tmp = (xmlNodePtr *)xmlRealloc(ctxt->nodeTab, ctxt->nodeMax * 2 *
 ...
 * Returns -1 in case of error, the index in the stack otherwise
 */
static int nameNsPush(xmlParserCtxtPtr ctxt, const xmlChar *value,
 ...
 *   NEXT1(l) Skip 1 xmlChar, and must also be used only to skip 1 non-newline
 * ASCII defined char within the parser. Clean macros, not dependent of an ASCII
 * context, expect UTF-8 encoding
 *
...
int xmlPushInput(xmlParserCtxtPtr ctxt, xmlParserInputPtr input) {
  ...
  if (xmlParserDebugEntities) {
    if ((ctxt->input != NULL) && (ctxt->input->filename))
      xmlGenericError(xmlGenericErrorContext, "%s(%d): ", ctxt->input->filename,
                      ctxt->input->line);
    ...
    if (RAW == ';') {
      ...
      if (entity == NULL) {
        ...
        if ((entity->etype == XML_INTERNAL_PARAMETER_ENTITY) ||
           ...
           */
          GROW if ((ctxt->input->end - ctxt->input->cur) >= 4) {
            start[0] = RAW;
            start[1] = NXT(1);
            start[2] = NXT(2);
            start[3] = NXT(3);
 ...
 *      must deallocate it !
 */
xmlChar *xmlStringDecodeEntities(xmlParserCtxtPtr ctxt, const xmlChar *str,
                                 int what, xmlChar end, xmlChar end2,
                                 xmlChar end3) {
  if ((ctxt == NULL) || (str == NULL))
    return (NULL);
  return (xmlStringLenDecodeEntities(ctxt, str, xmlStrlen(str), what, end, end2,
                                     end3));
}
...
xmlChar *xmlSplitQName(xmlParserCtxtPtr ctxt, const xmlChar *name,
                       xmlChar **prefix) {
...
static xmlChar *xmlParseAttValueInternal(xmlParserCtxtPtr ctxt, int *len,
                                         int *alloc, int normalize);
...
static const unsigned char test_char_data[256] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, /* 0x9, CR/LF separated */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25,
    0x00, 0x27, /* & */
    0x28, 0x29, 0x2A, 0x2B, 0x2C, 0x2D, 0x2E, 0x2F, 0x30, 0x31, 0x32,
    0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x3A, 0x3B, 0x00, 0x3D,
    0x3E, 0x3F, /* < */
    0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4A,
    0x4B, 0x4C, 0x4D, 0x4E, 0x4F, 0x50, 0x51, 0x52, 0x53, 0x54, 0x55,
    0x56, 0x57, 0x58, 0x59, 0x5A, 0x5B, 0x5C, 0x00, 0x5E, 0x5F, /* ] */
    0x60, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6A,
    0x6B, 0x6C, 0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75,
    0x76, 0x77, 0x78, 0x79, 0x7A, 0x7B, 0x7C, 0x7D, 0x7E, 0x7F, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* non-ascii */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    get_more_space:
      ...
      if (*in == '<') {
        ...
        if (nbchar > 0) {
          ...
          } else if ((ctxt->sax != NULL) && (ctxt->sax->characters != NULL)) {
            ctxt->sax->characters(ctxt->userData, tmp, nbchar);
          }
        }
        return;
...
xmlChar *xmlParseExternalID(xmlParserCtxtPtr ctxt, xmlChar **publicID,
                            int strict) {
  xmlChar *URI = NULL;
 ...
 */
static void xmlParseCommentComplex(xmlParserCtxtPtr ctxt, xmlChar *buf, int len,
                                   int size) {
  int q, ql;
  int r, rl;
  int cur, l;
...
const xmlChar *xmlParsePITarget(xmlParserCtxtPtr ctxt) {
  ...
  if ((name != NULL) && ((name[0] == 'x') || (name[0] == 'X')) &&
    ...
    if ((name[0] == 'x') && (name[1] == 'm') && (name[2] == 'l') &&
        (name[3] == 0)) {
      xmlFatalErrMsg(
          ctxt, XML_ERR_RESERVED_XML_NAME,
    ...
    if (isParameter) {
          ...
          if (uri == NULL) {
            ...
            if (uri->fragment != NULL) {
              ...
              if ((ctxt->sax != NULL) && (!ctxt->disableSAX) &&
                  (ctxt->sax->entityDecl != NULL))
                ctxt->sax->entityDecl(ctxt->userData, name,
                                      XML_EXTERNAL_PARAMETER_ENTITY, literal,
                                      URI, NULL);
            }
            xmlFreeURI(uri);
          }
      ...
      if ((RAW == '"') || (RAW == '\'')) {
        ...
        if ((ctxt->sax != NULL) && (!ctxt->disableSAX) &&
            (ctxt->sax->entityDecl != NULL))
          ctxt->sax->entityDecl(ctxt->userData, name,
                                XML_INTERNAL_GENERAL_ENTITY, NULL, NULL, value);
        /*
        ...
        if ((ctxt->myDoc == NULL) ||
          ...
          if (ctxt->myDoc->intSubset == NULL)
            ctxt->myDoc->intSubset =
                xmlNewDtd(ctxt->myDoc, BAD_CAST "fake", NULL, NULL);

          xmlSAX2EntityDecl(ctxt, name, XML_INTERNAL_GENERAL_ENTITY, NULL, NULL,
                            value);
        }
      } else {
        URI = xmlParseExternalID(ctxt, &literal, 1);
        ...
        if (CMP5(CUR_PTR, 'N', 'D', 'A', 'T', 'A')) {
          ...
          if ((ctxt->sax != NULL) && (!ctxt->disableSAX) &&
            ...
            ctxt->sax->unparsedEntityDecl(ctxt->userData, name, literal, URI,
                                          ndata);
        } else {
          if ((ctxt->sax != NULL) && (!ctxt->disableSAX) &&
              (ctxt->sax->entityDecl != NULL))
            ctxt->sax->entityDecl(ctxt->userData, name,
                                  XML_EXTERNAL_GENERAL_PARSED_ENTITY, literal,
                                  URI, NULL);
          /*
           * For expat compatibility in SAX mode.
          ...
          if ((ctxt->replaceEntities != 0) &&
            ...
            if (ctxt->myDoc->intSubset == NULL)
              ctxt->myDoc->intSubset =
                  xmlNewDtd(ctxt->myDoc, BAD_CAST "fake", NULL, NULL);
            xmlSAX2EntityDecl(ctxt, name, XML_EXTERNAL_GENERAL_PARSED_ENTITY,
                              literal, URI, NULL);
          }
        }
      }
  ...
  if (CMP9(CUR_PTR, '<', '!', 'A', 'T', 'T', 'L', 'I', 'S', 'T')) {
    ...
    while (RAW != '>') {
      ...
      if ((ctxt->sax != NULL) && (!ctxt->disableSAX) &&
        ...
        ctxt->sax->attributeDecl(ctxt->userData, elemName, attrName, type, def,
                                 defaultValue, tree);
      else if (tree != NULL)
        xmlFreeEnumeration(tree);
    ...
    if (RAW == '>') {
      if (input != ctxt->input) {
        xmlValidityError(ctxt, XML_ERR_ENTITY_BOUNDARY,
                         "Attribute list declaration doesn't start and stop in "
                         "the same entity\n",
                         NULL, NULL);
      }
      NEXT;
...
xmlElementContentPtr xmlParseElementMixedContentDecl(xmlParserCtxtPtr ctxt,
  ...
  if (CMP7(CUR_PTR, '#', 'P', 'C', 'D', 'A', 'T', 'A')) {
    ...
    while (RAW == '|') {
      ...
      if (elem == NULL) {
        ret =
            xmlNewDocElementContent(ctxt->myDoc, NULL, XML_ELEMENT_CONTENT_OR);
        if (ret == NULL)
          return (NULL);
        ret->c1 = cur;
        if (cur != NULL)
        ...
        if (n == NULL)
          return (NULL);
        n->c1 = xmlNewDocElementContent(ctxt->myDoc, elem,
...
xmlParseElementChildrenContentDeclPriv(xmlParserCtxtPtr ctxt, int inputchk,
  ...
  if (RAW == '(') {
    ...
    SKIP_BLANKS;
    cur = ret =
        xmlParseElementChildrenContentDeclPriv(ctxt, inputid, depth + 1);
    SKIP_BLANKS;
    GROW;
  } else {
    elem = xmlParseName(ctxt);
  ...
  while (RAW != ')') {
    ...
    if (RAW == ',') {
       ...
       */
        ...
        xmlFatalErrMsgInt(
            ctxt, XML_ERR_SEPARATOR_REQUIRED,
  ...
  if (RAW == '?') {
    ...
    if (ret != NULL) {
      ...
      while ((cur != NULL) && (cur->type == XML_ELEMENT_CONTENT_OR)) {
        if ((cur->c1 != NULL) && ((cur->c1->ocur == XML_ELEMENT_CONTENT_OPT) ||
                                  (cur->c1->ocur == XML_ELEMENT_CONTENT_MULT)))
          cur->c1->ocur = XML_ELEMENT_CONTENT_ONCE;
        if ((cur->c2 != NULL) && ((cur->c2->ocur == XML_ELEMENT_CONTENT_OPT) ||
...
static void xmlParseConditionalSections(xmlParserCtxtPtr ctxt) {
  ...
  if (CMP7(CUR_PTR, 'I', 'N', 'C', 'L', 'U', 'D', 'E')) {
    ...
    if (xmlParserDebugEntities) {
      if ((ctxt->input != NULL) && (ctxt->input->filename))
        xmlGenericError(xmlGenericErrorContext,
                        "%s(%d): ", ctxt->input->filename, ctxt->input->line);
      xmlGenericError(xmlGenericErrorContext,
                      "Entering INCLUDE Conditional Section\n");
    }

    while ((RAW != 0) && ((RAW != ']') || (NXT(1) != ']') || (NXT(2) != '>'))) {
      const xmlChar *check = CUR_PTR;
 ...
 */
void xmlParseExternalSubset(xmlParserCtxtPtr ctxt, const xmlChar *ExternalID,
...
void xmlParseReference(xmlParserCtxtPtr ctxt) {
  ...
  if (ent->checked == 0) {
    ...
    if (ent->etype == XML_INTERNAL_GENERAL_ENTITY) {
      ctxt->depth++;
      ret = xmlParseBalancedChunkMemoryInternal(ctxt, ent->content, user_data,
                                                &list);
      ctxt->depth--;
    ...
    if ((ret == XML_ERR_OK) && (list != NULL)) {
      if (((ent->etype == XML_INTERNAL_GENERAL_ENTITY) ||
        ...
        if (ctxt->replaceEntities) {
           ...
           */
          if (((list->type == XML_TEXT_NODE) && (list->next == NULL)) ||
      ...
      if (((list == NULL) && (ent->owner == 0)) ||
        ...
        while (cur != NULL) {
          ...
          if (cur == ent->last) {
             ...
             */
            if ((ctxt->parseMode == XML_PARSE_READER) && (nw != NULL) &&
                (nw->type == XML_ELEMENT_NODE) && (nw->children == NULL))
              nw->extra = 1;
         ...
         */
        nbktext = xmlDictLookup(ctxt->dict, BAD_CAST "nbktext", -1);
  ...
  if (ent == NULL) {
    if ((ctxt->standalone == 1) ||
      ...
      xmlErrMsgStr(ctxt, XML_WAR_UNDECLARED_ENTITY, "Entity '%s' not defined\n",
                   name);
      if ((ctxt->inSubset == 0) && (ctxt->sax != NULL) &&
    ...
    if (xmlStrEqual(val, BAD_CAST "default"))
      ...
      *(ctxt->space) = 1;
      ...
      xmlWarningMsg(ctxt, XML_WAR_SPACE_VALUE,
                    "Invalid value \"%s\" for xml:space : \"default\" or "
                    "\"preserve\" expected\n",
                    val, NULL);
    }
  }
...
xmlParseAttribute2(xmlParserCtxtPtr ctxt, const xmlChar *pref,
                   const xmlChar *elem, const xmlChar **prefix, xmlChar **value,
                   int *len, int *alloc) {
  const xmlChar *name;
  ...
  *value = NULL;
  ...
  if (ctxt->attsSpecial != NULL) {
    ...
    type = (int)(long)xmlHashQLookup2(ctxt->attsSpecial, pref, elem, *prefix,
                                      name);
    if (type != 0)
      normalize = 1;
  }
...
reparse:
  ...
  *tlen = ctxt->input->cur - ctxt->input->base - cur;
  ...
  failed:
    ...
    GROW if (ctxt->input->base != base) goto base_changed;
    if ((RAW == '>') || (((RAW == '/') && (NXT(1) == '>'))))
      break;
    if (!IS_BLANK_CH(RAW)) {
      xmlFatalErrMsg(ctxt, XML_ERR_SPACE_REQUIRED,
        ...
        if ((attname == ctxt->str_xmlns) && (aprefix == NULL)) {
          ...
          if ((ctxt->standalone == 1) &&
            ...
            xmlValidityError(ctxt, XML_DTD_STANDALONE_DEFAULTED,
                             "standalone: attribute %s on %s defaulted from "
                             "external subset\n",
                             attname, localname);
          }
          nbdef++;
  ...
  *URI = nsname;
  ...
  if ((ctxt->sax != NULL) && (ctxt->sax->startElementNs != NULL) &&
      (!ctxt->disableSAX)) {
    if (nbNs > 0)
      ctxt->sax->startElementNs(ctxt->userData, localname, prefix, nsname, nbNs,
                                &ctxt->nsTab[ctxt->nsNr - 2 * nbNs], nbatts / 5,
                                nbdef, atts);
    else
      ctxt->sax->startElementNs(ctxt->userData, localname, prefix, nsname, 0,
                                NULL, nbatts / 5, nbdef, atts);
  }
...
const xmlChar *xmlParseEncodingDecl(xmlParserCtxtPtr ctxt) {
  ...
  if (CMP8(CUR_PTR, 'e', 'n', 'c', 'o', 'd', 'i', 'n', 'g')) {
     ...
     */
    if ((encoding != NULL) && ((!xmlStrcasecmp(encoding, BAD_CAST "UTF-16")) ||
       ...
       */
      if ((ctxt->encoding == NULL) && (ctxt->input->buf != NULL) &&
 ...
 */
static int xmlParseLookupSequence(xmlParserCtxtPtr ctxt, xmlChar first,
...
#ifdef DEBUG_PUSH
      if (next == 0)
        xmlGenericError(xmlGenericErrorContext, "PP: lookup '%c' found at %d\n",
                        first, base);
      else if (third == 0)
        xmlGenericError(xmlGenericErrorContext,
...
#ifdef DEBUG_PUSH
  if (next == 0)
    xmlGenericError(xmlGenericErrorContext, "PP: lookup '%c' failed\n", first);
  else if (third == 0)
    xmlGenericError(xmlGenericErrorContext, "PP: lookup '%c%c' failed\n", first,
                    next);
  else
    xmlGenericError(xmlGenericErrorContext, "PP: lookup '%c%c%c' failed\n",
                    first, next, third);
#endif
  return (-1);
}
 ...
 */
static void xmlParseGetLasts(xmlParserCtxtPtr ctxt, const xmlChar **lastlt,
...
static int xmlParseTryOrFinish(xmlParserCtxtPtr ctxt, int terminate) {
  ...
  switch (ctxt->instate) {
  case XML_PARSER_EOF:
    xmlGenericError(xmlGenericErrorContext, "PP: try EOF\n");
    break;
  case XML_PARSER_START:
    xmlGenericError(xmlGenericErrorContext, "PP: try START\n");
    break;
  case XML_PARSER_MISC:
    xmlGenericError(xmlGenericErrorContext, "PP: try MISC\n");
    break;
  case XML_PARSER_COMMENT:
    xmlGenericError(xmlGenericErrorContext, "PP: try COMMENT\n");
    break;
  case XML_PARSER_PROLOG:
    xmlGenericError(xmlGenericErrorContext, "PP: try PROLOG\n");
    break;
  case XML_PARSER_START_TAG:
    xmlGenericError(xmlGenericErrorContext, "PP: try START_TAG\n");
    break;
  case XML_PARSER_CONTENT:
    xmlGenericError(xmlGenericErrorContext, "PP: try CONTENT\n");
    break;
  case XML_PARSER_CDATA_SECTION:
    xmlGenericError(xmlGenericErrorContext, "PP: try CDATA_SECTION\n");
    break;
  case XML_PARSER_END_TAG:
    xmlGenericError(xmlGenericErrorContext, "PP: try END_TAG\n");
    break;
  case XML_PARSER_ENTITY_DECL:
    xmlGenericError(xmlGenericErrorContext, "PP: try ENTITY_DECL\n");
    break;
  case XML_PARSER_ENTITY_VALUE:
    xmlGenericError(xmlGenericErrorContext, "PP: try ENTITY_VALUE\n");
    break;
  case XML_PARSER_ATTRIBUTE_VALUE:
    xmlGenericError(xmlGenericErrorContext, "PP: try ATTRIBUTE_VALUE\n");
    break;
  case XML_PARSER_DTD:
    xmlGenericError(xmlGenericErrorContext, "PP: try DTD\n");
    break;
  case XML_PARSER_EPILOG:
    xmlGenericError(xmlGenericErrorContext, "PP: try EPILOG\n");
    break;
  case XML_PARSER_PI:
    xmlGenericError(xmlGenericErrorContext, "PP: try PI\n");
    break;
  case XML_PARSER_IGNORE:
    xmlGenericError(xmlGenericErrorContext, "PP: try IGNORE\n");
    break;
  }
#endif
  ...
  while (1) {
    ...
    case XML_PARSER_CONTENT: {
      ...
      if ((cur == '<') && (next == '/')) {
        ...
        ctxt->instate = XML_PARSER_CONTENT;
                 ...
                 (ctxt->input->cur[2] == '[') && (ctxt->input->cur[3] == 'C') &&
    ...
    case XML_PARSER_END_TAG:
      ...
      if (ctxt->sax2) {
        xmlParseEndTag2(ctxt, (void *)ctxt->pushTab[ctxt->nameNr * 3 - 3],
    ...
    case XML_PARSER_CDATA_SECTION: {
      ...
      if (base < 0) {
        ...
        if ((ctxt->sax != NULL) && (base == 0) &&
            (ctxt->sax->cdataBlock != NULL) && (!ctxt->disableSAX)) {
          /*
    ...
    case XML_PARSER_DTD: {
      ...
      for (; (unsigned int)base < ctxt->input->buf->buffer->use; base++) {
        if (quote != 0) {
          if (buf[base] == quote)
            quote = 0;
          continue;
        ...
        if ((quote == 0) && (buf[base] == '<')) {
          ...
          if (((unsigned int)base + 4 < ctxt->input->buf->buffer->use) &&
              (buf[base + 1] == '!') && (buf[base + 2] == '-') &&
              (buf[base + 3] == '-')) {
            for (; (unsigned int)base + 3 < ctxt->input->buf->buffer->use;
                 base++) {
        ...
        if (buf[base] == ']') {
...
#endif
          if ((unsigned int)base + 1 >= ctxt->input->buf->buffer->use)
            break;
          if (buf[base + 1] == ']') {
          ...
          for (i = 1; (unsigned int)base + i < ctxt->input->buf->buffer->use;
               i++) {
            if (buf[base + i] == '>') {
#if 0
...
xmldecl_done:
  ...
  if ((end_in_lf == 1) && (ctxt->input != NULL) && (ctxt->input->buf != NULL)) {
...
xmlDtdPtr xmlIOParseDTD(xmlSAXHandlerPtr sax, xmlParserInputBufferPtr input,
  ...
  ctxt->myDoc->extSubset =
      xmlNewDtd(ctxt->myDoc, BAD_CAST "none", BAD_CAST "none", BAD_CAST "none");
...
xmlDtdPtr xmlSAXParseDTD(xmlSAXHandlerPtr sax, const xmlChar *ExternalID,
  ...
  if ((ctxt->sax != NULL) && (ctxt->sax->resolveEntity != NULL))
    input =
        ctxt->sax->resolveEntity(ctxt->userData, ExternalID, systemIdCanonic);
  if (input == NULL) {
    if (sax != NULL)
      ctxt->sax = NULL;
    xmlFreeParserCtxt(ctxt);
  ...
  ctxt->myDoc->properties = XML_DOC_INTERNAL;
  ctxt->myDoc->extSubset =
      xmlNewDtd(ctxt->myDoc, BAD_CAST "none", ExternalID, SystemID);
...
int xmlParseBalancedChunkMemory(xmlDocPtr doc, xmlSAXHandlerPtr sax,
  ...
  return xmlParseBalancedChunkMemoryRecover(doc, sax, user_data, depth, string,
                                            lst, 0);
}
#endif /* LIBXML_SAX1_ENABLED */
...
xmlParseBalancedChunkMemoryInternal(xmlParserCtxtPtr oldctxt,
  ...
  if ((lst != NULL) && (ret == XML_ERR_OK)) {
    ...
    *lst = cur;
    while (cur != NULL) {
#ifdef LIBXML_VALID_ENABLED
      if ((oldctxt->validate) && (oldctxt->wellFormed) && (oldctxt->myDoc) &&
          (oldctxt->myDoc->intSubset) && (cur->type == XML_ELEMENT_NODE)) {
        oldctxt->valid &=
            xmlValidateElement(&oldctxt->vctxt, oldctxt->myDoc, cur);
      }
#endif /* LIBXML_VALID_ENABLED */
      cur->parent = NULL;
      cur = cur->next;
 ...
 * error code otherwise
 */
xmlParserErrors xmlParseInNodeContext(xmlNodePtr node, const char *data,
 ...
 * Returns the resulting document tree
 */
xmlDocPtr xmlSAXParseMemory(xmlSAXHandlerPtr sax, const char *buffer, int size,
                            int recovery) {
...
xmlDocPtr xmlSAXParseDoc(xmlSAXHandlerPtr sax, const xmlChar *cur,
                         int recovery) {
  xmlDocPtr ret;
  xmlParserCtxtPtr ctxt;
  xmlSAXHandlerPtr oldsax = NULL;
 ...
 * Returns the resulting document tree
 */
xmlDocPtr xmlReadDoc(const xmlChar *cur, const char *URL, const char *encoding,
                     int options) {
  xmlParserCtxtPtr ctxt;
 ...
 * Returns the resulting document tree
 */
xmlDocPtr xmlReadFd(int fd, const char *URL, const char *encoding,
                    int options) {
  xmlParserCtxtPtr ctxt;
