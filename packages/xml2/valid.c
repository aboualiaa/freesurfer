...
static int xmlValidateAttributeValueInternal(xmlDocPtr doc,
...
static void xmlVErrMemory(xmlValidCtxtPtr ctxt, const char *extra) {
  ...
  if (extra)
    __xmlRaiseError(NULL, channel, data, pctxt, NULL, XML_FROM_VALID,
 ...
 */
static void xmlErrValid(xmlValidCtxtPtr ctxt, xmlParserErrors error,
  ...
  if (extra)
    __xmlRaiseError(NULL, channel, data, pctxt, NULL, XML_FROM_VALID, error,
                    XML_ERR_ERROR, NULL, 0, extra, NULL, NULL, 0, 0, msg,
                    extra);
  else
    __xmlRaiseError(NULL, channel, data, pctxt, NULL, XML_FROM_VALID, error,
                    XML_ERR_ERROR, NULL, 0, NULL, NULL, NULL, 0, 0, "%s", msg);
}
 ...
 */
static void xmlErrValidNode(xmlValidCtxtPtr ctxt, xmlNodePtr node,
  ...
  __xmlRaiseError(schannel, channel, data, pctxt, node, XML_FROM_VALID, error,
                  ...
                  (const char *)str1, (const char *)str3, 0, 0, msg, str1, str2,
                  str3);
}
 ...
 * Handle a validation error, provide contextual informations
 */
static void xmlErrValidNodeNr(xmlValidCtxtPtr ctxt, xmlNodePtr node,
                              xmlParserErrors error, const char *msg,
                              const xmlChar *str1, int int2,
                              const xmlChar *str3) {
  xmlStructuredErrorFunc schannel = NULL;
  xmlGenericErrorFunc channel = NULL;
  xmlParserCtxtPtr pctxt = NULL;
  ...
  __xmlRaiseError(schannel, channel, data, pctxt, node, XML_FROM_VALID, error,
                  XML_ERR_ERROR, NULL, 0, (const char *)str1,
                  (const char *)str3, NULL, int2, 0, msg, str1, int2, str3);
}
 ...
 */
static void xmlErrValidWarning(xmlValidCtxtPtr ctxt, xmlNodePtr node,
                               xmlParserErrors error, const char *msg,
                               const xmlChar *str1, const xmlChar *str2,
                               const xmlChar *str3) {
  xmlStructuredErrorFunc schannel = NULL;
...
static int vstateVPush(xmlValidCtxtPtr ctxt, xmlElementPtr elemDecl,
                       xmlNodePtr node) {
  ...
  if (ctxt->vstateNr >= ctxt->vstateMax) {
    ...
    tmp = (xmlValidState *)xmlRealloc(
        ctxt->vstateTab, 2 * ctxt->vstateMax * sizeof(ctxt->vstateTab[0]));
    if (tmp == NULL) {
  ...
  if ((elemDecl != NULL) && (elemDecl->etype == XML_ELEMENT_TYPE_ELEMENT)) {
    ...
    if (elemDecl->contModel != NULL) {
      ...
      xmlErrValidNode(ctxt, (xmlNodePtr)elemDecl, XML_ERR_INTERNAL_ERROR,
...
static int vstateVPush(xmlValidCtxtPtr ctxt, xmlElementContentPtr cont,
...
static int nodeVPush(xmlValidCtxtPtr ctxt, xmlNodePtr value) {
  if (ctxt->nodeMax <= 0) {
    ctxt->nodeMax = 4;
    ctxt->nodeTab =
        (xmlNodePtr *)xmlMalloc(ctxt->nodeMax * sizeof(ctxt->nodeTab[0]));
...
static void xmlValidPrintNode(xmlNodePtr cur) {
  if (cur == NULL) {
...
static void xmlValidPrintNodeList(xmlNodePtr cur) {
  if (cur == NULL)
    xmlGenericError(xmlGenericErrorContext, "null ");
  while (cur != NULL) {
...
static void xmlValidDebug(xmlNodePtr cur, xmlElementContentPtr cont) {
  char expr[5000];
...
static void xmlValidDebugState(xmlValidStatePtr state) {
  ...
  if (state->cont == NULL)
    ...
    case XML_ELEMENT_CONTENT_ELEMENT:
      xmlGenericError(xmlGenericErrorContext, "%s,", state->cont->name);
      break;
  ...
  xmlGenericError(xmlGenericErrorContext, ",%d,%X,%d)", state->depth,
                  state->occurs, state->state);
}
...
static void xmlValidStateDebug(xmlValidCtxtPtr ctxt) {
  ...
  xmlGenericError(xmlGenericErrorContext, " stack: %d ", ctxt->vstateNr - 1);
...
#define DEBUG_VALID_MSG(m) xmlGenericError(xmlGenericErrorContext, "%s\n", m);
 ...
 */
static int xmlValidBuildAContentModel(xmlElementContentPtr content,
  ...
  case XML_ELEMENT_CONTENT_ELEMENT: {
    ...
    case XML_ELEMENT_CONTENT_ONCE:
      ctxt->state =
          xmlAutomataNewTransition(ctxt->am, ctxt->state, NULL, fullname, NULL);
      break;
    ...
    case XML_ELEMENT_CONTENT_PLUS:
      ctxt->state =
          xmlAutomataNewTransition(ctxt->am, ctxt->state, NULL, fullname, NULL);
      xmlAutomataNewTransition(ctxt->am, ctxt->state, ctxt->state, fullname,
                               NULL);
      break;
...
void xmlFreeDocElementContent(xmlDocPtr doc, xmlElementContentPtr cur) {
  ...
  while (cur != NULL) {
    ...
    if (cur->c1 != NULL)
      xmlFreeDocElementContent(doc, cur->c1);
    if (dict) {
...
xmlElementPtr xmlAddElementDecl(xmlValidCtxtPtr ctxt, xmlDtdPtr dtd,
   ...
   */
  if ((ctxt != NULL) && ((ctxt->finishDtd == XML_CTXT_FINISH_DTD_0) ||
                         (ctxt->finishDtd == XML_CTXT_FINISH_DTD_1))) {
    ret->content = content;
    if (content != NULL)
...
xmlElementTablePtr xmlCopyElementTable(xmlElementTablePtr table) {
  return (
      (xmlElementTablePtr)xmlHashCopy(table, (xmlHashCopier)xmlCopyElement));
}
 ...
 */
static void xmlDumpEnumeration(xmlBufferPtr buf, xmlEnumerationPtr cur) {
 ...
 */
static int xmlScanIDAttributeDecl(xmlValidCtxtPtr ctxt, xmlElementPtr elem,
                                  int err) {
  xmlAttributePtr cur;
  int ret = 0;
 ...
 */
static xmlAttributePtr xmlCopyAttribute(xmlAttributePtr attr) {
  xmlAttributePtr cur;
 ...
 */
static void xmlDumpAttributeDeclScan(xmlAttributePtr attr, xmlBufferPtr buf) {
 ...
 */
static xmlNotationPtr xmlCopyNotation(xmlNotationPtr nota) {
  xmlNotationPtr cur;
...
xmlNotationTablePtr xmlCopyNotationTable(xmlNotationTablePtr table) {
  return (
      (xmlNotationTablePtr)xmlHashCopy(table, (xmlHashCopier)xmlCopyNotation));
}
#endif /* LIBXML_TREE_ENABLED */
 ...
 */
static void xmlDumpNotationDeclScan(xmlNotationPtr nota, xmlBufferPtr buf) {
 ...
 */
xmlIDPtr xmlAddID(xmlValidCtxtPtr ctxt, xmlDocPtr doc, const xmlChar *value,
                  xmlAttrPtr attr) {
  xmlIDPtr ret;
  xmlIDTablePtr table;
  ...
  if ((doc->intSubset == NULL) && (doc->extSubset == NULL) &&
    ...
    if (fullelemname != NULL && fullattrname != NULL) {
      ...
      if ((attrDecl == NULL) && (doc->extSubset != NULL))
        attrDecl =
            xmlGetDtdAttrDesc(doc->extSubset, fullelemname, fullattrname);
    }
 ...
 */
xmlRefPtr xmlAddRef(xmlValidCtxtPtr ctxt, xmlDocPtr doc, const xmlChar *value,
                    xmlAttrPtr attr) {
  xmlRefPtr ret;
...
xmlAttributePtr xmlGetDtdAttrDesc(xmlDtdPtr dtd, const xmlChar *elem,
                                  const xmlChar *name) {
  xmlAttributeTablePtr table;
  xmlAttributePtr cur;
  xmlChar *uqname = NULL, *prefix = NULL;
...
static int xmlIsDocNameStartChar(xmlDocPtr doc, int c) {
...
static int xmlIsDocNameChar(xmlDocPtr doc, int c) {
  if ((doc == NULL) || (doc->properties & XML_DOC_OLD10) == 0) {
    /*
     * Use the new checks of production [4] [4a] amd [5] of the
     * Update 5 of XML-1.0
...
static int xmlValidateNameValueInternal(xmlDocPtr doc, const xmlChar *value) {
  const xmlChar *cur;
  int val, len;
...
static int xmlValidateNamesValueInternal(xmlDocPtr doc, const xmlChar *value) {
  const xmlChar *cur;
  int val, len;
...
static int xmlValidateNmtokenValueInternal(xmlDocPtr doc,
                                           const xmlChar *value) {
  const xmlChar *cur;
  int val, len;
...
static int xmlValidateNmtokensValueInternal(xmlDocPtr doc,
                                            const xmlChar *value) {
  const xmlChar *cur;
  int val, len;
...
int xmlValidateNotationDecl(xmlValidCtxtPtr ctxt ATTRIBUTE_UNUSED,
...
static int xmlValidateAttributeValue2(xmlValidCtxtPtr ctxt, xmlDocPtr doc,
                                      const xmlChar *name,
                                      xmlAttributeType type,
                                      const xmlChar *value) {
  int ret = 1;
  ...
  case XML_ATTRIBUTE_ENTITY: {
    ...
    if (ent == NULL) {
      xmlErrValidNode(
          ctxt, (xmlNodePtr)doc, XML_DTD_UNKNOWN_ENTITY,
          "ENTITY attribute %s reference an unknown entity \"%s\"\n", name,
          value, NULL);
      ret = 0;
    } else if (ent->etype != XML_EXTERNAL_GENERAL_UNPARSED_ENTITY) {
      xmlErrValidNode(
          ctxt, (xmlNodePtr)doc, XML_DTD_ENTITY_TYPE,
  ...
  case XML_ATTRIBUTE_NOTATION: {
    ...
    if (nota == NULL) {
      xmlErrValidNode(
          ctxt, (xmlNodePtr)doc, XML_DTD_UNKNOWN_NOTATION,
  ...
  *dst = 0;
  if ((doc->standalone) && (extsubset == 1) && (!xmlStrEqual(value, ret))) {
    xmlErrValidNode(ctxt, elem, XML_DTD_NOT_STANDALONE,
                    "standalone: %s on %s value had to be normalized based on "
...
int xmlValidateAttributeDecl(xmlValidCtxtPtr ctxt, xmlDocPtr doc,
  ...
  if (attr->defaultValue != NULL) {
    val =
        xmlValidateAttributeValueInternal(doc, attr->atype, attr->defaultValue);
    if (val == 0) {
      xmlErrValidNode(
          ctxt, (xmlNodePtr)attr, XML_DTD_ATTRIBUTE_DEFAULT,
  ...
  if ((attr->atype == XML_ATTRIBUTE_ID) &&
    ...
    xmlErrValidNode(
        ctxt, (xmlNodePtr)attr, XML_DTD_ID_FIXED,
    ...
    if (elem != NULL) {
      ...
      if (doc->intSubset != NULL) {
        ...
        xmlHashScan3(table, NULL, NULL, attr->elem,
                     (xmlHashScanner)xmlValidateAttributeIdCallback, &nbId);
      }
    }
    if (nbId > 1) {

      xmlErrValidNodeNr(ctxt, (xmlNodePtr)attr, XML_DTD_ID_SUBSET,
                        "Element %s has %d ID attribute defined in the "
                        "internal subset : %s\n",
      ...
      if (extId > 1) {
        ...
        xmlErrValidNode(ctxt, (xmlNodePtr)attr, XML_DTD_ID_SUBSET,
                        "Element %s has ID attributes defined in the internal "
                        "and external subset : %s\n",
  ...
  if ((attr->defaultValue != NULL) && (attr->tree != NULL)) {
    ...
    if (tree == NULL) {
      xmlErrValidNode(ctxt, (xmlNodePtr)attr, XML_DTD_ATTRIBUTE_VALUE,
                      "Default value \"%s\" for attribute %s of %s is not "
          ...
          if (next->type == XML_ELEMENT_CONTENT_ELEMENT) {
            if ((xmlStrEqual(next->name, name)) &&
              ...
              if (cur->c1->prefix == NULL) {
                xmlErrValidNode(
                    ctxt, (xmlNodePtr)elem, XML_DTD_CONTENT_ERROR,
...
int xmlValidateOneAttribute(xmlValidCtxtPtr ctxt, xmlDocPtr doc,
                            xmlNodePtr elem, xmlAttrPtr attr,
                            const xmlChar *value) {
  xmlAttributePtr attrDecl = NULL;
  int val;
  int ret = 1;
  ...
  if ((elem->ns != NULL) && (elem->ns->prefix != NULL)) {
    ...
    if (fullname == NULL)
      return (0);
    if (attr->ns != NULL) {
      attrDecl = xmlGetDtdQAttrDesc(doc->intSubset, fullname, attr->name,
                                    attr->ns->prefix);
      if ((attrDecl == NULL) && (doc->extSubset != NULL))
        attrDecl = xmlGetDtdQAttrDesc(doc->extSubset, fullname, attr->name,
                                      attr->ns->prefix);
    } else {
  ...
  if (attrDecl->def == XML_ATTRIBUTE_FIXED) {
    if (!xmlStrEqual(value, attrDecl->defaultValue)) {
      xmlErrValidNode(
          ctxt, elem, XML_DTD_ATTRIBUTE_DEFAULT,
  ...
  if (attrDecl->atype == XML_ATTRIBUTE_NOTATION) {
    ...
    if (nota == NULL) {
      xmlErrValidNode(
          ctxt, elem, XML_DTD_UNKNOWN_NOTATION,
    ...
    if (tree == NULL) {
      xmlErrValidNode(ctxt, elem, XML_DTD_NOTATION_VALUE,
                      "Value \"%s\" for attribute %s of %s is not among the "
  ...
  ret &=
      xmlValidateAttributeValue2(ctxt, doc, attr->name, attrDecl->atype, value);
...
static int xmlValidateElementType(xmlValidCtxtPtr ctxt) {
  ...
  if ((NODE == NULL) && (CONT == NULL))
    return (1);
  if ((NODE == NULL) && ((CONT->ocur == XML_ELEMENT_CONTENT_MULT) ||
...
cont:
  ...
  case XML_ELEMENT_CONTENT_OR:
    ...
    if (vstateVPush(ctxt, CONT->c2, NODE, (unsigned char)(DEPTH + 1), OCCURS,
                    ROLLBACK_OR) < 0)
      return (-1);
    DEPTH++;
    CONT = CONT->c1;
 ...
 * Intended just for the debug routine
 */
static void xmlSnprintfElements(char *buf, int size, xmlNodePtr node,
                                int glob) {
  xmlNodePtr cur;
  int len;
...
static int xmlValidateElementContent(xmlValidCtxtPtr ctxt, xmlNodePtr child,
  ...
  ctxt->vstateMax = 8;
  ctxt->vstateTab =
      (xmlValidState *)xmlMalloc(ctxt->vstateMax * sizeof(ctxt->vstateTab[0]));
  if (ctxt->vstateTab == NULL) {
    xmlVErrMemory(ctxt, "malloc failed");
    return (-1);
  }
    ...
    if (ctxt != NULL) {
      ...
      if (name != NULL) {
        xmlErrValidNode(ctxt, parent, XML_DTD_CONTENT_MODEL,
                        "Element %s content does not follow the DTD, expecting "
                        "%s, got %s\n",
                        name, BAD_CAST expr, BAD_CAST list);
      } else {
        xmlErrValidNode(
            ctxt, parent, XML_DTD_CONTENT_MODEL,
 ...
 * returns 1 if valid or 0 otherwise
 */
static int xmlValidateOneCdataElement(xmlValidCtxtPtr ctxt, xmlDocPtr doc,
                                      xmlNodePtr elem) {
  int ret = 1;
 ...
 */
static int xmlValidateCheckMixed(xmlValidCtxtPtr ctxt,
                                 xmlElementContentPtr cont,
                                 const xmlChar *qname) {
  const xmlChar *name;
  int plen;
 ...
 */
static xmlElementPtr xmlValidGetElemDecl(xmlValidCtxtPtr ctxt, xmlDocPtr doc,
 ...
 */
int xmlValidatePushElement(xmlValidCtxtPtr ctxt, xmlDocPtr doc, xmlNodePtr elem,
                           const xmlChar *qname) {
  int ret = 1;
  xmlElementPtr eDecl;
  int extsubset = 0;
    ...
    if (state->elemDecl != NULL) {
      ...
      case XML_ELEMENT_TYPE_MIXED:
        ...
        if ((elemDecl->content != NULL) &&
          ...
          xmlErrValidNode(
              ctxt, state->node, XML_DTD_NOT_PCDATA,
          ...
          if (ret != 1) {
            xmlErrValidNode(
                ctxt, state->node, XML_DTD_INVALID_CHILD,
      ...
      case XML_ELEMENT_TYPE_ELEMENT:
        ...
        if (state->exec != NULL) {
          ...
          if (ret < 0) {
            xmlErrValidNode(
                ctxt, state->node, XML_DTD_CONTENT_MODEL,
        ...
        if (len > 0) {
          ...
          for (i = 0; i < len; i++) {
            if (!IS_BLANK_CH(data[i])) {
              xmlErrValidNode(ctxt, state->node, XML_DTD_CONTENT_MODEL,
                              "Element %s content does not follow the DTD, "
                              "Text not allowed\n",
                              state->node->name, NULL, NULL);
              ret = 0;
 ...
 * returns 1 if no validation problem was found or 0 otherwise
 */
int xmlValidatePopElement(xmlValidCtxtPtr ctxt, xmlDocPtr doc ATTRIBUTE_UNUSED,
    ...
    case XML_ELEMENT_TYPE_MIXED:
      ...
      while (child != NULL) {
        if (child->type == XML_ELEMENT_NODE) {
          ...
          if (cont == NULL) {
            xmlErrValidNode(
                ctxt, elem, XML_DTD_INVALID_CHILD,
                "Element %s is not declared in %s list of possible children\n",
                name, elem->name, NULL);
            ret = 0;
          }
          ...
          if (child->type == XML_TEXT_NODE) {
            ...
            if (*content == 0) {
              xmlErrValidNode(ctxt, elem, XML_DTD_STANDALONE_WHITE_SPACE,
                              "standalone: %s declared in the external subset "
                              "contains white spaces nodes\n",
                              elem->name, NULL, NULL);
              ret = 0;
              break;
            }
  ...
  while (attr != NULL) {
    if (attr->def == XML_ATTRIBUTE_REQUIRED) {
      ...
      if (qualified == -1) {
        ...
        xmlErrValidWarning(
            ctxt, elem, XML_DTD_NO_PREFIX,
            "Element %s required attribute %s:%s has no prefix\n", elem->name,
            attr->prefix, attr->name);
      } else if (qualified == 1) {
        xmlErrValidWarning(
            ctxt, elem, XML_DTD_DIFFERENT_PREFIX,
      ...
      if ((attr->prefix == NULL) &&
          ...
          if (ns->prefix == NULL) {
            if (!xmlStrEqual(attr->defaultValue, ns->href)) {
              xmlErrValidNode(ctxt, elem, XML_DTD_ELEM_DEFAULT_NAMESPACE,
                              "Element %s namespace name for default namespace "
        ...
        while (ns != NULL) {
          if (xmlStrEqual(attr->name, ns->prefix)) {
            if (!xmlStrEqual(attr->defaultValue, ns->href)) {
              xmlErrValidNode(
                  ctxt, elem, XML_DTD_ELEM_NAMESPACE,
...
int xmlValidateElement(xmlValidCtxtPtr ctxt, xmlDocPtr doc, xmlNodePtr elem) {
   ...
   */
  if ((elem->type == XML_XINCLUDE_START) || (elem->type == XML_XINCLUDE_END))
    return (1);
  ...
  if (elem->type == XML_ELEMENT_NODE) {
    ...
    while (ns != NULL) {
      if (elem->ns == NULL)
        ...
        ret &= xmlValidateOneNamespace(ctxt, doc, elem, elem->ns->prefix, ns,
                                       ns->href);
      ns = ns->next;
    }
  }
 ...
 *
 */
static void xmlValidateCheckRefCallback(xmlListPtr ref_list,
                                        xmlValidCtxtPtr ctxt,
                                        const xmlChar *name) {
...
static void xmlValidateNotationCallback(xmlEntityPtr cur, xmlValidCtxtPtr ctxt,
                                        const xmlChar *name ATTRIBUTE_UNUSED) {
  if (cur == NULL)
    return;
...
static void xmlValidateAttributeCallback(xmlAttributePtr cur,
                                         xmlValidCtxtPtr ctxt,
                                         const xmlChar *name ATTRIBUTE_UNUSED) {
  int ret;
  xmlDocPtr doc;
  ...
  case XML_ATTRIBUTE_NOTATION:
    if (cur->defaultValue != NULL) {
      ...
      ret = xmlValidateAttributeValue2(ctxt, ctxt->doc, cur->name, cur->atype,
                                       cur->defaultValue);
...
int xmlValidateDocument(xmlValidCtxtPtr ctxt, xmlDocPtr doc) {
  ...
  if ((doc->intSubset != NULL) &&
    ...
    if (doc->intSubset->SystemID != NULL) {
      ...
      sysID = NULL;
    doc->extSubset =
        xmlParseDTD(doc->intSubset->ExternalID, (const xmlChar *)sysID);
    if (sysID != NULL)
      xmlFree(sysID);
...
int xmlValidGetValidElements(xmlNode *prev, xmlNode *next,
   ...
   * still valid
   */
  nb_elements = xmlValidGetPotentialChildren(element_desc->content, elements,
                                             &nb_elements, 256);
