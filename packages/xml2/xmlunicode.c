...
static xmlIntFunc *xmlUnicodeLookup(xmlUnicodeNameTable *tptr,
                                    const char *tname);
...
static xmlUnicodeRange xmlUnicodeCats[] = {
    {"C", xmlUCSIsCatC},   {"Cc", xmlUCSIsCatCc}, {"Cf", xmlUCSIsCatCf},
    {"Co", xmlUCSIsCatCo}, {"Cs", xmlUCSIsCatCs}, {"L", xmlUCSIsCatL},
    {"Ll", xmlUCSIsCatLl}, {"Lm", xmlUCSIsCatLm}, {"Lo", xmlUCSIsCatLo},
    {"Lt", xmlUCSIsCatLt}, {"Lu", xmlUCSIsCatLu}, {"M", xmlUCSIsCatM},
    {"Mc", xmlUCSIsCatMc}, {"Me", xmlUCSIsCatMe}, {"Mn", xmlUCSIsCatMn},
    {"N", xmlUCSIsCatN},   {"Nd", xmlUCSIsCatNd}, {"Nl", xmlUCSIsCatNl},
    {"No", xmlUCSIsCatNo}, {"P", xmlUCSIsCatP},   {"Pc", xmlUCSIsCatPc},
    {"Pd", xmlUCSIsCatPd}, {"Pe", xmlUCSIsCatPe}, {"Pf", xmlUCSIsCatPf},
    {"Pi", xmlUCSIsCatPi}, {"Po", xmlUCSIsCatPo}, {"Ps", xmlUCSIsCatPs},
    {"S", xmlUCSIsCatS},   {"Sc", xmlUCSIsCatSc}, {"Sk", xmlUCSIsCatSk},
    {"Sm", xmlUCSIsCatSm}, {"So", xmlUCSIsCatSo}, {"Z", xmlUCSIsCatZ},
    {"Zl", xmlUCSIsCatZl}, {"Zp", xmlUCSIsCatZp}, {"Zs", xmlUCSIsCatZs}};

static const xmlChSRange xmlCS[] = {
    {0x0, 0x1f},      {0x7f, 0x9f},     {0xad, 0xad},     {0x600, 0x603},
    {0x6dd, 0x6dd},   {0x70f, 0x70f},   {0x17b4, 0x17b5}, {0x200b, 0x200f},
    {0x202a, 0x202e}, {0x2060, 0x2063}, {0x206a, 0x206f}, {0xd800, 0xd800},
    {0xdb7f, 0xdb80}, {0xdbff, 0xdc00}, {0xdfff, 0xe000}, {0xf8ff, 0xf8ff},
    {0xfeff, 0xfeff}, {0xfff9, 0xfffb}};
static const xmlChLRange xmlCL[] = {{0x1d173, 0x1d17a},  {0xe0001, 0xe0001},
                                    {0xe0020, 0xe007f},  {0xf0000, 0xf0000},
                                    {0xffffd, 0xffffd},  {0x100000, 0x100000},
                                    {0x10fffd, 0x10fffd}};
static xmlChRangeGroup xmlCG = {18, 7, xmlCS, xmlCL};

static const xmlChSRange xmlCfS[] = {
...
static const xmlChLRange xmlLL[] = {
    {0x10000, 0x1000b}, {0x1000d, 0x10026}, {0x10028, 0x1003a},
    {0x1003c, 0x1003d}, {0x1003f, 0x1004d}, {0x10050, 0x1005d},
    {0x10080, 0x100fa}, {0x10300, 0x1031e}, {0x10330, 0x10349},
    {0x10380, 0x1039d}, {0x10400, 0x1049d}, {0x10800, 0x10805},
    {0x10808, 0x10808}, {0x1080a, 0x10835}, {0x10837, 0x10838},
    {0x1083c, 0x1083c}, {0x1083f, 0x1083f}, {0x1d400, 0x1d454},
    ...
    {0x1d546, 0x1d546}, {0x1d54a, 0x1d550}, {0x1d552, 0x1d6a3},
    ...
    {0x1d7aa, 0x1d7c2}, {0x1d7c4, 0x1d7c9}, {0x20000, 0x20000},
    {0x2a6d6, 0x2a6d6}, {0x2f800, 0x2fa1d}};
static xmlChRangeGroup xmlLG = {279, 50, xmlLS, xmlLL};

static const xmlChSRange xmlLlS[] = {
    ...
    {0x22f, 0x22f},   {0x231, 0x231},   {0x233, 0x236},   {0x250, 0x2af},
    ...
    {0x3f5, 0x3f5},   {0x3f8, 0x3f8},   {0x3fb, 0x3fb},   {0x430, 0x45f},
    ...
    {0x4ca, 0x4ca},   {0x4cc, 0x4cc},   {0x4ce, 0x4ce},   {0x4d1, 0x4d1},
    ...
    {0x4f3, 0x4f3},   {0x4f5, 0x4f5},   {0x4f9, 0x4f9},   {0x501, 0x501},
    {0x503, 0x503},   {0x505, 0x505},   {0x507, 0x507},   {0x509, 0x509},
    {0x50b, 0x50b},   {0x50d, 0x50d},   {0x50f, 0x50f},   {0x561, 0x587},
    {0x1d00, 0x1d2b}, {0x1d62, 0x1d6b}, {0x1e01, 0x1e01}, {0x1e03, 0x1e03},
    ...
    {0x1e95, 0x1e9b}, {0x1ea1, 0x1ea1}, {0x1ea3, 0x1ea3}, {0x1ea5, 0x1ea5},
    ...
    {0x1ef7, 0x1ef7}, {0x1ef9, 0x1ef9}, {0x1f00, 0x1f07}, {0x1f10, 0x1f15},
    ...
    {0x1fe0, 0x1fe7}, {0x1ff2, 0x1ff4}, {0x1ff6, 0x1ff7}, {0x2071, 0x2071},
    {0x207f, 0x207f}, {0x210a, 0x210a}, {0x210e, 0x210f}, {0x2113, 0x2113},
    {0x212f, 0x212f}, {0x2134, 0x2134}, {0x2139, 0x2139}, {0x213d, 0x213d},
    {0x2146, 0x2149}, {0xfb00, 0xfb06}, {0xfb13, 0xfb17}, {0xff41, 0xff5a}};
static const xmlChLRange xmlLlL[] = {
    {0x10428, 0x1044f}, {0x1d41a, 0x1d433}, {0x1d44e, 0x1d454},
    {0x1d456, 0x1d467}, {0x1d482, 0x1d49b}, {0x1d4b6, 0x1d4b9},
    {0x1d4bb, 0x1d4bb}, {0x1d4bd, 0x1d4c3}, {0x1d4c5, 0x1d4cf},
    {0x1d4ea, 0x1d503}, {0x1d51e, 0x1d537}, {0x1d552, 0x1d56b},
    {0x1d586, 0x1d59f}, {0x1d5ba, 0x1d5d3}, {0x1d5ee, 0x1d607},
    {0x1d622, 0x1d63b}, {0x1d656, 0x1d66f}, {0x1d68a, 0x1d6a3},
    {0x1d6c2, 0x1d6da}, {0x1d6dc, 0x1d6e1}, {0x1d6fc, 0x1d714},
    {0x1d716, 0x1d71b}, {0x1d736, 0x1d74e}, {0x1d750, 0x1d755},
    {0x1d770, 0x1d788}, {0x1d78a, 0x1d78f}, {0x1d7aa, 0x1d7c2},
    {0x1d7c4, 0x1d7c9}};
static xmlChRangeGroup xmlLlG = {396, 28, xmlLlS, xmlLlL};

static const xmlChSRange xmlLmS[] = {
    {0x2b0, 0x2c1},   {0x2c6, 0x2d1},   {0x2e0, 0x2e4},   {0x2ee, 0x2ee},
    {0x37a, 0x37a},   {0x559, 0x559},   {0x640, 0x640},   {0x6e5, 0x6e6},
    {0xe46, 0xe46},   {0xec6, 0xec6},   {0x17d7, 0x17d7}, {0x1843, 0x1843},
    {0x1d2c, 0x1d61}, {0x3005, 0x3005}, {0x3031, 0x3035}, {0x303b, 0x303b},
    {0x309d, 0x309e}, {0x30fc, 0x30fe}, {0xff70, 0xff70}, {0xff9e, 0xff9f}};
static xmlChRangeGroup xmlLmG = {20, 0, xmlLmS, NULL};

static const xmlChSRange xmlLoS[] = {
    {0x1bb, 0x1bb},   {0x1c0, 0x1c3},   {0x5d0, 0x5ea},   {0x5f0, 0x5f2},
    {0x621, 0x63a},   {0x641, 0x64a},   {0x66e, 0x66f},   {0x671, 0x6d3},
    {0x6d5, 0x6d5},   {0x6ee, 0x6ef},   {0x6fa, 0x6fc},   {0x6ff, 0x6ff},
    ...
    {0xf49, 0xf6a},   {0xf88, 0xf8b},   {0x1000, 0x1021}, {0x1023, 0x1027},
    {0x1029, 0x102a}, {0x1050, 0x1055}, {0x10d0, 0x10f8}, {0x1100, 0x1159},
    ...
    {0x1760, 0x176c}, {0x176e, 0x1770}, {0x1780, 0x17b3}, {0x17dc, 0x17dc},
    {0x1820, 0x1842}, {0x1844, 0x1877}, {0x1880, 0x18a8}, {0x1900, 0x191c},
    {0x1950, 0x196d}, {0x1970, 0x1974}, {0x2135, 0x2138}, {0x3006, 0x3006},
    {0x303c, 0x303c}, {0x3041, 0x3096}, {0x309f, 0x309f}, {0x30a1, 0x30fa},
    {0x30ff, 0x30ff}, {0x3105, 0x312c}, {0x3131, 0x318e}, {0x31a0, 0x31b7},
    {0x31f0, 0x31ff}, {0x3400, 0x3400}, {0x4db5, 0x4db5}, {0x4e00, 0x4e00},
    {0x9fa5, 0x9fa5}, {0xa000, 0xa48c}, {0xac00, 0xac00}, {0xd7a3, 0xd7a3},
    {0xf900, 0xfa2d}, {0xfa30, 0xfa6a}, {0xfb1d, 0xfb1d}, {0xfb1f, 0xfb28},
    {0xfb2a, 0xfb36}, {0xfb38, 0xfb3c}, {0xfb3e, 0xfb3e}, {0xfb40, 0xfb41},
    {0xfb43, 0xfb44}, {0xfb46, 0xfbb1}, {0xfbd3, 0xfd3d}, {0xfd50, 0xfd8f},
    {0xfd92, 0xfdc7}, {0xfdf0, 0xfdfb}, {0xfe70, 0xfe74}, {0xfe76, 0xfefc},
    {0xff66, 0xff6f}, {0xff71, 0xff9d}, {0xffa0, 0xffbe}, {0xffc2, 0xffc7},
    {0xffca, 0xffcf}, {0xffd2, 0xffd7}, {0xffda, 0xffdc}};
static const xmlChLRange xmlLoL[] = {
    {0x10000, 0x1000b}, {0x1000d, 0x10026}, {0x10028, 0x1003a},
    {0x1003c, 0x1003d}, {0x1003f, 0x1004d}, {0x10050, 0x1005d},
    {0x4f4, 0x4f4},   {0x4f8, 0x4f8},   {0x500, 0x500},   {0x502, 0x502},
    {0x504, 0x504},   {0x506, 0x506},   {0x508, 0x508},   {0x50a, 0x50a},
    {0x50c, 0x50c},   {0x50e, 0x50e},   {0x531, 0x556},   {0x10a0, 0x10c5},
    ...
    {0x1e90, 0x1e90}, {0x1e92, 0x1e92}, {0x1e94, 0x1e94}, {0x1ea0, 0x1ea0},
    ...
    {0x1f48, 0x1f4d}, {0x1f59, 0x1f59}, {0x1f5b, 0x1f5b}, {0x1f5d, 0x1f5d},
    {0x1f5f, 0x1f5f}, {0x1f68, 0x1f6f}, {0x1fb8, 0x1fbb}, {0x1fc8, 0x1fcb},
    ...
    {0x212a, 0x212d}, {0x2130, 0x2131}, {0x2133, 0x2133}, {0x213e, 0x213f},
    {0x2145, 0x2145}, {0xff21, 0xff3a}};
static const xmlChLRange xmlLuL[] = {
    {0x10400, 0x10427}, {0x1d400, 0x1d419}, {0x1d434, 0x1d44d},
    {0x1d468, 0x1d481}, {0x1d49c, 0x1d49c}, {0x1d49e, 0x1d49f},
    {0x1d4a2, 0x1d4a2}, {0x1d4a5, 0x1d4a6}, {0x1d4a9, 0x1d4ac},
    {0x1d4ae, 0x1d4b5}, {0x1d4d0, 0x1d4e9}, {0x1d504, 0x1d505},
    {0x1d507, 0x1d50a}, {0x1d50d, 0x1d514}, {0x1d516, 0x1d51c},
    {0x1d538, 0x1d539}, {0x1d53b, 0x1d53e}, {0x1d540, 0x1d544},
    {0x1d546, 0x1d546}, {0x1d54a, 0x1d550}, {0x1d56c, 0x1d585},
    {0x1d5a0, 0x1d5b9}, {0x1d5d4, 0x1d5ed}, {0x1d608, 0x1d621},
    {0x1d63c, 0x1d655}, {0x1d670, 0x1d689}, {0x1d6a8, 0x1d6c0},
    {0x1d6e2, 0x1d6fa}, {0x1d71c, 0x1d734}, {0x1d756, 0x1d76e},
    {0x1d790, 0x1d7a8}};
static xmlChRangeGroup xmlLuG = {390, 31, xmlLuS, xmlLuL};

static const xmlChSRange xmlMS[] = {
...
static const xmlChSRange xmlMcS[] = {
    {0x903, 0x903},   {0x93e, 0x940},   {0x949, 0x94c},   {0x982, 0x983},
    {0x9be, 0x9c0},   {0x9c7, 0x9c8},   {0x9cb, 0x9cc},   {0x9d7, 0x9d7},
    {0xa03, 0xa03},   {0xa3e, 0xa40},   {0xa83, 0xa83},   {0xabe, 0xac0},
    {0xac9, 0xac9},   {0xacb, 0xacc},   {0xb02, 0xb03},   {0xb3e, 0xb3e},
    {0xb40, 0xb40},   {0xb47, 0xb48},   {0xb4b, 0xb4c},   {0xb57, 0xb57},
...
static const xmlChSRange xmlMnS[] = {
    {0x300, 0x357},   {0x35d, 0x36f},   {0x483, 0x486},   {0x591, 0x5a1},
    {0x5a3, 0x5b9},   {0x5bb, 0x5bd},   {0x5bf, 0x5bf},   {0x5c1, 0x5c2},
    {0x1810, 0x1819}, {0x1946, 0x194f}, {0x2070, 0x2070}, {0x2074, 0x2079},
    {0x2080, 0x2089}, {0x2153, 0x2183}, {0x2460, 0x249b}, {0x24ea, 0x24ff},
    {0x2776, 0x2793}, {0x3007, 0x3007}, {0x3021, 0x3029}, {0x3038, 0x303a},
    {0x3192, 0x3195}, {0x3220, 0x3229}, {0x3251, 0x325f}, {0x3280, 0x3289},
    {0x32b1, 0x32bf}, {0xff10, 0xff19}};
static const xmlChLRange xmlNL[] = {{0x10107, 0x10133},
                                    {0x10320, 0x10323},
                                    {0x1034a, 0x1034a},
                                    {0x104a0, 0x104a9},
                                    {0x1d7ce, 0x1d7ff}};
...
static const xmlChSRange xmlNdS[] = {
...
static const xmlChSRange xmlPdS[] = {
    {0x2d, 0x2d},     {0x58a, 0x58a},   {0x1806, 0x1806}, {0x2010, 0x2015},
...
static const xmlChSRange xmlPoS[] = {
...
static const xmlChSRange xmlPsS[] = {
    ...
    {0x23b4, 0x23b4}, {0x2768, 0x2768}, {0x276a, 0x276a}, {0x276c, 0x276c},
    {0x276e, 0x276e}, {0x2770, 0x2770}, {0x2772, 0x2772}, {0x2774, 0x2774},
    {0x27e6, 0x27e6}, {0x27e8, 0x27e8}, {0x27ea, 0x27ea}, {0x2983, 0x2983},
    ...
    {0x29fc, 0x29fc}, {0x3008, 0x3008}, {0x300a, 0x300a}, {0x300c, 0x300c},
    {0x300e, 0x300e}, {0x3010, 0x3010}, {0x3014, 0x3014}, {0x3016, 0x3016},
    {0x3018, 0x3018}, {0x301a, 0x301a}, {0x301d, 0x301d}, {0xfd3e, 0xfd3e},
...
static const xmlChSRange xmlSS[] = {
    {0x24, 0x24},     {0x2b, 0x2b},     {0x3c, 0x3e},     {0x5e, 0x5e},
    {0x60, 0x60},     {0x7c, 0x7c},     {0x7e, 0x7e},     {0xa2, 0xa9},
    {0xac, 0xac},     {0xae, 0xb1},     {0xb4, 0xb4},     {0xb6, 0xb6},
    ...
    {0xfffc, 0xfffd}};
static const xmlChLRange xmlSL[] = {
    {0x10102, 0x10102}, {0x10137, 0x1013f}, {0x1d000, 0x1d0f5},
    {0x1d100, 0x1d126}, {0x1d12a, 0x1d164}, {0x1d16a, 0x1d16c},
    {0x1d183, 0x1d184}, {0x1d18c, 0x1d1a9}, {0x1d1ae, 0x1d1dd},
...
static const xmlChSRange xmlScS[] = {
    {0x24, 0x24},     {0xa2, 0xa5},     {0x9f2, 0x9f3},   {0xaf1, 0xaf1},
    {0xbf9, 0xbf9},   {0xe3f, 0xe3f},   {0x17db, 0x17db}, {0x20a0, 0x20b1},
    {0xfdfc, 0xfdfc}, {0xfe69, 0xfe69}, {0xff04, 0xff04}, {0xffe0, 0xffe1},
    {0xffe5, 0xffe6}};
static xmlChRangeGroup xmlScG = {13, 0, xmlScS, NULL};

static const xmlChSRange xmlSkS[] = {
    {0x5e, 0x5e},     {0x60, 0x60},     {0xa8, 0xa8},     {0xaf, 0xaf},
    {0xb4, 0xb4},     {0xb8, 0xb8},     {0x2c2, 0x2c5},   {0x2d2, 0x2df},
...
static const xmlChSRange xmlSmS[] = {
...
static const xmlChLRange xmlSmL[] = {{0x1d6c1, 0x1d6c1}, {0x1d6db, 0x1d6db},
                                     {0x1d6fb, 0x1d6fb}, {0x1d715, 0x1d715},
                                     {0x1d735, 0x1d735}, {0x1d74f, 0x1d74f},
                                     {0x1d76f, 0x1d76f}, {0x1d789, 0x1d789},
                                     {0x1d7a9, 0x1d7a9}, {0x1d7c3, 0x1d7c3}};
static xmlChRangeGroup xmlSmG = {48, 10, xmlSmS, xmlSmL};

static const xmlChSRange xmlSoS[] = {
    {0xa6, 0xa7},     {0xa9, 0xa9},     {0xae, 0xae},     {0xb0, 0xb0},
    {0xb6, 0xb6},     {0x482, 0x482},   {0x60e, 0x60f},   {0x6e9, 0x6e9},
    {0x6fd, 0x6fe},   {0x9fa, 0x9fa},   {0xb70, 0xb70},   {0xbf3, 0xbf8},
    {0xbfa, 0xbfa},   {0xf01, 0xf03},   {0xf13, 0xf17},   {0xf1a, 0xf1f},
    {0xf34, 0xf34},   {0xf36, 0xf36},   {0xf38, 0xf38},   {0xfbe, 0xfc5},
    {0xfc7, 0xfcc},   {0xfcf, 0xfcf},   {0x1940, 0x1940}, {0x19e0, 0x19ff},
    {0x2100, 0x2101}, {0x2103, 0x2106}, {0x2108, 0x2109}, {0x2114, 0x2114},
    {0x2116, 0x2118}, {0x211e, 0x2123}, {0x2125, 0x2125}, {0x2127, 0x2127},
    {0x2129, 0x2129}, {0x212e, 0x212e}, {0x2132, 0x2132}, {0x213a, 0x213b},
    {0x214a, 0x214a}, {0x2195, 0x2199}, {0x219c, 0x219f}, {0x21a1, 0x21a2},
    {0x21a4, 0x21a5}, {0x21a7, 0x21ad}, {0x21af, 0x21cd}, {0x21d0, 0x21d1},
    {0x21d3, 0x21d3}, {0x21d5, 0x21f3}, {0x2300, 0x2307}, {0x230c, 0x231f},
    {0x2322, 0x2328}, {0x232b, 0x237b}, {0x237d, 0x239a}, {0x23b7, 0x23d0},
    {0x2400, 0x2426}, {0x2440, 0x244a}, {0x249c, 0x24e9}, {0x2500, 0x25b6},
    {0x25b8, 0x25c0}, {0x25c2, 0x25f7}, {0x2600, 0x2617}, {0x2619, 0x266e},
    {0x2670, 0x267d}, {0x2680, 0x2691}, {0x26a0, 0x26a1}, {0x2701, 0x2704},
    {0x2706, 0x2709}, {0x270c, 0x2727}, {0x2729, 0x274b}, {0x274d, 0x274d},
    {0x274f, 0x2752}, {0x2756, 0x2756}, {0x2758, 0x275e}, {0x2761, 0x2767},
    {0x2794, 0x2794}, {0x2798, 0x27af}, {0x27b1, 0x27be}, {0x2800, 0x28ff},
    {0x2b00, 0x2b0d}, {0x2e80, 0x2e99}, {0x2e9b, 0x2ef3}, {0x2f00, 0x2fd5},
    {0x2ff0, 0x2ffb}, {0x3004, 0x3004}, {0x3012, 0x3013}, {0x3020, 0x3020},
    {0x3036, 0x3037}, {0x303e, 0x303f}, {0x3190, 0x3191}, {0x3196, 0x319f},
    {0x3200, 0x321e}, {0x322a, 0x3243}, {0x3250, 0x3250}, {0x3260, 0x327d},
    {0x327f, 0x327f}, {0x328a, 0x32b0}, {0x32c0, 0x32fe}, {0x3300, 0x33ff},
    {0x4dc0, 0x4dff}, {0xa490, 0xa4c6}, {0xfdfd, 0xfdfd}, {0xffe4, 0xffe4},
    {0xffe8, 0xffe8}, {0xffed, 0xffee}, {0xfffc, 0xfffd}};
static const xmlChLRange xmlSoL[] = {{0x10102, 0x10102}, {0x10137, 0x1013f},
                                     {0x1d000, 0x1d0f5}, {0x1d100, 0x1d126},
                                     {0x1d12a, 0x1d164}, {0x1d16a, 0x1d16c},
                                     {0x1d183, 0x1d184}, {0x1d18c, 0x1d1a9},
                                     {0x1d1ae, 0x1d1dd}, {0x1d300, 0x1d356}};
static xmlChRangeGroup xmlSoG = {103, 10, xmlSoS, xmlSoL};

static const xmlChSRange xmlZS[] = {
    {0x20, 0x20},     {0xa0, 0xa0},     {0x1680, 0x1680},
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsBuhid(int code) { return (((code >= 0x1740) && (code <= 0x175F))); }
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of CJKCompatibilityIdeographsSupplement
 * UCS Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of CJKUnifiedIdeographsExtensionA UCS
 * Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of CJKUnifiedIdeographsExtensionB UCS
 * Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of CombiningDiacriticalMarksforSymbols
 * UCS Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsGreek(int code) { return (((code >= 0x0370) && (code <= 0x03FF))); }
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of IdeographicDescriptionCharacters UCS
 * Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsKhmer(int code) { return (((code >= 0x1780) && (code <= 0x17FF))); }
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsLao(int code) { return (((code >= 0x0E80) && (code <= 0x0EFF))); }
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsLimbu(int code) { return (((code >= 0x1900) && (code <= 0x194F))); }
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of MathematicalAlphanumericSymbols UCS
 * Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of MiscellaneousMathematicalSymbols-A UCS
 * Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of MiscellaneousMathematicalSymbols-B UCS
 * Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of MiscellaneousSymbolsandArrows UCS
 * Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsOgham(int code) { return (((code >= 0x1680) && (code <= 0x169F))); }
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsRunic(int code) { return (((code >= 0x16A0) && (code <= 0x16FF))); }
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of SupplementalMathematicalOperators UCS
 * Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of SupplementaryPrivateUseArea-A UCS
 * Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of SupplementaryPrivateUseArea-B UCS
 * Block
 *
 * Returns 1 if true 0 otherwise
 */
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsTaiLe(int code) { return (((code >= 0x1950) && (code <= 0x197F))); }
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsTamil(int code) { return (((code >= 0x0B80) && (code <= 0x0BFF))); }
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsThai(int code) { return (((code >= 0x0E00) && (code <= 0x0E7F))); }
 ...
 * @code: UCS code point
 *
 * Check whether the character is part of UnifiedCanadianAboriginalSyllabics UCS
 * Block
 *
 * Returns 1 if true 0 otherwise
 */
...
int xmlUCSIsCatCo(int code) {
  return ((code == 0xe000) || (code == 0xf8ff) || (code == 0xf0000) ||
          (code == 0xffffd) || (code == 0x100000) || (code == 0x10fffd));
}
...
int xmlUCSIsCatCs(int code) {
  return ((code == 0xd800) || ((code >= 0xdb7f) && (code <= 0xdb80)) ||
          ((code >= 0xdbff) && (code <= 0xdc00)) || (code == 0xdfff));
}
...
int xmlUCSIsCatMe(int code) {
  return (((code >= 0x488) && (code <= 0x489)) || (code == 0x6de) ||
...
int xmlUCSIsCatNl(int code) {
  return (((code >= 0x16ee) && (code <= 0x16f0)) ||
          ((code >= 0x2160) && (code <= 0x2183)) || (code == 0x3007) ||
          ((code >= 0x3021) && (code <= 0x3029)) ||
          ((code >= 0x3038) && (code <= 0x303a)) || (code == 0x1034a));
}
...
int xmlUCSIsCatPc(int code) {
  return ((code == 0x5f) || ((code >= 0x203f) && (code <= 0x2040)) ||
          (code == 0x2054) || (code == 0x30fb) ||
...
int xmlUCSIsCatPf(int code) {
  return ((code == 0xbb) || (code == 0x2019) || (code == 0x201d) ||
          (code == 0x203a));
}
...
int xmlUCSIsCatPi(int code) {
  return ((code == 0xab) || (code == 0x2018) ||
          ((code >= 0x201b) && (code <= 0x201c)) || (code == 0x201f) ||
          (code == 0x2039));
}
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatZl(int code) { return ((code == 0x2028)); }
...
int xmlUCSIsCatZs(int code) {
  return ((code == 0x20) || (code == 0xa0) || (code == 0x1680) ||
