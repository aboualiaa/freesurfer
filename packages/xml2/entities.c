...
static xmlEntity xmlEntityLt = {NULL,
                                XML_ENTITY_DECL,
                                BAD_CAST "lt",
                                NULL,
                                NULL,
                                ...
                                0,
                                1};
static xmlEntity xmlEntityGt = {NULL,
                                XML_ENTITY_DECL,
                                BAD_CAST "gt",
                                NULL,
                                NULL,
                                ...
                                0,
                                1};
static xmlEntity xmlEntityAmp = {NULL,
                                 XML_ENTITY_DECL,
                                 BAD_CAST "amp",
                                 NULL,
                                 NULL,
                                 ...
                                 0,
                                 1};
static xmlEntity xmlEntityQuot = {NULL,
                                  XML_ENTITY_DECL,
                                  BAD_CAST "quot",
                                  NULL,
                                  NULL,
                                  ...
                                  0,
                                  1};
static xmlEntity xmlEntityApos = {NULL,
                                  XML_ENTITY_DECL,
                                  BAD_CAST "apos",
                                  NULL,
                                  NULL,
...
static void xmlFreeEntity(xmlEntityPtr entity) {
  ...
  if (dict != NULL) {
    ...
    if ((entity->SystemID != NULL) && (!xmlDictOwns(dict, entity->SystemID)))
      xmlFree((char *)entity->SystemID);
    if ((entity->URI != NULL) && (!xmlDictOwns(dict, entity->URI)))
      xmlFree((char *)entity->URI);
    if ((entity->content != NULL) && (!xmlDictOwns(dict, entity->content)))
 ...
 */
static xmlEntityPtr xmlGetEntityFromTable(xmlEntitiesTablePtr table,
                                          const xmlChar *name) {
 ...
 * Returns A newly allocated string with the substitution done.
 */
xmlChar *xmlEncodeSpecialChars(xmlDocPtr doc ATTRIBUTE_UNUSED,
                               const xmlChar *input) {
  const xmlChar *cur = input;
  xmlChar *buffer = NULL;
  xmlChar *out = NULL;
 ...
 */
static void xmlFreeEntityWrapper(xmlEntityPtr entity,
