...
#define DCM_MAKETAG(g, e)                                                      \
  (((((unsigned int)(g)) << 16) & 0xffff0000) | ((unsigned int)(e)&0xffff))
 ...
 */
CONDITION DCM_OpenFile(const char *name, unsigned long opt,
                       DCM_OBJECT **object);
...
typedef CONDITION(DCM_EXPORT_STREAM_CALLBACK)(void *buf, U32 bytesExported,
                                              int lastFlag, void *ctx);
...
DCM_ExportStream(DCM_OBJECT **obj, unsigned long opt, void *buf,
                 ...
                 void *ctx);
CONDITION
DCM_GetElementValue(DCM_OBJECT **obj, DCM_ELEMENT *element, U32 *rtnLength,
                    void **ctx);
char *DCM_GetString(DCM_OBJECT **obj, DCM_TAG tag);

CONDITION
DCM_GetElement(DCM_OBJECT **obj, DCM_TAG tag, DCM_ELEMENT *attribute);
CONDITION
DCM_GetElementSize(DCM_OBJECT **obj, DCM_TAG tag, U32 *retlen);
CONDITION
DCM_GetElementValueOffset(DCM_OBJECT **obj, DCM_ELEMENT *element,
                          unsigned long offset);
typedef CONDITION(DCM_GET_COMPRESSED_CALLBACK)(void *buf, U32 bytesExported,
                                               int index, int startFlag,
                                               int lastFlag,
                                               int startOfFragment, void *ctx);

CONDITION
DCM_GetCompressedValue(DCM_OBJECT **obj, DCM_TAG tag, void *buf, size_t bufSize,
                       DCM_GET_COMPRESSED_CALLBACK *callback, void *ctx);
...
CONDITION
DCM_ModifyElements(DCM_OBJECT **obj, DCM_ELEMENT *element, int count,
                   DCM_FLAGGED_ELEMENT *flaggedElement, int flagCount,
                   int *updateCount);
...
#define DCM_FILEIOERROR /* File I/O error */ FORM_COND(FAC_DCM, SEV_ERROR, 29)
...
#define DCM_IDPRIVATECODINGSCHEMECREATORUID                                    \
  DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x010C)
#define DCM_IDCODESETEXTENSIONCREATORUID                                       \
  DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x010D)
...
#define DCM_IDREFERENCEDSTUDYCOMPONENTSEQ                                      \
  DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x1111)
...
#define DCM_IDREFERENCEDPREVIOUSWAVEFORM                                       \
  DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x1148)
#define DCM_IDREFERENCEDSIMULTANEOUSWAVEFORMS                                  \
  DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x114A)
#define DCM_IDREFERENCEDSUBSEQUENTWAVEFORM                                     \
  DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x114C)
...
#define DCM_IDANATOMICREGIONMODIFIERSEQ                                        \
  DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x2220)
#define DCM_IDPRIMARYANATOMICSTRUCTURESEQ                                      \
  DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x2228)
#define DCM_IDPRIMARYANATOMICSTRUCTUREMODIFIERSEQ                              \
  DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x2230)
#define DCM_IDTRANSDUCERPOSITIONSEQ DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x2240)
#define DCM_IDTRANSDUCERPOSITIONMODIFIERSEQ                                    \
  DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x2242)
#define DCM_IDTRANSDUCERORIENTATIONSEQ DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x2244)
#define DCM_IDTRANSDUCERORIENTATIONMODIFIERSEQ                                 \
  DCM_MAKETAG(DCM_GROUPIDENTIFYING, 0x2246)
...
#define DCM_ACQCONTRASTBOLUSADMINROUTESEQ                                      \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x0014)
...
#define DCM_ACQINTERVENTIONDRUGSTOPTIME                                        \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x0027)
...
#define DCM_ACQINTERVENTIONALTHERAPYSEQ                                        \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x0036)
...
#define DCM_ACQTERMINATIONCONDITIONDATA                                        \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x0075)
...
#define DCM_ACQSECONDARYCAPTMANUFACTURER                                       \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1016)
#define DCM_ACQSECONDARYCAPTMODEL DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1018)
#define DCM_ACQSECONDARYCAPTSOFTWAREVERSION                                    \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1019)
...
#define DCM_ACQCONTRASTBOLUSINGREDIENTCONCENTRATION                            \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1049)
...
#define DCM_ACQRADIONUCLIDEPOSITRONFRACTION                                    \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1076)
#define DCM_ACQRADIOPHARMACEUTICALSPECIFICACTIVITY                             \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1077)
...
#define DCM_ACQESTIMATEDRADIOGRAPHICMAGFACTOR                                  \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1114)
...
#define DCM_ACQTABLELONGITUDINALINCREMENT                                      \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1137)
...
#define DCM_ACQPOSITIONERSECONDARYANGLE                                        \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1511)
#define DCM_ACQPOSITIONERPRIMARYANGLEINCR                                      \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1520)
#define DCM_ACQPOSITIONERSECONDARYANGLEINCR                                    \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1521)
...
#define DCM_ACQSHUTTERRIGHTVERTICALEDGE                                        \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1604)
#define DCM_ACQSHUTTERUPPERHORIZONTALEDGE                                      \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1606)
#define DCM_ACQSHUTTERLOWERHORIZONTALEDGE                                      \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1608)
...
#define DCM_ACQVERTICESOFPOLYGONALSHUTTER                                      \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1620)
#define DCM_ACQSHUTTERPRESENTATIONVALUE                                        \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1622)
#define DCM_ACQCOLLIMATORSHAPE DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1700)
#define DCM_ACQCOLLIMATORLEFTVERTICALEDGE                                      \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1702)
#define DCM_ACQCOLLIMATORRIGHTVERTICALEDGE                                     \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1704)
#define DCM_ACQCOLLIMATORUPPERHORIZONTALEDGE                                   \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1706)
#define DCM_ACQCOLLIMATORLOWERHORIZONTALEDGE                                   \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1708)
#define DCM_ACQCENTEROFCIRCULARCOLLIMATOR                                      \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1710)
#define DCM_ACQRADIUSOFCIRCULARCOLLIMATOR                                      \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1712)
#define DCM_ACQVERTICESOFPOLYGONALCOLLIMATOR                                   \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1720)
#define DCM_ACQACQUISITIONTIMESYNCHRONIZED                                     \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1800)
#define DCM_ACQTIMESOURCE DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1801)
#define DCM_ACQTIMEDISTRIBUTIONPROTOCOL                                        \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x1802)
...
#define DCM_ACQSOFTTISSUEFOCUSTHERMALINDEX                                     \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x5028)
#define DCM_ACQSOFTTISSUESURFACETHERMALINDEX                                   \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x5029)
...
#define DCM_ACQIMAGETRANSFORMATIONMATRIX                                       \
  DCM_MAKETAG(DCM_GROUPACQUISITION, 0x5210)
...
#define DCM_RELIMAGEORIENTATIONPATIENT                                         \
  DCM_MAKETAG(DCM_GROUPRELATIONSHIP, 0x0037)
/* Retired 0050 */
...
#define DCM_RELNUMBERTEMPORALPOSITIONS                                         \
  DCM_MAKETAG(DCM_GROUPRELATIONSHIP, 0x0105)
...
#define DCM_RELNUMBERPATRELATEDSTUDIES                                         \
  DCM_MAKETAG(DCM_GROUPRELATIONSHIP, 0x1200)
...
#define DCM_RELNUMBERSTUDYRELATEDSERIES                                        \
  DCM_MAKETAG(DCM_GROUPRELATIONSHIP, 0x1206)
#define DCM_RELNUMBERSTUDYRELATEDIMAGES                                        \
  DCM_MAKETAG(DCM_GROUPRELATIONSHIP, 0x1208)
#define DCM_RELNUMBERSERIESRELATEDINST                                         \
  DCM_MAKETAG(DCM_GROUPRELATIONSHIP, 0x1209)
...
#define DCM_RELMODIFIEDIMAGEDESCRIPTION                                        \
  DCM_MAKETAG(DCM_GROUPRELATIONSHIP, 0x3406)
...
#define DCM_RELORIGINALIMAGEIDNOMENCLATURE                                     \
  DCM_MAKETAG(DCM_GROUPRELATIONSHIP, 0x5002)
...
#define DCM_PRCSCHEDULEDPROCSTEPDESCRIPTION                                    \
  DCM_MAKETAG(DCM_GRPPROCEDURE, 0x0007)
...
#define DCM_PRCPATIENTTRANSPORTARRANGEMENTS                                    \
  DCM_MAKETAG(DCM_GRPPROCEDURE, 0x1004)
...
#define DCM_PRCNAMESINTENDEDRECIPIENTSRESULTS                                  \
  DCM_MAKETAG(DCM_GRPPROCEDURE, 0x1010)
...
#define DCM_PRCPLACERORDERNUMBERIMAGINGSRVREQ                                  \
  DCM_MAKETAG(DCM_GRPPROCEDURE, 0x2006)
#define DCM_PRCFILLERORDERNUMBERIMAGINGSRVREQ                                  \
  DCM_MAKETAG(DCM_GRPPROCEDURE, 0x2007)
...
#define DCM_PRCCONFIDIENTIALITYCONSTRAINTPATIENTDATADES                        \
  DCM_MAKETAG(DCM_GRPPROCEDURE, 0x3001)
...
#define DCM_NMIVIEWANGULATIONMODIFIERCODESEQ                                   \
  DCM_MAKETAG(DCM_GROUPNMIMAGE, 0x0222)
...
#define DCM_NMIPATIENTORIENTATIONMODIFIERCODESEQ                               \
  DCM_MAKETAG(DCM_GROUPNMIMAGE, 0x0412)
#define DCM_NMIPATIENTGANTRYRELATIONSHIPCODESEQ                                \
  DCM_MAKETAG(DCM_GROUPNMIMAGE, 0x0414)
...
#define DCM_BFSREFERENCEDFILMBOXSEQ                                            \
  DCM_MAKETAG(DCM_GROUPBASICFILMSESSION, 0x0500)
...
#define DCM_BFBANNOTATIONDISPLAYFORMAT                                         \
  DCM_MAKETAG(DCM_GROUPBASICFILMBOX, 0x0030)
...
#define DCM_BIBPREFORMATGREYSCALEIMAGESEQ                                      \
  DCM_MAKETAG(DCM_GROUPBASICIMAGEBOX, 0x0110)
#define DCM_BIBPREFORMATCOLORIMAGESEQ                                          \
  DCM_MAKETAG(DCM_GROUPBASICIMAGEBOX, 0x0111)
...
#define DCM_BABANNOTATIONPOSITION                                              \
  DCM_MAKETAG(DCM_GROUPBASICANNOTATIONBOX, 0x0010)
...
#define DCM_IOBREFOVERLAYPLANESEQ                                              \
  DCM_MAKETAG(DCM_GROUPBASICIMAGEOVERLAYBOX, 0x0010)
#define DCM_IOBREFOVERLAYPLANEGROUPS                                           \
  DCM_MAKETAG(DCM_GROUPBASICIMAGEOVERLAYBOX, 0x0011)
#define DCM_IOBOVERLAYMAGNIFICATIONTYPE                                        \
  DCM_MAKETAG(DCM_GROUPBASICIMAGEOVERLAYBOX, 0x0060)
#define DCM_IOBOVERLAYSMOOTHINGTYPE                                            \
  DCM_MAKETAG(DCM_GROUPBASICIMAGEOVERLAYBOX, 0x0070)
#define DCM_IOBOVERLAYFOREGROUNDDENSITY                                        \
  DCM_MAKETAG(DCM_GROUPBASICIMAGEOVERLAYBOX, 0x0080)
#define DCM_IOBOVERLAYMODE DCM_MAKETAG(DCM_GROUPBASICIMAGEOVERLAYBOX, 0x0090)
#define DCM_IOBTHRESHOLDDENSITY                                                \
  DCM_MAKETAG(DCM_GROUPBASICIMAGEOVERLAYBOX, 0x0100)
#define DCM_IOBREFIMAGEBOXSEQUENCE                                             \
  DCM_MAKETAG(DCM_GROUPBASICIMAGEOVERLAYBOX, 0x0500)
