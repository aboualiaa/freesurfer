/* $Header: /cvsroot/osrs/libtiff/libtiff/tif_aux.c,v 1.6 2003/12/06 15:55:41
 * dron Exp $ */
...
static void TIFFDefaultTransferFunction(TIFFDirectory *td) {
...
static void TIFFDefaultRefBlackWhite(TIFFDirectory *td) {
  int i;
