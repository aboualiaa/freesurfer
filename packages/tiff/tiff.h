/* $Header: /cvsroot/osrs/libtiff/libtiff/tiff.h,v 1.19 2003/12/20 13:40:09 dron
 * Exp $ */
...
typedef unsigned short uint16; /* sizeof (uint16) must == 2 */
    ...
    defined(__LP64__) || defined(__arch64__)
typedef int int32;
...
#define TIFFTAG_XMLPACKET                                                      \
  700 /* %XML packet [Adobe XMP technote 9-14-02] (dkelly@apago.com) */
...
#define TIFFTAG_IT8TRAPINDICATOR                                               \
  34031 /* Trapping indicator (untrapped=0, trapped=1) */
