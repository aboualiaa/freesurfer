/* $Header: /cvsroot/osrs/libtiff/libtiff/tif_open.c,v 1.11 2003/09/25 08:36:21
 * dron Exp $ */
 ...
 */
static void TIFFInitOrder(TIFF *tif, int magic, int bigendian) {
...
TIFF *TIFFClientOpen(const char *name, const char *mode, thandle_t clientdata,
  ...
  if (tif->tif_header.tiff_version != TIFF_VERSION) {
    TIFFError(name, "Not a TIFF file, bad version number %d (0x%x)",
