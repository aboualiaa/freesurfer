...
typedef enum {                 /* Operating modes for buffer controllers */
               ...
               /* Remaining modes require a full-image buffer to have been
                  created */
...
struct jpeg_marker_writer {
  ...
  JMETHOD(void, write_marker_header,
