...
bool Sketch::init(const SvmRealVector &alpha, double b,
...
bool Sketch::init(const SvmRealVector &alpha, const IntVector &dataIndex,
                  double b, const DoubleMatrix &kernelMatrix, int posCount,
                  int negCount, double threshold) {
