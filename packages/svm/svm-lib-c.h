...
/* weights is the weights vector at point vec. If using linear classifier, vec
 * could be NULL */
...
/* label contains the results of applying the classifiers to the corresponding
 * hold-out point */
