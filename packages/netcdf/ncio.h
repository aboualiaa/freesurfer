 ...
 */
/* $Id: ncio.h,v 1.23 1997/10/06 20:12:15 davis Exp $ */
 ...
 */
typedef int ncio_getfunc(ncio *const nciop, off_t offset, size_t extent,
...
extern int ncio_open(const char *path, int ioflags, off_t igeto, size_t igetsz,
                     size_t *sizehintp, ncio **nciopp, void **const igetvpp);

extern int ncio_close(ncio *nciop, int doUnlink);
