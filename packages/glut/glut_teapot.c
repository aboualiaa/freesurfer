...
static int patchdata[][16] = {
    ...
    /* bottom */
    {118, 118, 118, 118, 124, 122, 119, 121, 123, 126, 125, 120, 40, 39, 38,
     37},
    /* handle */
...
/* CENTRY */
void APIENTRY glutSolidTeapot(GLdouble scale) { teapot(14, scale, GL_FILL); }

void APIENTRY glutWireTeapot(GLdouble scale) { teapot(10, scale, GL_LINE); }
