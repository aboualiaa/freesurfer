...
/**
 ...
 GLUT_XLIB_IMPLEMENTATION=12 mjk's GLUT 3.6 release with early GLUT 4 routines +
signal handling.
...
extern void APIENTRY glutKeyboardFunc(void (*func)(unsigned char key, int x,
                                                   int y));
extern void APIENTRY glutMouseFunc(void (*func)(int button, int state, int x,
                                                int y));
...
extern void APIENTRY glutTimerFunc(unsigned int millis, void (*func)(int value),
                                   int value);
...
extern void APIENTRY glutSpaceballButtonFunc(void (*func)(int button,
                                                          int state));
...
extern void APIENTRY glutTabletButtonFunc(void (*func)(int button, int state,
                                                       int x, int y));
#if (GLUT_API_VERSION >= 3)
...
#endif
#if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 13)
extern void APIENTRY glutKeyboardUpFunc(void (*func)(unsigned char key, int x,
                                                     int y));
...
extern void APIENTRY glutSetColor(int, GLfloat red, GLfloat green,
                                  GLfloat blue);
...
extern void APIENTRY glutWireSphere(GLdouble radius, GLint slices,
                                    GLint stacks);
extern void APIENTRY glutSolidSphere(GLdouble radius, GLint slices,
                                     GLint stacks);
...
extern void APIENTRY glutWireTorus(GLdouble innerRadius, GLdouble outerRadius,
                                   GLint sides, GLint rings);
extern void APIENTRY glutSolidTorus(GLdouble innerRadius, GLdouble outerRadius,
                                    GLint sides, GLint rings);
