...
int _nrrdFormatEPS_available(void) { return AIR_FALSE; }
...
int _nrrdFormatEPS_fitsInto(const Nrrd *nrrd, const NrrdEncoding *encoding,
                            int useBiff) {
...
int _nrrdFormatEPS_write(FILE *file, const Nrrd *nrrd, NrrdIoState *nio) {
