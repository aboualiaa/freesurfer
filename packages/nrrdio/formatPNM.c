...
int _nrrdFormatPNM_available(void) { return AIR_FALSE; }
...
int _nrrdFormatPNM_fitsInto(const Nrrd *nrrd, const NrrdEncoding *encoding,
                            int useBiff) {
...
int _nrrdFormatPNM_write(FILE *file, const Nrrd *nrrd, NrrdIoState *nio) {
