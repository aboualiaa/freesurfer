...
int _nrrdEncodingBzip2_available(void) { return AIR_FALSE; }

int _nrrdEncodingBzip2_read(FILE *file, void *data, size_t elementNum,
...
int _nrrdEncodingBzip2_write(FILE *file, const void *data, size_t elementNum,
