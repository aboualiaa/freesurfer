...
int _nrrdFormatVTK_available(void) { return AIR_FALSE; }
...
int _nrrdFormatVTK_fitsInto(const Nrrd *nrrd, const NrrdEncoding *encoding,
                            int useBiff) {
...
int _nrrdFormatVTK_write(FILE *file, const Nrrd *nrrd, NrrdIoState *nio) {
