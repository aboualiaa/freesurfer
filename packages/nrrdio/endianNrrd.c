...
void _nrrdSwap16Endian(void *_data, size_t N) {
  short *data, s, fix;
  size_t I;
...
void _nrrdSwap32Endian(void *_data, size_t N) {
  int *data, w, fix;
  size_t I;
...
void _nrrdSwap64Endian(void *_data, size_t N) {
  airLLong *data, l, fix;
  size_t I;
...
void _nrrdNoopEndian(void *data, size_t N) {
  AIR_UNUSED(data);
  AIR_UNUSED(N);
  return;
}

void _nrrdBlockEndian(void *data, size_t N) {
...
void (*_nrrdSwapEndian[])(void *, size_t) = {
