...
protected:
  ...
  void SetArgument(std::vector<Argument *> *iArguments, std::string iFlag,
                   std::string iShortDescription, std::string iLongDescription,
                   std::string iExample, std::string iErrorMessage);
...
public:
  ...
  static void WriteData(const std::string fileName, double **dataArray,
                        const int nRows, const int cCols);

  static void WriteData(const std::string fileName, const float *data,
                        const int nRows, const int nCols);

  static void WriteDataAppend(const std::string fileName, double **dataArray,
                              const int nRows, const int cCols);

  static void WriteDataAppend(const std::string fileName, const float *data,
                              const int nRows, const int nCols);
