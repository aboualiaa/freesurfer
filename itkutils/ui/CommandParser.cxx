...
int CommandParser::GetNumberOfArguments() { return m_nArgs; }

char **CommandParser::GetArguments() { return m_aArgs; }
...
char *CommandParser::GetArgument(const char *iFlag) {
  char *argument = NULL;
...
int CommandParser::GetArgumentInt(const char *iFlag) {
...
std::vector<int> CommandParser::GetArgumentIntVector(const char *iFlag) {
...
double CommandParser::GetArgumentDouble(const char *iFlag) {
  char *argumentStr = GetArgument(iFlag);
...
bool CommandParser::GetArgumentBoolean(const char *iFlag) {
