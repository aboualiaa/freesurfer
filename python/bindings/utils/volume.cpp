...
*/
template <typename T>
static py::array_t<T> resampleTypedVolume(py::array_t<T>      source_vol,
                                          py::object          target_shape,
...
*/
py::array resampleVolume(py::array source_vol, py::object target_shape,
                         py::array_t<double> target2source) {
