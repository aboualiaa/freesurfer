        ...
        if self.saveModelProbabilities:
            ...
            for classNumber, className in enumerate(classNames):
                for componentNumber in range(
                    ...
                    probabilities[
                        gaussianNumber, downSampledMask, 0
                    ] = downSampledGaussianPosteriors[:, gaussianNumber]
                    probabilities[gaussianNumber, downSampledMask, 1] = (
                        downSampledClassPriors[:, classNumber]
                        * self.gmm.mixtureWeights[gaussianNumber]
                    )
