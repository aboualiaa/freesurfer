...
def check_tensorflow():
    ...
    try:
        ...
        error(
            "Found fspython TensorFlow, but could not import (see error above)."
        )
        print(
            "If you've install the GPU version, please ensure that the appropriate"
        )
        print(
            "CUDA libraries are installed on your system and available in your environment."
        )
        sys.exit(1)
