...
class MRIDeepNet(object):
    ...
    def load_training_image_slices(
        self,
        source_filenames,
        target_filenames,
        is_src_label_img,
        ...
        if self.model is None:
            raise RuntimeError("Model does not exist")
        self.feature_generator.create_data_storage()
        self.feature_generator.generate_src_trg_training_slice_data(
            source_filenames,
            target_filenames,
            is_src_label_img,
            is_trg_label_img,
    ...
    def load_validation_image_slices(
        self,
        source_filenames,
        target_filenames,
        is_src_label_img,
        ...
        if self.model is None:
            raise RuntimeError("Model does not exist")
        self.feature_generator.generate_src_trg_validation_slice_data(
            source_filenames,
            target_filenames,
            is_src_label_img,
            is_trg_label_img,
    ...
    def predict_segmentation(
        ...
        (
            ...
            label_img_data,
            count_img_data,
        ) = self.feature_generator.build_seg_from_patches(
            out_patches,
            in_indices,
...
class FeatureGenerator(object):
    ...
    def generate_src_trg_training_slice_data(
        self,
        source_filenames,
        target_filenames,
        is_src_label_img,
    ...
    def generate_src_trg_validation_slice_data(
        self,
        source_filenames,
        target_filenames,
        is_src_label_img,
    ...
    def apply_flash(self, theta_flash, batch_pd, batch_t1, batch_t2):
        ...
        batch_flash = scipy.signal.medfilt(
            batch_flash, kernel_size=[1, 3, 3, 3, 1]
        )
        return batch_flash
