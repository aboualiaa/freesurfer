...
# endif
# if defined(__GNUC__)
#  define ITK_SIMULATE_VERSION_MAJOR ITK_DEC(__GNUC__)
# elif defined(__GNUG__)
#  define ITK_SIMULATE_VERSION_MAJOR ITK_DEC(__GNUG__)
# endif
# if defined(__GNUC_MINOR__)
#  define ITK_SIMULATE_VERSION_MINOR ITK_DEC(__GNUC_MINOR__)
# endif
# if defined(__GNUC_PATCHLEVEL__)
#  define ITK_SIMULATE_VERSION_PATCH ITK_DEC(__GNUC_PATCHLEVEL__)
# endif
