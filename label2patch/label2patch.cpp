...
int main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option(
      argc, argv, "$Id: label2patch.c,v 1.7 2016/12/10 22:57:39 fischl Exp $",
      "$Name:  $");
