...
FixedVTKSamplingFilter<TInputMesh, TOutputMesh>::FixedVTKSamplingFilter() {
...
void FixedVTKSamplingFilter<TInputMesh, TOutputMesh>::GenerateData() {
  ...
  outputMesh->SetCellData(const_cast<typename TInputMesh::CellDataContainer *>(
      this->GetInput()->GetCellData()));
}

template <class TInputMesh, class TOutputMesh>
void FixedVTKSamplingFilter<TInputMesh, TOutputMesh>::SampleToFiberLenght() {
  typedef typename TInputMesh::CellsContainer FixedCellsContainer;
  typename FixedCellsContainer::ConstIterator cellItFxd =
      this->GetInput()->GetCells()->Begin();
  typename TInputMesh::PointsContainer::Iterator it =
