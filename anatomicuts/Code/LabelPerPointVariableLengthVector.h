...
class LabelPerPointVariableLengthVector
    : public itk::VariableLengthVector<TValueType> {
public:
  /** The element type stored at each location in the Array. */
  using ValueType       = TValueType;
  using ComponentType   = TValueType;
  using RealValueType   = typename itk::NumericTraits<ValueType>::RealType;
  using Self            = LabelPerPointVariableLengthVector<TValueType, TMesh>;
  using Superclass      = itk::VariableLengthVector<TValueType>;
