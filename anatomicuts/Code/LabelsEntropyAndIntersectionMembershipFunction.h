...
public:
  ...
  void SetLabelsAndEuclid(bool lae) { this->m_labelsAndEuclid = lae; }
  void SetMeanEuclidean(bool me) { this->m_meanEuclidean = me; }
  void SetGaussian(bool g) { this->m_gaussian = g; }
  ...
  void SetMeanAndCovInvert(bool m) { this->m_meanAndCovInvert = m; }
