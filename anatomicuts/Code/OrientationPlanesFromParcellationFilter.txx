...
template<class TInputImage,class TOutputImage>
void OrientationPlanesFromParcellationFilter<TInputImage,TOutputImage>::GeneratePlanes(MRI* image)
{
...
template<class TInputImage,class TOutputImage>
float OrientationPlanesFromParcellationFilter<TInputImage,TOutputImage>::DistanceToMidline(double x, double y, double z)
{
	typename InputImageType::PointType point;
	point[0]=x;
	point[1]=y;
