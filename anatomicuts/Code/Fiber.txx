...
$ Language:  C++ Date:      $Date: 2011-04-04 17:38:45 +0200 (Mon, 04 Apr 2011)
...
Fiber<T, TDimension, TTensorCoord>::operator=(const Self &f) {
  this->SetPointList(f.GetPointList());
  return *this;
}

template <class T, unsigned int TDimension, class TTensorCoord>
void Fiber<T, TDimension, TTensorCoord>::AddPoint(const FiberPoint &P) {
  m_FiberPointList.push_back(P);
}

template <class T, unsigned int TDimension, class TTensorCoord>
typename Fiber<T, TDimension, TTensorCoord>::FiberPoint
Fiber<T, TDimension, TTensorCoord>::GetPoint(const int i) const {
...
template <class T, unsigned int TDimension, class TTensorCoord>
void Fiber<T, TDimension, TTensorCoord>::MergeWith(const Self &F) {
...
template <class T, unsigned int TDimension, class TTensorCoord>
double Fiber<T, TDimension, TTensorCoord>::GetLength(void) const {
...
template <class T, unsigned int TDimension, class TTensorCoord>
double Fiber<T, TDimension, TTensorCoord>::GetEuclideanLength(void) const {
...
template <class T, unsigned int TDimension, class TTensorCoord>
void Fiber<T, TDimension, TTensorCoord>::GetStatistics(StatisticsType type,
                                                       double &       mean,
...
template <class T, unsigned int TDimension, class TTensorCoord>
double Fiber<T, TDimension, TTensorCoord>::GetTensorScalarValue(
    const TensorType &tensor, const StatisticsType &type) const {
  double scalar = 0.0;
  switch (type) {
  case ADC:
...
template <class T, unsigned int TDimension, class TTensorCoord>
void Fiber<T, TDimension, TTensorCoord>::GetFAStatistics(double &mean,
                                                         double &min,
                                                         double &max,
                                                         double &var) const {
...
template <class T, unsigned int TDimension, class TTensorCoord>
void Fiber<T, TDimension, TTensorCoord>::GetADCStatistics(double &mean,
                                                          double &min,
                                                          double &max,
                                                          double &var) const {
