...
void PolylineCell<TCellInterface>::MakeCopy(
    CellAutoPointer &cellPointer) const {
 ...
 */
template <typename TCellInterface>
unsigned int PolylineCell<TCellInterface>::GetDimension(void) const {
 ...
 */
template <typename TCellInterface>
unsigned int PolylineCell<TCellInterface>::GetNumberOfPoints(void) const {
...
PolylineCell<TCellInterface>::GetNumberOfBoundaryFeatures(int dimension) const {
  switch (dimension) {
  case 0:
 ...
 */
template <typename TCellInterface>
bool PolylineCell<TCellInterface>::GetBoundaryFeature(
    int dimension, CellFeatureIdentifier featureId,
...
PolylineCell<TCellInterface>::PointIdsBegin(void) {
...
PolylineCell<TCellInterface>::PointIdsBegin(void) const {
  return &m_PointIds->ElementAt(0);
}
...
template <typename TCellInterface>
typename PolylineCell<TCellInterface>::PointIdIterator
PolylineCell<TCellInterface>::PointIdsEnd(void) {
...
template <typename TCellInterface>
typename PolylineCell<TCellInterface>::PointIdConstIterator
PolylineCell<TCellInterface>::PointIdsEnd(void) const {
  return &m_PointIds->ElementAt(m_PointIds->Size() - 1) + 1;
}
...
template <typename TCellInterface>
typename PolylineCell<TCellInterface>::CellFeatureCount
PolylineCell<TCellInterface>::GetNumberOfVertices(void) const {
 ...
 */
template <typename TCellInterface>
bool PolylineCell<TCellInterface>::GetVertex(CellFeatureIdentifier vertexId,
                                             VertexAutoPointer &vertexPointer) {
