...
#define ULOUT(msg)                                                             \
  if (st_env.pcsm_userlog)                                                     \
    st_env.pcsm_userlog->dump(st_env.b_syslogPrepend, (msg));
#define nULOUT(msg)                                                            \
  if (st_env.pcsm_userlog)                                                     \
    st_env.pcsm_userlog->dump(false, (msg));
#define SLOUT(msg)                                                             \
  if (st_env.pcsm_syslog)                                                      \
    st_env.pcsm_syslog->dump(st_env.b_syslogPrepend, (msg));
#define nSLOUT(msg)                                                            \
  if (st_env.pcsm_syslog)                                                      \
    st_env.pcsm_syslog->dump(false, (msg));
#define RLOUT(msg)                                                             \
  if (st_env.pcsm_resultlog)                                                   \
    st_env.pcsm_resultlog->dump(st_env.b_syslogPrepend, (msg));
#define nRLOUT(msg)                                                            \
  if (st_env.pcsm_resultlog)                                                   \
    st_env.pcsm_resultlog->dump(false, (msg));

#define pULOUT(msg)                                                            \
  if (mps_env->pcsm_userlog)                                                   \
    mps_env->pcsm_userlog->dump(mps_env->b_syslogPrepend, (msg));
#define pnULOUT(msg)                                                           \
  if (mps_env->pcsm_userlog)                                                   \
    mps_env->pcsm_userlog->dump(false, (msg));
#define pSLOUT(msg)                                                            \
  if (mps_env->pcsm_syslog)                                                    \
    mps_env->pcsm_syslog->dump(mps_env->b_syslogPrepend, (msg));
#define pnSLOUT(msg)                                                           \
  if (mps_env->pcsm_syslog)                                                    \
    mps_env->pcsm_syslog->dump(false, (msg));
#define pRLOUT(msg)                                                            \
  if (mps_env->pcsm_resultlog)                                                 \
    mps_env->pcsm_resultlog->dump(mps_env->b_syslogPrepend, (msg));
#define pnRLOUT(msg)                                                           \
  if (mps_env->pcsm_resultlog)                                                 \
...
/// \fn bool str_3parse(string& astr_input, string& astr_first, string&
/// astr_second, string& astr_third) \brief Break (on whitespace) an input
/// string into three substrings. Any remainder is returned in the input. \param
/// astr_input  Source string to parse. Destructive parsing. \param astr_first
