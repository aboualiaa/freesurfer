...
/*!
  ...
  apch_curvFileName The name of a FreeSurfer curvature file. \param apf_curv
  Array containing the curvature values. \return If curvature file is
...
void C_mpmOverlay_NOP::costWeightVector_init() {
  //
  // ARGS
  //
  // DESC
...
C_mpmOverlay_NOP::C_mpmOverlay_NOP(s_env *aps_env) : C_mpmOverlay(aps_env) {
  //
  // ARGS
  //
  // DESC
...
float C_mpmOverlay_NOP::costEdge_calc(int i, int j) { return 0.0; }
...
void C_mpmOverlay_unity::costWeightVector_init() {
  //
  // ARGS
  //
  // DESC
...
C_mpmOverlay_unity::C_mpmOverlay_unity(s_env *aps_env) : C_mpmOverlay(aps_env) {
  //
  // ARGS
  //
  // DESC
...
float C_mpmOverlay_unity::costEdge_calc(int i, int j) {
...
void C_mpmOverlay_FScurvs::costWeightVector_init() {
  //
  // ARGS
  //
  // DESC
...
float C_mpmOverlay_FScurvs::costEdge_calc(int i, int j) { return 0.0; }
...
void C_mpmOverlay_distance::costWeightVector_init() {
  //
  // ARGS
  //
  // DESC
...
C_mpmOverlay_distance::C_mpmOverlay_distance(s_env *aps_env)
    : C_mpmOverlay(aps_env) {
  //
  // ARGS
  //
...
float C_mpmOverlay_distance::costEdge_calc(int i, int j) {
  //
  ...
  if (wd <= 0.)
    error("negative edge length detected!", 1);
...
void C_mpmOverlay_euclidean::costWeightVector_init() {
  //
  // ARGS
  //
  // DESC
...
C_mpmOverlay_euclidean::C_mpmOverlay_euclidean(s_env *aps_env)
    : C_mpmOverlay(aps_env) {
  //
  // ARGS
  //
...
float C_mpmOverlay_euclidean::costEdge_calc(int i, int j) {
  //
  // Return the cost in moving from vertex 'i' to vertex 'j'.
...
void C_mpmOverlay_curvature::costWeightVector_init() {
  //
  // ARGS
  //
  // DESC
...
C_mpmOverlay_curvature::C_mpmOverlay_curvature(s_env *aps_env,
  ...
  if (size != mv_size)
    error("Element mismatch between curvature overlay and internal mesh", 10);
...
float C_mpmOverlay_curvature::costEdge_calc(int i, int j) {
  //
  // Return the cost in moving from vertex 'i' to vertex 'j'.
