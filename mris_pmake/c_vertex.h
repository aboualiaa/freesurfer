...
bool vertex_valLTE(VERTEX *pvertex, void *pv_void);

/// \fn bool vertex_isDijkVirgin(VERTEX* pvertex, void* pv_void)
/// \brief A function (typically used as a callback) that determines if the
/// passed vertex is marked as DIJK_VIRGIN. \param  pvertex The vertex to
/// process \param pv_void A pointer to a void structure. This is unpacked
///   (if necessary) by the function itself.
/// \return    (bool) TRUE if vertex is marked with DIJK_VIRGIN, else FALSE
bool vertex_isDijkVirgin(VERTEX *pvertex, void *pv_void);

/// \fn bool vertex_ripFlagIsTrue(VERTEX* pvertex, void* pv_void)
/// \brief A function (typically used as a callback) that determines if the
/// "ripflag" for the given vertex index is TRUE or FALSE. \param  pvertex The
/// vertex to process \param pv_void A pointer to a void structure. This is
/// unpacked
///   (if necessary) by the function itself.
/// \return    (bool) TRUE if ripflag is TRUE, else FALSE
bool vertex_ripFlagIsTrue(VERTEX *pvertex, void *pv_void);
...
bool vertex_alwaysTrue(VERTEX *pvertex, void *pv_void);

/// \fn void vertex_signumFunctional(VERTEX* pvertex, void* apv_functional)
/// \brief A function (typically used as a callback) that counts the signum of
/// the curvature value \param  pvertex The vertex to process \param
/// apv_functional A pointer to void* housing the arguments that
///    the function internals require
/// \return    (void)
void vertex_signumFunctional(VERTEX *apvertex, void *apv_functional);
...
///    the function internals require
/// \return    (void)
void vertex_curveAreaSum(VERTEX *apvertex, void *apv_functional);
...
///    the function internals require
/// \return    (void)
void vertex_rawCurveSum(VERTEX *apvertex, void *apv_functional);
...
///    the function internals require
/// \return    (void)
void vertex_rawCurveMinMax(VERTEX *apvertex, void *apv_functional);

/// \fn void vertex_ripFlagMark(VERTEX* pvertex, void* pv_mark)
/// \brief A function (typically used as a callback) that marks the "ripflag"
/// for the given vertex index as 'ch_mark' \param  pvertex The vertex to
/// process \param  ch_mark The mark to write to the 'ripflag' field \return
/// (void)
