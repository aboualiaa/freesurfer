...
/// \fn void singleVertexSet(MRIS* apmris, int avertex, void (*vertex_labelMark)
/// (VERTEX* pvertex, void* marker), void* apv_marker ) \fn void
/// singleVertexSet(MRIS* apmris, int avertex, void (*vertex_labelMark) (VERTEX*
/// pvertex, void* marker), void* apv_marker )
/*/// \fn label_coreLoad */
/// \brief For a passed surface, set the specified vertex index using the
/// callback function, vertex_labelMark(). \param apmris    surface to process
...
/// (*vertex_labelMark)(VERTEX* pvertex,void* marker), void* apv_marker ) \fn
/// void label_coreLoad(MRIS& amris, string astr_fileName, bool
/// (*vertex_labelMark)(VERTEX* pvertex,void* marker), void* apv_marker )
/*/// \fn label_coreLoad */
/// \brief The core label function. Typically called by wrapper functions within
/// a specific context. A label file is read from disk, and each vertex of this
/// label is marked on the passed surface by vertex_labelMark(). \param amris
/// surface on to which the label is loaded \param astr_fileName  filename
/// containing the label to load \param vertex_labelMark a callback function
/// that operates on
///     each loaded vertex
/// \param apv_marker  a pointer to void that embodies the
///     argument list to (*vertex_labelMark)()
...
/// \fn void workingSurface_loadFrom(s_env& st_env, void
/// (*vertex_labelMark)(VERTEX* pvertex, void* marker), void* apv_marker); \fn
/// void workingSurface_loadFrom(s_env& st_env, void (*vertex_labelMark)(VERTEX*
/// pvertex, void* marker), void* apv_marker);
/*/// \fn label_coreSave*/
...
/// *vertex_satisfyTestCondition) \fn void label_coreSave(MRIS& amris, string
/// astr_fileName, bool *vertex_satisfyTestCondition)
/*/// \fn label_coreSave*/
/// \brief The core label save function. Typically called by wrapper functions
/// within a specific context. This parses a processed surface, and writes a
/// label file to disk. This label file contains each vertex flagged by the
/// callback function vertex_satisfyTestCondition(). \param amris     surface
/// from which to save the
///       label file
...
/// b_staggered = true) \brief Save concentric ply areas. \param st_env   the
/// program environment \param astr_fileName  the filename prefix to save ply
/// labels
...
/// (*vertex_satisfyTestCondition) (VERTEX* pvertex, void* apv_void), void*
/// apv_fromCaller) \fn void label_auxSurface_saveTo(s_env& st_env, bool
/// (*vertex_satisfyTestCondition) (VERTEX* pvertex, void* apv_void), void*
/// apv_fromCaller)
/*/// \fn label_coreLoad */
...
/// \return    (void)
void label_secondarySurface_saveTo(
    s_env &st_env,
    bool (*vertex_satisfyTestCondition)(VERTEX *pvertex, void *apv_void),
    void *apv_fromCaller);

/// \fn void label_workingSurface_saveTo(s_env& st_env, bool
/// (*vertex_satisfyTestCondition) (VERTEX* pvertex, void* apv_void), void*
/// apv_fromCaller) \fn void label_workingSurface_saveTo(s_env& st_env, bool
/// (*vertex_satisfyTestCondition) (VERTEX* pvertex, void* apv_void), void*
/// apv_fromCaller)
/*/// \fn label_coreLoad */
...
///      (*vertex_satisfyTestCondition)()
/// \return    (void)
void label_workingSurface_saveTo(
    s_env &st_env,
    bool (*vertex_satisfyTestCondition)(VERTEX *pvertex, void *apv_void),
    void *apv_fromCaller);
