...
void surface_vertexFunction_do(
    s_env &st_env,
    bool (*vertex_satisfyTestCondition)(VERTEX *pvertex, void *pv_extra),
    void *apv_conditional,
    void (*vertex_function)(VERTEX *pvertex, void *pv_extra),
    void *apv_functional);

/// \fn void surface_vertexPatternCopy(s_env& st_env, MRIS* apMS_source, MRIS*
/// apMS_target, bool (*vertex_satisfyTestCondition) (VERTEX* pvertex, void*
/// pv_extra), void* apvsource_extra, void (*vertex_modify) (VERTEX* pvertex,
/// void* pv_extra), void*apvtarget_extra) \fn void
/// surface_vertexPatternCopy(s_env& st_env, MRIS* apMS_source, MRIS*
/// apMS_target, bool (*vertex_satisfyTestCondition) (VERTEX* pvertex, void*
/// pv_extra), void* apvsource_extra, void (*vertex_modify) (VERTEX* pvertex,
/// void* pv_extra), void*apvtarget_extra)
/*/// \fn label_coreLoad */
...
///     (*vertex_modify)()
/// \return    (void)
void surface_vertexPatternCopy(
    s_env &st_env, MRIS *apMS_source, MRIS *apMS_target,
    bool (*vertex_satisfyTestCondition)(VERTEX *pvertex, void *pv_extra),
    void *apvsource_extra,
    void (*vertex_modify)(VERTEX *pvertex, void *pv_extra),
...
/// \param  st_env  the problem environment
/// \return (void)
void surface_correlationFunction_do(s_env &st_env);
...
/// \fn void surface_averageIntegratedCurvArea_do(s_env& st_env, e_CURVATURE
/// ae_curvature) \brief Calculates the average integrated curvature measure for
/// a given curvature
...
/// \return (void)
void surface_averageIntegratedCurveArea_do(
    s_env &st_env, e_CURVATURE ae_curvature = e_gaussian);
...
float surface_ripMark(s_env &st_env);
...
/// \param  st_env  the problem environment
/// \param b_wholeSurfaceForce if 'true', examine each node and set 'ripflag' to
/// 'FALSE' \return (void)
void surface_ripClear(s_env &st_env, bool b_wholeSurfaceForce = false);
