...
/// \param maxPolls  The number of polls to wait. Each poll lasts a given
/// timeout. \return  (void)
std::string asynchEvent_poll(c_SSocket_UDP_receive *pCSocketUDPR, int maxPolls);
...
/// \param astr_comms  Control string parsed from socket
/// \return  true|false  Status: success or fail.
bool asynchEvent_processENV(s_env &ast_env, std::string astr_comms);
