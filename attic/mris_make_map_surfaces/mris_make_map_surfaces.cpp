    ...
    for (y = 0; y < mri_src->height; y++)
      for (z = 0; z < mri_src->depth; z++) {
        ...
        case Right_Cerebellum_Cortex:
          if ((MRIlabelsInNbhd(mri_aseg, x, y, z, 1, Left_Cerebral_Cortex) ==
               0) &&
              (MRIlabelsInNbhd(mri_aseg, x, y, z, 1, Right_Cerebral_Cortex) ==
               0)) {
        ...
        case Right_Cerebellum_White_Matter:
          ...
          break;
        case Unknown:
          if ((MRIlabelsInNbhd(mri_aseg, x, y, z, 2, Left_Cerebral_Cortex) ==
               0) &&
              (MRIlabelsInNbhd(mri_aseg, x, y, z, 2, Right_Cerebral_Cortex) ==
               0)) {
            MRIsetVoxVal(mri_dst, x, y, z, 0, 0);
          }
          break;
