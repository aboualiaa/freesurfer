 ...
 * mean of the symmetric min distances between the boundaries
 */
/*
...
int main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option(
      argc, argv,
      "$Id: mri_label_accuracy.c,v 1.2 2011/03/02 00:04:22 nicks Exp $",
      "$Name:  $");
  ...
  accuracy =
      MRIcomputeLabelAccuracy(mri_src, mri_ref, MRI_MEAN_MIN_DISTANCE, stdout);
