...
static char vcid[] =
    "$Id: mris_w_to_curv.c,v 1.6 2011/03/02 00:04:34 nicks Exp $";
...
int main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option(
      argc, argv, "$Id: mris_w_to_curv.c,v 1.6 2011/03/02 00:04:34 nicks Exp $",
      "$Name:  $");
  ...
  if (MRISreadValues(mris, wfile_name) != NO_ERROR)
    ErrorExit(ERROR_NOFILE, "%s: could not read w file %s", Progname,
              wfile_name);
