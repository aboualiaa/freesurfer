 ...
 *
 * This is a function that allows for intensity thresholding the input volume.
 * By default the threshold is a lower threshold, but with the -u flag this can
 * be changed to be an upper one.
 */
/*
...
static void print_help(void) {
  ...
  printf("  -U Instead of lower thresholding the volume it will upper "
         "threshold it.\n");
  printf(
