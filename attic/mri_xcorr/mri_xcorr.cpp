...
static void print_help(void) {
  print_usage();
  printf("Computes voxelwise temporal correlation coefficient between two "
         "volumes. If v2 is not specified, then v2 is formed from v1 by "
         "left-right  reversing the columns.\n");
  exit(1);
}
/*--------------------------------------------*/
static void print_version(void) {
