...
int cvector_mark_low_prob_vertices(float *pvals, float pthresh,
                                   MRI_SURFACE *mris) {
  int i, num;
...
double cvector_compute_dist_free_snr(float **c1_thickness, int num_class1,
...
double cvector_compute_snr(float *c1_mean, float *c2_mean, float *vvar,
                           float *vsnr, int num, int *pi, float bonferroni,
                           int stat_type) {
  double snr;
...
int cvector_add_variances(float *c1_var, float *c2_var, int num_class1,
...
int cvector_multiply_variances(float *c1_var, float *c2_var, int num_class1,
...
int cvector_track_best_snr(float *vsnr, float *vbest_snr, float *vbest_avgs,
                           float *c1_mean, float *c2_mean, float *c1_best_mean,
                           float *c2_best_mean, float *c1_var, float *c2_var,
                           float *c1_best_var, float *c2_best_var,
                           float **c1_avg_thickness, float **c2_avg_thickness,
                           float **c1_best_thicknesses, int nc1,
                           float **c2_best_thicknesses, int nc2, int avgs,
                           int num, float fthresh, int *pnum_found) {
  int i, n;
...
int cvector_track_best_stats(float *vpvals, float *vbest_pvals,
                             float *vbest_avgs, float *c1_mean, float *c2_mean,
                             float *c1_best_mean, float *c2_best_mean,
                             float *c1_var, float *c2_var, float *c1_best_var,
                             float *c2_best_var, float **c1_avg_thickness,
...
int cvector_extract_best_avg(float *vbest_avgs, float *vsrc, float *vdst,
                             int navgs, int num) {
  int i;
...
double cvector_compute_pvalues(float *c1_mean, float *c1_var, float *c2_mean,
                               float *c2_var, int num_class1, int num_class2,
