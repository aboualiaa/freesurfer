...
int main(int argc, char *argv[]) {
  if (argc < 3) {
    cout << "Usage  : mri_copy_params <input volume> <like volume> [<output "
            "volume>]"
         << endl;
    cout << "         if the output volume is not given, it will overwrite "
            "input volume "
         << endl;
    cout << "Purpose: copies TR, TE, TI, and flip angle from <like volume>"
         << endl;
    return 0;
  }
  string invol;
