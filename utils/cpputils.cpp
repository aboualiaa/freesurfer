...
/* This uses the more accurate signed distance transform from a surface ( uses
 * OBB Trees in turn ). It takes more time ( around 4 to 5 minutes ) but it's
 * very accurate. returned MRI structure (mri_out) is an MRI_INT MRI volume with
 * voxels inside having the value 1 and voxels outside with value 0.
 */
