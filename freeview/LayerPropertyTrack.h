...
public:
  ...
  int GetDirectionScheme() { return m_nDirectionScheme; }

  int GetDirectionMapping() { return m_nDirectionMapping; }

  QColor GetSolidColor() { return m_color; }

  int GetRenderRep() { return m_nRenderRep; }

  double GetTubeRadius() { return m_dTubeRadius; }

  int GetNumberOfSides() { return m_nNumberOfSides; }
