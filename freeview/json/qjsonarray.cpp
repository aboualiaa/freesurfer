...
/*!
    ...
    \sa at()
 */
QJsonValue QJsonArray::first() const { return at(0); }
...
/*!
    ...
    \sa at()
 */
QJsonValue QJsonArray::last() const { return at(a ? (a->length - 1) : 0); }

/*!
    Inserts \a value at the beginning of the array.

    This is the same as \c{insert(0, value)} and will prepend \a value to the
   array.

    \sa append(), insert()
 */
void QJsonArray::prepend(const QJsonValue &value) { insert(0, value); }
...
/*!
    \fn QJsonArray::iterator QJsonArray::insert(iterator before, const
   QJsonValue &value)

    Inserts \a value before the position pointed to by \a before, and returns an
   iterator pointing to the newly inserted item.
...
/*!
    ...
    Removes the item pointed to by \a it, and returns an iterator pointing to
   the next item.
...
/*!
    Returns \c true if the array contains an occurrence of \a value, otherwise
   \c false.
...
/*!
    ...
    Same as at().
 */
QJsonValue QJsonArray::operator[](int i) const { return at(i); }
...
bool QJsonArray::operator==(const QJsonArray &other) const {
  ...
  for (int i = 0; i < (int)a->length; ++i) {
    if (QJsonValue(d, a, a->at(i)) !=
        QJsonValue(other.d, other.a, other.a->at(i)))
      return false;
  }
  return true;
}
...
/*! \fn QJsonArray::iterator QJsonArray::end()
   ...
   imaginary item after the last item in the array.
...
/*! \fn void QJsonArray::push_back(const QJsonValue &value)
    ...
    to \l{QJsonArray::append()}{append(value)} and will append \a value to the
   array.
*/
...
/*! \fn void QJsonArray::push_front(const QJsonValue &value)
    ...
    This function is provided for STL compatibility. It is equivalent
    to \l{QJsonArray::prepend()}{prepend(value)} and will prepend \a value to
   the array.
*/
...
/*! \class QJsonArray::iterator
    \inmodule QtCore
    \brief The QJsonArray::iterator class provides an STL-style non-const
   iterator for QJsonArray.
    ...
    QJsonArray::begin(), QJsonArray::end(), or QJsonArray::insert() before you
   can start iterating.
...
/*! \class QJsonArray::const_iterator
    \inmodule QtCore
    \brief The QJsonArray::const_iterator class provides an STL-style const
   iterator for QJsonArray.
...
/*! \fn QJsonArray::const_iterator::const_iterator(const QJsonArray *array, int
   index) \internal
*/
...
/*! \fn QJsonValue QJsonArray::const_iterator::operator[](int j) const
    ...
    Returns the item at offset \a j from the item pointed to by this iterator
   (the item at position \c{*this + j}).
...
/*! \fn bool QJsonArray::const_iterator::operator==(const const_iterator &other)
   const
