...
/*! \class QJsonDocument
    ...
    \brief The QJsonDocument class provides a way to read and write JSON
   documents.
   ...
   QJsonDocument using QJsonDocument::fromJson(). toJson() converts it back to
   text. The parser is very fast and efficient and converts the JSON to the
   binary representation used by Qt.
   ...
   using isArray() and isObject(). The array or object contained in the document
   can be retrieved using array() or object() and then read or manipulated.
 ...
 */
QJsonDocument::QJsonDocument() : d(0) {}

/*!
 * Creates a QJsonDocument from \a object.
 */
QJsonDocument::QJsonDocument(const QJsonObject &object) : d(0) {
  setObject(object);
}
 ...
 */
QJsonDocument::QJsonDocument(const QJsonArray &array) : d(0) {
  setArray(array);
}
...
/*!
    \internal
 */
QJsonDocument::QJsonDocument(QJsonPrivate::Data *data) : d(data) {
  Q_ASSERT(d);
  d->ref.ref();
}
...
/*! \enum QJsonDocument::DataValidation
  ...
  data from a trusted place and know it's valid, as using of invalid data can
...
/*!
 ...
 \a validation decides whether the data is checked for validity before being
 used. By default the data is validated. If the \a data is not valid, the method
...
QJsonDocument QJsonDocument::fromBinaryData(const QByteArray &data,
  ...
  memcpy(&root, data.constData() + sizeof(QJsonPrivate::Header),
         sizeof(QJsonPrivate::Base));
...
QVariant QJsonDocument::toVariant() const {
  ...
  if (d->header->root()->isArray())
    ...
    return QJsonObject(d,
                       static_cast<QJsonPrivate::Object *>(d->header->root()))
        .toVariantMap();
}
...
QByteArray QJsonDocument::toJson() const { return toJson(Indented); }
#endif
...
/*!
    Converts the QJsonDocument to a UTF-8 encoded JSON document in the provided
   \a format.
...
QByteArray QJsonDocument::toJson(JsonFormat format) const {
  ...
  if (d->header->root()->isArray())
    QJsonPrivate::Writer::arrayToJson(
        static_cast<QJsonPrivate::Array *>(d->header->root()), json, 0,
        (format == Compact));
  else
    QJsonPrivate::Writer::objectToJson(
        static_cast<QJsonPrivate::Object *>(d->header->root()), json, 0,
        (format == Compact));
...
/*!
 ...
 structure that will contain information about possible errors encountered
 during parsing.
...
/*!
 ...
 The binary format can be stored on disk and interchanged with other
 applications or computers. fromBinaryData() can be used to convert it back into
 a JSON document.
...
QByteArray QJsonDocument::toBinaryData() const {
  ...
  return QByteArray(d->rawData,
                    d->header->root()->size + sizeof(QJsonPrivate::Header));
}
...
bool QJsonDocument::operator==(const QJsonDocument &other) const {
  ...
  if (d->header->root()->isObject())
    return QJsonObject(
               d, static_cast<QJsonPrivate::Object *>(d->header->root())) ==
           QJsonObject(other.d, static_cast<QJsonPrivate::Object *>(
                                    other.d->header->root()));
  else
    return QJsonArray(d,
                      static_cast<QJsonPrivate::Array *>(d->header->root())) ==
           QJsonArray(other.d, static_cast<QJsonPrivate::Array *>(
                                   other.d->header->root()));
}
...
/*!
    ...
    will also be null.
 */
bool QJsonDocument::isNull() const { return (d == 0); }
...
QDebug operator<<(QDebug dbg, const QJsonDocument &o) {
  ...
  if (o.d->header->root()->isArray())
    QJsonPrivate::Writer::arrayToJson(
        static_cast<QJsonPrivate::Array *>(o.d->header->root()), json, 0, true);
  else
    QJsonPrivate::Writer::objectToJson(
        static_cast<QJsonPrivate::Object *>(o.d->header->root()), json, 0,
        true);
  dbg.nospace()
      << "QJsonDocument("
