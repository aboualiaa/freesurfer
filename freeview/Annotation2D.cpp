...
void Annotation2D::Update(vtkRenderer *renderer, int nPlane) {
  ...
  case 0:
    ...
    tpos = slicePos[0];
    mri->RemapPositionToRealRAS(tpos, pos[0], pos[1], slicePos[0], pos[0],
                                pos[1]);
    if (pos[0] >= 0)
    ...
    mri->RemapPositionToRealRAS(tpos, pos[2], pos[3], slicePos[0], pos[2],
                                pos[3]);
    if (pos[2] >= 0)
    ...
    mri->RemapPositionToRealRAS(tpos, centPos[1], centPos[2], slicePos[0],
                                centPos[1], centPos[2]);
    if (slicePos[0] >= 0)
  ...
  case 1:
    ...
    tpos = slicePos[1];
    mri->RemapPositionToRealRAS(pos[0], tpos, pos[1], pos[0], slicePos[1],
                                pos[1]);
    if (pos[0] >= 0)
      m_actorCoordinates[0]->SetInput(
    ...
    mri->RemapPositionToRealRAS(pos[2], tpos, pos[3], pos[2], slicePos[1],
                                pos[3]);
  ...
  case 2:
    ...
    tpos = slicePos[2];
    mri->RemapPositionToRealRAS(pos[0], pos[1], tpos, pos[0], pos[1],
                                slicePos[2]);
    ...
    mri->RemapPositionToRealRAS(pos[2], pos[3], tpos, pos[2], pos[3],
                                slicePos[2]);
    ...
    mri->RemapPositionToRealRAS(centPos[0], centPos[1], tpos, centPos[0],
                                centPos[1], slicePos[2]);
    if (slicePos[2] >= 0)
      m_actorCoordinates[4]->SetInput(
