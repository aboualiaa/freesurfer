...
public:
  ...
  inline LayerProperty *GetProperty() { return mProperty; }
  ...
  virtual void SetFileName(const QString &fn) { m_sFilename = fn; }

  void SendActorUpdated() { emit ActorUpdated(); }

  QString GetSubjectName() { return m_sSubjectName; }

  void ParseSubjectName(const QString &file_path);

  void SetLayerIndex(int n) { m_nLayerIndex = n; }

  int GetLayerIndex() { return m_nLayerIndex; }
  ...
  bool GetAboutToDelete() { return m_bAboutToDelete; }

  void MarkAboutToDelete() { m_bAboutToDelete = true; }
