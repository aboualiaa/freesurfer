...
DialogGradientFilter::DialogGradientFilter(QWidget *parent)
    : QDialog(parent), ui(new Ui::DialogGradientFilter) {
  ui->setupUi(this);
}

DialogGradientFilter::~DialogGradientFilter() { delete ui; }
...
double DialogGradientFilter::GetSD() { return ui->doubleSpinBoxSD->value(); }
