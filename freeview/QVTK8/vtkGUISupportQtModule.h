...
#define VTKGUISUPPORTQT_DEPRECATED_EXPORT                                      \
  VTKGUISUPPORTQT_EXPORT __attribute__((__deprecated__))
#define VTKGUISUPPORTQT_DEPRECATED_NO_EXPORT                                   \
  VTKGUISUPPORTQT_NO_EXPORT __attribute__((__deprecated__))
#endif
