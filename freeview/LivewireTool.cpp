...
void LivewireTool::GetLivewirePoints(vtkImageData *image, int nPlane,
                                     int nSlice, double *pt1_in, double *pt2_in,
                                     vtkPoints *pts_out) {
...
void LivewireTool::GetLivewirePoints(double *pt1_in, double *pt2_in,
                                     vtkPoints *pts_out) {
  if (!m_imageSlice) {
    return;
  }
