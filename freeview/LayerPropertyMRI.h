...
public:
  ...
  enum VectorInversion { VI_None = 0, VI_X, VI_Y, VI_Z };

  enum VectorRepresentation { VR_Line = 0, VR_Direction_Line, VR_Bar };

  enum TensorRepresentation { TR_Boxoid = 0, TR_Ellipsoid };

  enum UpSampleMethod { UM_None = 0, UM_NearestNeighbor, UM_Linear, UM_Cubic };

  enum ProjectionMapType { PM_None = 0, PM_Maximum, PM_Mean };
  ...
  bool GetHeatScaleTruncate() { return m_bHeatScaleTruncate; }

  bool GetHeatScaleInvert() { return m_bHeatScaleInvert; }
  ...
  double GetClearBackgroundValue() { return mClearBackgroundValue; }
  ...
  double *GetWindowRange() { return mWindowRange; }

  double *GetLevelRange() { return mLevelRange; }

  bool GetDisplayVector() { return m_bDisplayVector; }

  bool GetDisplayRGB() { return m_bDisplayRGB; }

  bool GetDisplayTensor() { return m_bDisplayTensor; }

  int GetVectorInversion() { return m_nVectorInversion; }

  int GetTensorInversion() { return m_nTensorInversion; }

  int GetVectorRepresentation() { return m_nVectorRepresentation; }

  bool GetTensorRepresentation() { return m_nTensorRepresentation; }

  bool GetShowAsContour() { return mbShowAsContour; }

  double GetContourMinThreshold() { return mMinContourThreshold; }

  double GetContourMaxThreshold() { return mMaxContourThreshold; }
  ...
  double *GetContourColor() { return m_rgbContour; }

  bool GetContourUseImageColorMap() { return m_bContourUseImageColorMap; }

  bool GetContourExtractAllRegions() { return m_bContourExtractAll; }

  bool GetShowLabelOutline() { return m_bShowLabelOutline; }

  int GetUpSampleMethod() { return m_nUpSampleMethod; }

  int GetContourSmoothIterations() { return m_nContourSmoothIterations; }

  bool GetRememberFrameSettings() { return m_bRememberFrameSettings; }

  bool GetShowAsLabelContour() { return this->m_bShowAsLabelContour; }

  bool GetShowVoxelizedContour() { return m_bShowVoxelizedContour; }

  bool GetContourUpsample() { return this->m_bContourUpsample; }

  double GetVectorScale() { return m_dVectorScale; }

  double GetVectorDisplayScale() { return m_dVectorDisplayScale; }

  bool GetNormalizeVector() { return m_bNormalizeVector; }

  bool GetUsePercentile() { return m_bUsePercentile; }

  bool GetAutoAdjustFrameLevel() { return m_bAutoAdjustFrameLevel; }

  bool GetHeatScaleAutoMid() { return m_bHeatScaleAutoMid; }

  int GetProjectionMapType() { return m_nProjectionMapType; }

  bool GetShowProjectionMap() { return m_nProjectionMapType > 0; }
  ...
  QList<int> GetSelectedLabels() { return m_listVisibleLabels; }

  void UpdateActiveFrame(int nFrame);

  double GetVectorLineWidth() { return m_dVectorLineWidth; }

  int GetVectorSkip() { return m_nVectorSkip; }

  double GetVectorNormThreshold() { return m_dVectorNormThreshold; }

  QColor GetBinaryColor() { return m_colorBinary; }
...
public slots:
  ...
  void SetUsePercentile(bool b) { m_bUsePercentile = b; }
