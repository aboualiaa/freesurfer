...
double *Cursor3D::GetPosition() { return m_dPosition; }
...
void Cursor3D::Show(bool bShow) { m_actorCursor->SetVisibility(bShow ? 1 : 0); }

bool Cursor3D::IsShown() { return m_actorCursor->GetVisibility() > 0; }
