...
class LayerLineProfile : public Layer {
  Q_OBJECT
public:
  LayerLineProfile(int nPlane, QObject *parent = NULL,
                   LayerPointSet *line1 = NULL, LayerPointSet *line2 = NULL);
  ~LayerLineProfile();
  ...
  int GetPlane() { return m_nPlane; }

  bool Solve(double profileSpacing, double referenceSize,
  ...
  double GetResultion() { return m_dResolution; }

  double GetSpacing() { return m_dSpacing; }

  int GetNumberOfSamples() { return m_nSamples; }

  double GetOffset() { return m_dOffset; }

  LayerPointSet *GetSpline0() { return m_spline0; }

  LayerPointSet *GetSpline1() { return m_spline1; }
