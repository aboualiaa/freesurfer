...
public:
  ...
  enum CURVATURE_MAP { CM_Off = 0, CM_Threshold, CM_Binary };

  enum SuraceRenderMode {
    SM_Surface = 0,
    SM_Wireframe,
    SM_SurfaceAndWireframe
  };

  enum MeshColorMap { MC_Surface = 0, MC_Curvature, MC_Overlay, MC_Solid };

  double GetOpacity() const;

  double *GetBinaryColor() { return m_dRGB; }
  ...
  double GetThresholdSlope() { return m_dThresholdSlope; }

  double *GetEdgeColor() { return m_dRGBEdge; }

  double *GetVectorColor() { return m_dRGBVector; }

  int GetEdgeThickness() { return m_nEdgeThickness; }

  int GetVectorPointSize() { return m_nVectorPointSize; }
  ...
  int GetCurvatureMap() { return m_nCurvatureMap; }

  int GetSurfaceRenderMode() { return m_nSurfaceRenderMode; }

  double *GetVertexColor() { return m_dRGBVertex; }

  bool GetShowVertices() { return m_bShowVertices; }

  int GetVertexPointSize() { return m_nVertexPointSize; }

  double *GetMeshColor() { return m_dRGBMesh; }
  ...
  bool GetShowOverlay() { return m_bShowOverlay; }

  bool GetShowAnnotation() { return m_bShowAnnotation; }

  bool GetUseSurfaceColorOn2D() { return m_bUseSurfaceColorOn2D; }

  int GetZOrderOverlay() { return m_nZOrderOverlay; }

  int GetZOrderLabel() { return m_nZOrderLabel; }

  int GetZOrderAnnotation() { return m_nZOrderAnnotation; }
