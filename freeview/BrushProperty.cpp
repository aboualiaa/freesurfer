...
BrushProperty::BrushProperty(QObject *parent)
    : QObject(parent), m_nBrushSize(1), m_nBrushTolerance(0),
      m_bEnableDrawRange(false), m_bEnableExcludeRange(false),
  ...
  m_nBrushTolerance = 0;
  m_bEnableDrawRange =
      settings.value("/BrushProperty/EnableDrawRange", false).toBool();
  //  m_bEnableExcludeRange   = settings.value(
  //  "/BrushProperty/EnableExcludeRange", false ).toBool();
  m_bDrawConnectedOnly =
      settings.value("/BrushProperty/DrawConnected", false).toBool();
  m_dDrawRange[0] = settings.value("/BrushProperty/DrawRangeLow", 0).toDouble();
  m_dDrawRange[1] =
      settings.value("/BrushProperty/DrawRangeHigh", 1000000).toDouble();
  m_dExcludeRange[0] =
      settings.value("/BrushProperty/ExcludeRangeLow", 0).toDouble();
  m_dExcludeRange[1] =
      settings.value("/BrushProperty/ExcludeRangeHigh", 0).toDouble();

  m_dEraseRange[0] =
      settings.value("/BrushProperty/EraseRangeLow", 0).toDouble();
  m_dEraseRange[1] =
      settings.value("/BrushProperty/EraseRangeHigh", 1000000).toDouble();
  m_dEraseExcludeRange[0] =
      settings.value("/BrushProperty/EraseExcludeRangeLow", 0).toDouble();
  m_dEraseExcludeRange[1] =
      settings.value("/BrushProperty/EraseExcludeRangeHigh", 0).toDouble();
...
BrushProperty::~BrushProperty() {
  ...
  settings.setValue("/BrushProperty/EraseExcludeRangeLow",
                    m_dEraseExcludeRange[0]);
  settings.setValue("/BrushProperty/EraseExcludeRangeHigh",
                    m_dEraseExcludeRange[1]);
  settings.setValue("/BrushProperty/Geos", m_mapGeos);
}

int BrushProperty::GetBrushSize() { return m_nBrushSize; }
...
int BrushProperty::GetBrushTolerance() { return m_nBrushTolerance; }
...
LayerVolumeBase *BrushProperty::GetReferenceLayer() { return m_layerRef; }

void BrushProperty::SetReferenceLayer(LayerVolumeBase *layer) {
  m_layerRef = layer;
}

double *BrushProperty::GetDrawRange() { return m_dDrawRange; }
...
bool BrushProperty::GetDrawRangeEnabled() { return m_bEnableDrawRange; }

void BrushProperty::SetDrawRangeEnabled(bool bEnable) {
  m_bEnableDrawRange = bEnable;
}

double *BrushProperty::GetExcludeRange() { return m_dExcludeRange; }
...
bool BrushProperty::GetExcludeRangeEnabled() { return m_bEnableExcludeRange; }

void BrushProperty::SetExcludeRangeEnabled(bool bEnable) {
  m_bEnableExcludeRange = bEnable;
}

bool BrushProperty::GetDrawConnectedOnly() { return m_bDrawConnectedOnly; }
...
double *BrushProperty::GetEraseRange() { return m_dEraseRange; }
...
bool BrushProperty::GetEraseRangeEnabled() { return m_bEnableEraseRange; }

void BrushProperty::SetEraseRangeEnabled(bool bEnable) {
  m_bEnableEraseRange = bEnable;
}

double *BrushProperty::GetEraseExcludeRange() { return m_dEraseExcludeRange; }
