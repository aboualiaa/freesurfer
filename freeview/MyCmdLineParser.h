...
struct CmdLineEntry {
  ...
  CmdLineEntry(int nType = CMD_LINE_SWITCH, const char *sShortName = 0,
               const char *sLongName = 0, const char *sArguName = 0,
               const char *desc = 0, int nMinArguments = 1,
               int nMaxArguments = 1) {
...
public:
  ...
  void AddValidCmdLineEntry(int nType, const char *sShortName,
                            const char *sLongName, const char *sArguName,
