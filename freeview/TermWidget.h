...
public:
   ...
   */
  ~StdRedirector() { m_Stream.rdbuf(m_pBuf); }
...
public:
  ...
  bool GetRedirectStdOutput() { return m_bRedirectStdOutput; }
...
public slots:
  ...
  void SetDuplicateStdOutput(bool bDup = true) { m_bDuplicateStdOutput = bDup; }
