...
CursorFactory::CursorFactory() { Initialize(); }
...
void CursorFactory::Initialize() {
  ...
  CursorPolyline =
      QCursor(QPixmap(":resource/icons/cursor_polyline.png"), 0, 0);
  ...
  CursorColorPicker =
      QCursor(QPixmap(":resource/icons/cursor_colorpicker.png"), 0, 23);
  CursorMeasureLine =
      QCursor(QPixmap(":resource/icons/cursor_measure_line.png"), 0, 0);
  CursorGrab = QCursor(QPixmap(":resource/icons/cursor_grab.png"), 11, 11);
  CursorMeasureRectangle =
      QCursor(QPixmap(":resource/icons/cursor_measure_rectangle.png"), 0, 0);
  CursorContour = QCursor(QPixmap(":resource/icons/cursor_contour.png"), 0, 0);
  CursorMeasurePolyline =
      QCursor(QPixmap(":resource/icons/cursor_measure_polyline.png"), 0, 0);
