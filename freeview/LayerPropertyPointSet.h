...
public:
  ...
  double *GetSplineColor() { return mRGBSpline; }

  void SetSplineColor(double r, double g, double b);

  double GetRadius() { return m_dRadius; }

  double GetSplineRadius() { return m_dSplineRadius; }

  int GetColorMap() { return m_nColorMap; }

  double GetHeatScaleMin() { return m_dHeatScaleMin; }

  double GetHeatScaleMid() { return m_dHeatScaleMid; }
  ...
  std::vector<ScalarValues> GetScalarSets() { return m_scalarSets; }
  int GetNumberOfScalarSets() { return m_scalarSets.size(); }
  ...
  bool GetShowSpline() { return m_bShowSpline; }
