...
public:
  ...
  const TransformType *GetTransform() const { return m_Transform; }
  ...
  //
  float GetExtraFraction() const { return m_ExtraFraction; }
  ...
  //
  int GetDownSamplingFactor() const { return m_DownSamplingFactor; }

  //
  const int *GetBoundingBoxSize() const { return m_BoundingBoxSize; }
