...
//---------------------------------------------------------------------------
vtkFlRenderWindowInteractor::vtkFlRenderWindowInteractor(int x, int y, int w,
                                                         int h, const char *l)
...
void vtkFlRenderWindowInteractor::Start() {
  ...
  vtkErrorMacro(<< "vtkFlRenderWindowInteractor::Start() interactor cannot "
                   "control event loop.");
}
//---------------------------------------------------------------------------
...
int vtkFlRenderWindowInteractor::handle(int event) {
  ...
  case FL_PUSH:         // mouse down
    ...
    case FL_LEFT_MOUSE:
      ...
      InteractorStyle->OnLeftButtonDown(
          Fl::event_state(FL_CTRL), Fl::event_state(FL_SHIFT), Fl::event_x(),
          this->h() - Fl::event_y() - 1);
#endif
      break;
  ...
  case FL_MOVE:
    ...
    InteractorStyle->OnMouseMove(Fl::event_state(FL_CTRL),
                                 Fl::event_state(FL_SHIFT), Fl::event_x(),
                                 this->h() - Fl::event_y() - 1);
#endif
    break;
