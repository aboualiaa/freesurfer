...
// static char vcid[] = "$Id: mris_label_calc.cpp,v 1.6 2016/12/10 22:57:58
// fischl Exp $";
...
int main(int argc, char *argv[]) {
  ...
  if (comm == "union") {
    if (argc != 5) {
      cerr << "Command 'union' needs 4 arguments: union inlabel1 inlabel2 "
              "outlabel"
           << endl;
      exit(1);
    }
    ...
    if (argc != 5) {
      cerr << endl
           << "  Command 'intersect' needs 4 arguments: " << endl
           << endl;
      ;
    ...
    if (argc != 5) {
      ...
      cerr << "> mris_label_calc invert inlabel insurface outlabel" << endl
           << endl;
      exit(1);
    }
    string if1 = argv[2];
    ...
    if (argc != 6) {
      ...
      cerr << "> mris_label_calc erode iterations inlabel insurface outlabel"
           << endl
           << endl;
      exit(1);
    }
    ...
    if (argc != 6) {
      ...
      cerr << "> mris_label_calc dilate iterations inlabel insurface outlabel"
           << endl
           << endl;
      exit(1);
    }
