...
#define VTKIOIMAGE_DEPRECATED_EXPORT                                           \
  VTKIOIMAGE_EXPORT __attribute__((__deprecated__))
#define VTKIOIMAGE_DEPRECATED_NO_EXPORT                                        \
  VTKIOIMAGE_NO_EXPORT __attribute__((__deprecated__))
#endif
