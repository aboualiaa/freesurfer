...
def removeHeader():
    imageIn = sys.argv[
        1
    ]  # "/local_mount/space/namic/2/users/vsiless/data/hcp-mgh/mgh_1001/dtifit_FA_LPS.nii.gz"
    imageOut = sys.argv[
        2
    ]  # "/local_mount/space/namic/2/users/vsiless/data/hcp-mgh/mgh_1001/dtifit_FA_LPS_eye.nii.gz"
