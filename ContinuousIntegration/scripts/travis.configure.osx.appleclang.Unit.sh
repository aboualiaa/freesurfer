...
cmake -G Ninja -DCMAKE_BUILD_TYPE=Debug -DFS_GEMS_BUILD_MATLAB=OFF ..
cmake -G Ninja -DCMAKE_BUILD_TYPE=Debug -DFS_GEMS_BUILD_MATLAB=OFF .. # again so that AppleClang finds OpenMP
