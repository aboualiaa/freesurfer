...
int vtkInflatePolyData::RequestUpdateExtent(
    vtkInformation *vtkNotUsed(iRequest), vtkInformationVector **ioaInputInfo,
    vtkInformationVector *ioaOutputInfo) {
...
int vtkInflatePolyData::RequestData(vtkInformation *vtkNotUsed(iRequest),
  ...
  if ((nullptr == points) || (points->GetNumberOfPoints() < 1)) {
  ...
  if ((nullptr == polys) || (polys->GetNumberOfCells() < 1)) {
