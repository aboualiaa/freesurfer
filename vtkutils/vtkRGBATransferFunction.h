...
=========================================================================*/
// .NAME vtkRGBATransferFunction - Defines a transfer function for mapping a
// property to an RGBA color value.

// .SECTION Description
// This code is based on vtkColorTransferFunction. It was modified to add an
// alpha element to all color output. This required adding a 5th element to the
// Function units, and changing all Add***Point and Add***Segment functions to
// Add***APoint and Add***ASegment, adding an alpha parameter to each.
...
class /*VTKCOMMONCORE_EXPORT*/ vtkRGBATransferFunction
