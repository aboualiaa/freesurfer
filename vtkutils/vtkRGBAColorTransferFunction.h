...
=========================================================================*/
// .NAME vtkRGBAColorTransferFunction - Defines a transfer function for mapping
// a property to an RGB color value.
...
private:
  vtkRGBAColorTransferFunction(
      const vtkRGBAColorTransferFunction &);            // Not implemented.
