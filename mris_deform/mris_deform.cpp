...
static double find_min_rms(
    double *kernel, double *intensity_profile, int profile_len,
...
static int mark_sg_index_okay_dark_csf(double *orig_intensity_profile,
                                       ...
                                       const char *fname, int current_index,
...
static int mark_sg_index_okay_bright_csf(
    ...
    const char *fname, int current_index, double outside_val, int min_wm_index,
...
static int mark_wm_index_okay(double *intensity_profile, int *wm_index_okay,
                              ...
                              int len, const char *fname, int max_in) {
...
static double compute_profile_L1(double *kernel, double *iprofile, int nsamples,
                                 const char *fname, double step, double in_dist,
                                 double *errors) {
  double val, kval, L1;
  int    i;
  FILE * fp = NULL;
