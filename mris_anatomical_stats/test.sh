...
compare_file stats.table stats.ref.table -I#
...
compare_file aparc.stats.table aparc.stats.ref.table -I#
...
compare_file a2009s.stats.table a2009s.stats.ref.table -I#
