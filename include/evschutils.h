...
EVENT_SCHEDULE *RandEvSch(int nevents, int ntypes, float dtmin, float dtnullavg,
                          int randweights);
EVENT_SCHEDULE *SynthEvSch(int nEvTypes, int *nPer, float *tPer, float tRes,
                           float tMax, float tPreScan);
...
int         EVSRandTiming(EVSCH *EvSch, float *EvDur, float tRes, float tMax,
                          float tPreScan);
