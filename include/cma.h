...
#define IS_FUTURE_WMSA(l)                                                      \
  (((l) == Left_future_WMSA) || ((l) == Right_future_WMSA) ||                  \
   ((l) == future_WMSA))
...
#define IS_CC(l)                                                               \
  ((l >= CC_Posterior && l <= CC_Anterior) ||                                  \
   (l >= MIN_CC_EXTRA && l <= MAX_CC_EXTRA))
...
#define IS_UNKNOWN(label)                                                      \
  (((label) == Unknown) || (label == 255) || (label == Bright_Unknown) ||      \
   (label == Dark_Unknown))
...
#define IS_WM(label)                                                           \
  (((label) == Left_Cerebral_White_Matter) ||                                  \
   ...
   ((label) == Right_Temporal_Cerebral_White_Matter) || IS_CC(label) ||        \
   (label == Left_VentralDC) || (label == Right_VentralDC) ||                  \
   IS_CEREBELLAR_WM(label))
#define IS_HYPO(label)                                                         \
  (((label) == WM_hypointensities) || ((label) == Left_WM_hypointensities) ||  \
   ((label) == Right_WM_hypointensities) || IS_FUTURE_WMSA(label))
#define IS_WMSA(label) IS_HYPO(label)
#define IS_WMH(label)  (IS_WM(label) || IS_HYPO(label))
#define IS_THALAMUS(label)                                                     \
  (((label) == Left_Thalamus) || ((label) == Left_Thalamus) ||                 \
   ((label) == Right_Thalamus) || ((label) == Right_Thalamus))
#define IS_GM(label)                                                           \
  (((label) == Left_Cerebral_Cortex) || ((label) == Right_Cerebral_Cortex))
#define IS_VENTRAL_DC(l) (((l) == Left_VentralDC) || ((l) == Right_VentralDC))

#define IS_CEREBELLAR_WM(label)                                                \
  (((label) == Left_Cerebellum_White_Matter) ||                                \
   ((label) == Right_Cerebellum_White_Matter))
#define IS_CEREBELLAR_GM(label)                                                \
  (((label) == Left_Cerebellum_Cortex) || ((label) == Right_Cerebellum_Cortex))
#define IS_CEREBELLUM(label)                                                   \
  (IS_CEREBELLAR_WM(label) || IS_CEREBELLAR_GM(label))
...
#define IS_CORTEX(l)                                                           \
  (((l) == Left_Cerebral_Cortex) || ((l) == Right_Cerebral_Cortex))
#define IS_LAT_VENT(l)                                                         \
  (((l) == Left_Lateral_Ventricle) || ((l) == Right_Lateral_Ventricle) ||      \
   ((l) == Right_Inf_Lat_Vent) || ((l) == Left_Inf_Lat_Vent))
#define IS_CSF(l)                                                              \
  (IS_LAT_VENT(l) || ((l) == CSF) || ((l) == CSF_SA) ||                        \
   ((l) == Third_Ventricle) || ((l) == Fourth_Ventricle))

#define IS_INF_LAT_VENT(l)                                                     \
  (((l) == Left_Inf_Lat_Vent) || ((l) == Right_Inf_Lat_Vent))
#define IS_VENTRICLE(l)                                                        \
  (IS_LAT_VENT(l) || IS_INF_LAT_VENT(l) || ((l) == Third_Ventricle) ||         \
   ((l) == Fourth_Ventricle))
...
#define IS_ACCUMBENS(l)                                                        \
  (((l) == Left_Accumbens_area) || ((l) == Right_Accumbens_area))
...
#define LABEL_WITH_NO_TOPOLOGY_CONSTRAINT(l)                                   \
  (((l) == Right_non_WM_hypointensities) ||                                    \
   ((l) == Left_non_WM_hypointensities) || ((l) == Left_WM_hypointensities) || \
   ((l) == Right_WM_hypointensities) || ((l) == Left_choroid_plexus) ||        \
   ((l) == Right_choroid_plexus) || ((l) == WM_hypointensities) ||             \
   ((l) == Dura) || ((l) == Bone) || ((l) == CSF_SA) || ((l) == Epidermis) ||  \
   ((l) == SC_FAT_MUSCLE) || ((l) == non_WM_hypointensities))
...
#define IS_FIMBRIA(l)                                                          \
  ((l) == left_fimbria || (l) == right_fimbria || (l) == fimbria)
#define CSF_CLASS       0
#define GM_CLASS        1
#define WM_CLASS        2
...
#define IS_GRAY_MATTER(l)                                                      \
  (((l) == Left_Cerebral_Cortex) || ((l) == Left_Hippocampus) ||               \
   ((l) == Left_Amygdala) || ((l) == Left_Putamen) || ((l) == Left_Caudate) || \
   ((l) == Left_Cerebellum_Cortex) || ((l) == Left_Accumbens_area) ||          \
   ((l) == Right_Cerebral_Cortex) || ((l) == Right_Hippocampus) ||             \
   ((l) == Right_Amygdala) || ((l) == Right_Putamen) ||                        \
   ((l) == Right_Caudate) || ((l) == Right_Cerebellum_Cortex) ||               \
...
#define IS_FLUID(l)                                                            \
  (((l) == Left_Lateral_Ventricle) || ((l) == Left_Inf_Lat_Vent) ||            \
   ((l) == Right_Lateral_Ventricle) || ((l) == Right_Inf_Lat_Vent) ||          \
   ((l) == Unknown))

#define IS_LH_CLASS(l)                                                         \
  (((l) == Left_Cerebral_Cortex) || ((l) == Left_Cerebral_White_Matter) ||     \
   ((l) == Left_Hippocampus) || ((l) == Left_Amygdala) ||                      \
   ((l) == Left_Putamen) || ((l) == Left_Pallidum) || ((l) == Left_Caudate) || \
   ((l) == Left_Lateral_Ventricle) || ((l) == Left_Inf_Lat_Vent) ||            \
   ((l) == Left_Cerebellum_Cortex) || ((l) == Left_Cerebellum_White_Matter) || \
   ((l) == Left_Thalamus) || ((l) == Left_vessel) ||                           \
   ((l) == Left_choroid_plexus) || ((l) == Left_VentralDC) ||                  \
   ((l) == Left_Accumbens_area))

#define IS_RH_CLASS(l)                                                         \
  (((l) == Right_Cerebral_Cortex) || ((l) == Right_Cerebral_White_Matter) ||   \
   ((l) == Right_Hippocampus) || ((l) == Right_Amygdala) ||                    \
   ((l) == Right_Putamen) || ((l) == Right_Pallidum) ||                        \
   ((l) == Right_Caudate) || ((l) == Right_Lateral_Ventricle) ||               \
   ((l) == Right_Inf_Lat_Vent) || ((l) == Right_Cerebellum_Cortex) ||          \
   ((l) == Right_Cerebellum_White_Matter) || ((l) == Right_Thalamus) ||        \
   ((l) == Right_vessel) || ((l) == Right_choroid_plexus) ||                   \
   ((l) == Right_VentralDC) || ((l) == Right_Accumbens_area))

// only structures that are 'pure' of one tissue type
#define IS_GRAY_CLASS(l)                                                       \
  (IS_GM(l) || ((l) == Left_Caudate) || ((l) == Right_Caudate))

#define IS_WHITE_CLASS(l)                                                      \
  (((l) == Left_Cerebral_White_Matter) || ((l) == Right_Cerebral_White_Matter))

#define IS_CSF_CLASS(l)                                                        \
  (((l) == Left_Lateral_Ventricle) || ((l) == Right_Lateral_Ventricle) ||      \
   ((l) == CSF) || ((l) == CSF_SA) || ((l) == Third_Ventricle) ||              \
   ((l) == Fourth_Ventricle) || ((l) == Fifth_Ventricle) ||                    \
   ((l) == left_hippocampal_fissure) || ((l) == right_hippocampal_fissure) ||  \
