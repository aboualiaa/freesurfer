...
MRI *RFAlabel(MRI *mri_inputs, RFA *rfa, MRI *mri_labeled,
              TRANSFORM *transform);
...
#define NOT_TRAINING_LABEL(l)                                                  \
  (((l) == Left_Accumbens_area) || ((l) == Right_Accumbens_area) ||            \
   ...
   ((l) == Fourth_Ventricle) || ((l) == Left_vessel) ||                        \
   ((l) == Right_vessel) || ((l) == non_WM_hypointensities) ||                 \
   ((l) == Left_Lateral_Ventricle) || ((l) == Right_Lateral_Ventricle) ||      \
   ((l) == Left_Inf_Lat_Vent) || ((l) == Right_Inf_Lat_Vent) ||                \
   ((l) == Left_Pallidum) || ((l) == Right_Pallidum) ||                        \
   ((l) == Left_Amygdala) || ((l) == Right_Amygdala) ||                        \
   ((l) == Left_Hippocampus) || ((l) == Right_Hippocampus) ||                  \
   ((l) == Left_Putamen) || ((l) == non_WM_hypointensities) ||                 \
   ((l) == Right_Putamen) || ((l) == Left_Caudate) ||                          \
   ((l) == Right_Caudate) || ((l) == Left_Thalamus_Proper) ||                  \
   ((l) == Right_Thalamus_Proper) || ((l) == Left_choroid_plexus) ||           \
   ((l) == Right_choroid_plexus) || ((l) == CC_Anterior) ||                    \
   ((l) == CC_Mid_Anterior) || ((l) == CC_Central) || ((l) == CC_Posterior) || \
   ((l) == CC_Mid_Posterior))
