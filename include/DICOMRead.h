...
typedef struct {
  ...
  // general infos
  char *StudyDate, *PatientName, *Manufacturer, *StudyTime, *SeriesTime,
      *AcquisitionTime;
  ...
  // image position and orientation
  double ImagePosition[3], ImageOrientation[6], FirstImagePosition[3],
      LastImagePosition[3], Vc[3], Vr[3], Vs[3];
