...

{
  ...
  ROMP_Distributor_begin(&ROMP_distributor, ROMP_LO, ROMP_HI
...
// When this is not in a macro, but is directly here instead, the compilers use
// this file as the source correlation of the "omp parallel for" loop body,
// which hinders using performance analysis tools
//
#ifndef ROMP_for_begin
#define ROMP_for_begin                                                                                                \
  for (ROMP_index = 0; ROMP_index < ROMP_distributor.partialSize;                                                     \
       ROMP_index++) {                                                                                                \
    ROMP_PF_begin                                                                                                     \
                                                                                                                      \
