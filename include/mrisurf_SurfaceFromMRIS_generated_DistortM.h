#ifndef MRISURF_SURFACEFROMMRIS_GENERATED_DISTORTM_H
#define MRISURF_SURFACEFROMMRIS_GENERATED_DISTORTM_H

#include "mrisurf.h"

namespace DistortM {
struct Face : public Repr_Elt {
  using Surface = DistortM::Surface;
  using Vertex  = DistortM::Vertex;
  inline Face();
