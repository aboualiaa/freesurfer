...
public:
  GCAlinearPrior()
      : xDim(0), yDim(0), zDim(0), n4D(0), bytes(), offsets4D(), maxLabels(),
        labels(), priors(), totTraining(){};
  ...
  inline short &maxVoxelLabel(const int ix, const int iy, const int iz) {
    /*!
  ...
  inline short maxVoxelLabel(const int ix, const int iy, const int iz) const {
    /*!
    The maxLabels array holds per voxel data
    */
    size_t idx = index3D(ix, iy, iz);
  ...
  inline short voxelLabelCount(const int ix, const int iy, const int iz) const {
    /*!
  ...
  inline unsigned short &voxelLabel(const int ix, const int iy, const int iz,
                                    const int iLabel) {
    /*!
  ...
  const_GCAprior GetConstPrior(const int ix, const int iy, const int iz) const;
...
class const_GCAprior {
public:
  const_GCAprior(const int _ix, const int _iy, const int _iz,
                 const GCAlinearPrior &src)
      : gcalp(src), idx3d(src.index3D(_ix, _iy, _iz)),
