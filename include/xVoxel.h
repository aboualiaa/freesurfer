...
tBoolean xVoxl_IncrementUntilLimit(xVoxelRef ThisKRT, float inLimit);
tBoolean xVoxl_IncrementWithMinUntilLimit(xVoxelRef ThisKRT, float inMin,
                                          float inLimit);
tBoolean xVoxl_IncrementUntilLimits(xVoxelRef ThisKRT, float inXLimit,
                                    float inYLimit, float inZLimit);
tBoolean xVoxl_IncrementWithMinsUntilLimits(xVoxelRef ThisKRT, float inXMin,
                                            float inYMin, float inXLimit,
                                            float inYLimit, float inZLimit);
...
#define xVoxl_ExpandFloat(v)                                                   \
  xVoxl_GetFloatX(v), xVoxl_GetFloatY(v), xVoxl_GetFloatZ(v)
#define xVoxl_ExpandInt(v) xVoxl_GetX(v), xVoxl_GetY(v), xVoxl_GetZ(v)
#define xVoxl_ExpandRint(v)                                                    \
  (int)rint(xVoxl_GetX(v)), (int)rint(xVoxl_GetY(v)), (int)rint(xVoxl_GetZ(v))
