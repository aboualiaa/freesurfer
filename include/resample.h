...
MRI *vol2roi_linear(MRI *SrcVol, MATRIX *Qsrc, MATRIX *Fsrc, MATRIX *Wsrc,
                    MATRIX *Dsrc, MRI *SrcMskVol, MATRIX *Msrc2lbl,
                    LABEL *Label, int float2int, int *nhits, MRI *FinalMskVol);
...
MRI *MRIseg2SegPVF(MRI *seg, LTA *seg2vol, double resmm, int *segidlist,
                   int nsegs, MRI *mask, int ReInit, COLOR_TABLE *ct, MRI *out);
