...
MRI *GCAMmorphToAtlasType(MRI *mri_src, GCA_MORPH *gcam, MRI *mri_dst,
                          int frame, int interp_type);
MRI *GCAMmorphDTIToAtlasType(MRI *mri_src, GCA_MORPH *gcam, MRI *mri_dst,
                             int interp_type, int reorient);
...
int  GCAMregisterWithSubcorticalConnections(GCA_MORPH *gcam, MRI *mri,
...
MRI *GCAMmorphFieldFromAtlas(GCA_MORPH *gcam, MRI *mri, int which,
                             int save_inversion, int filter);
double GCAMcomputeRMS(GCA_MORPH *gcam, MRI *mri, GCA_MORPH_PARMS *parms);
double GCAMcomputeRMSWithSubcorticalConnections(
    GCA_MORPH *gcam, MRI *mri, GCA_MORPH_PARMS *parms,
    MRI_SUBCORTCONN *mri_source_subcort, MRI_SUBCORTCONN *mri_target_subcort);
