...
typedef struct {
  ...
  /* fitness information */
  /* initial fitness */
  float initial_face_ll, initial_vertex_ll, initial_curv_ll, initial_qcurv_ll,
      initial_mri_ll, initial_unmri_ll;
  /* final fitness */
  float final_face_ll, final_vertex_ll, final_curv_ll, final_qcurv_ll,
      final_mri_ll, final_unmri_ll;
