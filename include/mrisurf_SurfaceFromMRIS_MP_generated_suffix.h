...
MRIS_MP::MRIS_MP() {}
MRIS_MP::MRIS_MP(Representation *representation, size_t idx)
    : Repr_Elt(representation, idx) {}
...
MRIS_MP::MRIS_MP(XYZPositionConsequencesM::MRIS_MP const &src)
    : Repr_Elt(src) {}
...
void Face::set_ripflag(char to) { repr->f_ripflag[idx] = to; }
void Face::set_norm(FloatXYZ to) { repr->f_norm[idx] = to; }
