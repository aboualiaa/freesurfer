...
public:
  ...
  public:
    ...
    operator std::vector<ssize_t>() const {
      return {width, height, depth, nframes};
    }

    friend bool operator==(const Shape &l, const Shape &r) {
      return (std::vector<ssize_t>(l) == std::vector<ssize_t>(r));
    }
