...
#define ISWHITE(c)                                                             \
  (((c) == BORDER_MATTER) || ((c) == THIN_STRANDS) || ((c) == WHITE_MATTER))
...
#define FEATURE_POSITION                                                       \
  (FEATURE_X_POSITION | FEATURE_Y_POSITION | FEATURE_Z_POSITION)

#define FEATURE_CPOLV                                                          \
  (FEATURE_CPOLV_MEAN3 | FEATURE_CPOLV_MEAN5 | FEATURE_CPOLV_MEDIAN3 |         \
   FEATURE_CPOLV_ZSCORE5 | FEATURE_CPOLV_ZSCORE7 | FEATURE_CPOLV_CURV5 |       \
   FEATURE_CPOLV_CURV7 | FEATURE_CPOLV_MEDIAN5)
