...
int OpenDFPMin(float p[], int n, float ftol, int *iter, float *fret,
               ...
               // addition
               void (*step_func)(int itno, float sse, void *parms, float *p),
               void *parms, void (*user_callback_function)(float[]));

void OpenSpline(float x[], float y[], int n, float yp1, float ypn, float y2[]);

void OpenSplint(float xa[], float ya[], float y2a[], int n, float x, float *y);
