...
public:
  ...
  int LoadSurfaceScalars(const char *ifnScalars, const char *isLabel = NULL,
                         const char *isLabel2 = NULL, int inFrame = 0);
  ...
  void ManageFactorListBoxSelections(vtkKWListBox *iListBox,
                                     int iaSelections[2], int iMaxFactors);
  ...
  static void NotebookRaisePageCallback(vtkObject *, unsigned long, void *,
                                        void *);
  ...
  static void ScatterPlotGraphMouseoverEnterElementCallback(vtkObject *,
                                                            unsigned long,
                                                            void *, void *);
  static void ScatterPlotGraphMouseoverExitElementCallback(vtkObject *,
                                                           unsigned long,
                                                           void *, void *);
  static void ScatterPlotGraphContextualMenuOpeningCallback(vtkObject *,
                                                            unsigned long,
                                                            void *, void *);
