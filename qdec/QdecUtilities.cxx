...
const char *QdecUtilities::FileNamePath(const char *fname,
                                        const char *pathName) {
  char *slash;
...
const char *QdecUtilities::GetQdecrcResourceString(const char *key) {
...
const char *QdecUtilities::GetResourceString(const char *key,
                                             const char *filename) {
